...
oMenu.mainwidth=120 //A largura do menuitems principal em pixel ou%
...
oMenu.subwidth=150 //Caso você não queira a largura igual a do menu
...
oMenu.menuplacement=new Array('0','120','240','360','480') //os primeiros 3 números são a posição horizontal dos menus
...
oMenu.makeMain(0,'CADASTRO',0)
	//Sub items:
	// makeSub(MAIN_NUM,SUB_NUM,'TEXT','LINK',TOTAL,'FRAME_TARGET') (set link to 0 if you want submenus of this menu item)
	

	oMenu.makeSub(0,0,'Processo......................',0,2)
	oMenu.makeSub(0,1,'Sub-Processo..................',0,2)
	
	oMenu.makeSubSub(0,0,0,'Novo......................','xproc/asp/cadas_processo.asp?txtOpc=1',3)
	oMenu.makeSubSub(0,0,1,'Alterar...................','xproc/asp/altera_processo.asp',3)
	oMenu.makeSubSub(0,0,2,'Excluir...................','xproc/asp/exclui_.asp',3)

	oMenu.makeSubSub(0,1,0,'Novo......................','xproc/asp/cadas_sub_processo.asp?txtOpc=1',3)
	oMenu.makeSubSub(0,1,1,'Alterar...................','xproc/asp/altera_sub_processo.asp?txtOpc=1',3)
	oMenu.makeSubSub(0,1,2,'Excluir...................','xproc/asp/exclui.asp',3)
	


//MAIN 1 - Jornal	
//oMenu.makeMain(1,'RELAÇÕES','0',0)
oMenu.makeMain(1,'DECOMPOSIÇÃO',0)

	//oMenu.makeSub(1,0,'Por Atividade','xproc/asp/form_relaciona_ativ_trans4.asp?txtOpc=1',2)
	oMenu.makeSub(1,0,'Por Sub-Processo','xproc/asp/selec_Mega_Proc_Sub_Processo.asp?txtOpc=1',1)

//MAIN 2 - Seguros
oMenu.makeMain(2,'CONSULTA',0)
	oMenu.makeSub(2,0,'Mega-Processo','xproc/asp/consulta_mega_processo.asp',9)
	oMenu.makeSub(2,1,'Processo','xproc/asp/consulta_processo.asp',9)
	oMenu.makeSub(2,2,'Sub-Processo','xproc/asp/consulta_sub.asp',9)
	oMenu.makeSub(2,3,'Master List R/3','xproc/asp/consulta_modulo.asp',9)
	oMenu.makeSub(2,4,'Atividade','xproc/asp/consulta_atividade.asp',9)
	oMenu.makeSub(2,5,'Transações','xproc/asp/consulta_trans.asp',9)
	oMenu.makeSub(2,6,'Empresa','xproc/asp/consulta_empresa.asp',9)
	oMenu.makeSub(2,7,'Relações Carga...................',0,9)
	oMenu.makeSub(2,8,'Relações Definidas..............',0,9)
	
	oMenu.makeSubSub(2,7,0,'Por Atividade','xproc/asp/em_desenvolvimento.asp',3)
	oMenu.makeSubSub(2,7,1,'Por Master List R/3','xproc/asp/em_desenvolvimento.asp',3)
	oMenu.makeSubSub(2,7,2,'Por Transação','xproc/asp/em_desenvolvimento.asp',3)

	oMenu.makeSubSub(2,8,0,'Por Mega-Processo','xproc/asp/em_desenvolvimento.asp',7)
	oMenu.makeSubSub(2,8,1,'Por Processo','xproc/asp/em_desenvolvimento.asp',7)
	oMenu.makeSubSub(2,8,2,'Por Sub-Processo','xproc/asp/em_desenvolvimento.asp',7)
	oMenu.makeSubSub(2,8,3,'Por Atividade','xproc/asp/em_desenvolvimento.asp',7)
	oMenu.makeSubSub(2,8,4,'Por Master List R/3','xproc/asp/em_desenvolvimento.asp',7)
	oMenu.makeSubSub(2,8,5,'Por Transação','xproc/asp/em_desenvolvimento.asp',7)
	oMenu.makeSubSub(2,8,6,'Por Atividade x Transação','xproc/asp/consulta.asp',7)

//MAIN 3 - Serviços
oMenu.makeMain(3,'USUÁRIO',0)
	oMenu.makeSub(3,0,'Cadastro','xproc/asp/cad_usuario.asp',2)
	oMenu.makeSub(3,1,'Acesso','xproc/asp/cadas_acesso.asp',2)

//MAIN 4 - Contato
oMenu.makeMain(4,'ESCOPO',0)
	oMenu.makeSub(4,0,'Master List R/3',0,6)
	oMenu.makeSub(4,1,'Atividade',0,6)
	oMenu.makeSub(4,2,'Transação',0,6)
	oMenu.makeSub(4,3,'Empresa/Unidade',0,6)
	oMenu.makeSub(4,4,'M.List x Ativ x Transação','xproc/asp/relacao_master_.asp',6)
	oMenu.makeSub(4,5,'Atividade x Empresa','xproc/asp/relacao_ativ_emp_.asp',6)

	oMenu.makeSubSub(4,0,0,'Novo......................','xproc/asp/cad_modulo.asp',3)
	oMenu.makeSubSub(4,0,1,'Alterar...................','xproc/asp/altera_modulo.asp',3)
	oMenu.makeSubSub(4,0,2,'Excluir...................','xproc/asp/exclusao.asp?ID=1',3)

	oMenu.makeSubSub(4,1,0,'Novo......................','xproc/asp/cad_atividade.asp',3)
	oMenu.makeSubSub(4,1,1,'Alterar...................','xproc/asp/altera_atividade.asp',3)
	oMenu.makeSubSub(4,1,2,'Excluir...................','xproc/asp/exclusao.asp?ID=2',3)

	oMenu.makeSubSub(4,2,0,'Novo......................','xproc/asp/cad_transacao.asp',3)
	oMenu.makeSubSub(4,2,1,'Alterar...................','xproc/asp/altera_transacao.asp',3)
	oMenu.makeSubSub(4,2,2,'Excluir...................','xproc/asp/exclusao.asp?ID=3',3)

	oMenu.makeSubSub(4,3,0,'Novo......................','xproc/asp/cad_empresa.asp',3)
	oMenu.makeSubSub(4,3,1,'Alterar...................','xproc/asp/altera_empresa.asp',3)
	oMenu.makeSubSub(4,3,2,'Excluir...................','xproc/asp/exclusao.asp?ID=4',3)
