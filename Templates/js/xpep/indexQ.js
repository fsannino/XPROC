...
oMenu.makeMain(posicao,'Detalhamento',0)
	...
	qtd_7=1;
	oMenu.makeSub(posicao,0,'Inclusão/Alteração',raiz + '/asp/xpep/asp/seleciona_plano.asp?pAcao=X',qtd_7)
...
oMenu.makeMain(posicao,'Suporte',0)
	...
	qtd_7=1;
	oMenu.makeSub(posicao,0,'Troca Servidor',raiz + '/asp/xpep/asp/troca_servidor.asp',qtd_7)
