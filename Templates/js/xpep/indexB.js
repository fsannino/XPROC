...
//Style variables NOTE: O stylesheet foram afastados. 
//Use isto ao invés! (alguns estilos estão lá através de falta, como position:absolute ++)
//padding:3px = distância vertical

// DEFINE O TIPO E TAMNAHO DA LETRA DO MENU 
oMenu.clMain='padding:0px; font-family:verdana; font-size:9px; font-weight:bold; text-align:center; border: solid; border-width: 0pt 0pt 0pt 1pt; border-color: #FFFFFF #FFFFFF #FFFFFF #FFFFFF' //Style do menu principal (menu título)
oMenu.clSub='padding:4px; font-family:verdana; font-size:9px; font-weight:bold; text-indent: 2pt; border-color: #FFFFFF #FFFFFF #FFFFFF; border-style: solid; border-top-width: 0px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px' //Style dos submenus
oMenu.clSubSub='padding:4px; font-family:verdana; font-size:9px; font-weight:bold; text-indent: 2pt; border-color: #FFFFFF #cccccc #cccccc; border-style: solid; border-top-width: 0px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px' //Style dos subsubmenus
...
oMenu.mainheight=14 //A altura do menuitems principal em pixel ou%
...
oMenu.subheight=20 //Caso você não queira a altura igual a do menu
oMenu.subwidth=140 //Caso você não queira a largura igual a do menu
...
oMenu.subsubheight=20 //Caso você não queira a altura igual a do submenu
oMenu.subsubwidth=120 //Caso você não queira a largura igual a do submenu
...
oMenu.subsubXplacement=80 //** NEW ** distância dos submenus em relação aos links

//Cores dos Background dos menus
oMenu.mainbgcoloroff='#6699CC' //Background do menu principal
oMenu.mainbgcoloron='#0099FF' //Background do mouseover do menu principal
oMenu.subbgcoloroff='#6699CC' //Background do submenu
oMenu.subbgcoloron='#0066CC' //Background do mouseover do submenu
oMenu.subsubbgcoloroff='#6699CC' //Background do subsubmenu
...
//oMenu.menuplacement=new Array('0','80','160','240','320','400','480','560','640') //os primeiros 3 números são a posição horizontal dos menus
//  oMenu.menuplacement=new Array('0','70','140','210','280','350','420','490','560','630','700') //os primeiros 3 números são a posição horizontal dos menus
//  oMenu.menuplacement=new Array('0','70','140') //os primeiros 3 números são a posição horizontal dos menus
//A POSIÇÃO DO MENU NA TELA É DADO PELO NUM DO PRIMEIRO VETOR E 
// O CAMPO oMenu.fromtop=80 //in pixel or %

//oMenu.menuplacement=new Array('200','320','440', '560') //os primeiros 3 números são a posição horizontal dos menus
oMenu.menuplacement=new Array('200','280','350','420') //os primeiros 3 números são a posição horizontal dos menus

//Altura do menu em relação ao topo do browser
oMenu.fromtop=48//in pixel or %
...
posicao=0;
oMenu.makeMain(posicao,'Detalhamento',0)

	qtd_7=1;
	oMenu.makeSub(posicao,0,'Inclusão/Alteração',raiz + '/asp/xpep/asp/seleciona_plano.asp',qtd_7)
	
//MAIN 2 - Seguros
posicao=1;
oMenu.makeMain(posicao,'Consulta',0)
	qtd_2=7;
    oMenu.makeSub(posicao,0,'PCM',0,qtd_2)	
    oMenu.makeSub(posicao,1,'PAC',0,qtd_2)	
    oMenu.makeSub(posicao,2,'PPO',0,qtd_2)	
    oMenu.makeSub(posicao,3,'PCD',0,qtd_2)	
    oMenu.makeSub(posicao,4,'PDS',0,qtd_2)	
    oMenu.makeSub(posicao,5,'PAI',0,qtd_2)	
	oMenu.makeSub(posicao,6,'Lista Projeto',raiz + '/asp/xpep/asp/relat_lista_projeto.asp',qtd_2)	
	qtd_7=2;
	oMenu.makeSubSub(posicao,0,0,'PCM_Por_Plano',raiz + '/asp/xpep/asp/seleciona_plano_relat_pcm.asp?pAcao=C&pTpRel=1',qtd_7)
	oMenu.makeSubSub(posicao,0,1,'PCM_Por_Data',raiz +  '/asp/xpep/asp/seleciona_plano_relat_pcm.asp?pAcao=C&pTpRel=2',qtd_7)
	qtd_7=1;
	oMenu.makeSubSub(posicao,1,0,'PAC_Por_Plano',raiz + '/asp/xpep/asp/seleciona_plano_relat_pac.asp?pAcao=C&pTpRel=2',qtd_7)
	qtd_7=1;
	oMenu.makeSubSub(posicao,2,0,'PPO_Por_Atividade',raiz + '/asp/xpep/asp/seleciona_plano_relat_outras.asp?pAcao=C&pTpRel=4&pSiglaPlano=PPO',qtd_7)
	qtd_7=1;
	oMenu.makeSubSub(posicao,3,0,'PCD_Por_Atividade',raiz + '/asp/xpep/asp/seleciona_plano_relat_outras.asp?pAcao=C&pTpRel=3&pSiglaPlano=PCD',qtd_7)
	qtd_7=1;
	oMenu.makeSubSub(posicao,4,0,'PDS_Por_Atividade',raiz + '/asp/xpep/asp/seleciona_plano_relat_outras.asp?pAcao=C&pTpRel=2&pSiglaPlano=PDS',qtd_7)
	qtd_7=1;
	oMenu.makeSubSub(posicao,5,0,'PAI_Por_Atividade',raiz + '/asp/xpep/asp/seleciona_plano_relat_outras.asp?pAcao=C&pTpRel=1&pSiglaPlano=PAI',qtd_7)

//posicao=2;
//oMenu.makeMain(posicao,'Usuário',0)

	//qtd_7=1;
	//oMenu.makeSub(posicao,0,'Cadastro',raiz + '/asp/xpep/asp/msg_geral.asp?pMsg=C',qtd_7)

//posicao=3;
//oMenu.makeMain(posicao,'Suporte',0)

	//qtd_7=1;
	//oMenu.makeSub(posicao,0,'Troca Servidor',raiz + '/asp/xpep/asp/msg_geral.asp?pMsg=C',qtd_7)
