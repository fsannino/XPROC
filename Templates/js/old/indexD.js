...
oMenu.menuplacement=new Array('0') //os primeiros 3 números são a posição horizontal dos menus
...
oMenu.makeMain(posicao,'CONSULTA',0)
	...
	oMenu.makeSubSub(posicao,pos_Sub,14,'Consulta Validação de Escopo ', raiz + '/asp/cenario/consulta_escopo_cenario.asp',qtd_61)
