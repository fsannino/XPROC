...
oMenu.menuplacement=new Array('0','120','240','360','480','580') //os primeiros 3 números são a posição horizontal dos menus
...
oMenu.makeMain(posicao,'CONSULTA',0)
	...
	oMenu.makeSubSub(posicao,pos_Sub,13,'Consulta Validação de Escopo ', raiz + '/asp/cenario/consulta_escopo_cenario.asp',qtd_61)	
...
oMenu.makeMain(4,'ESCOPO',0)
	oMenu.makeSub(4,0,'Agrup.(Mstr List R3)',0,7)
	oMenu.makeSub(4,1,'Atividade',0,7)
	oMenu.makeSub(4,2,'Transação',0,7)
	oMenu.makeSub(4,3,'Empresa/Unidade',0,7)
	oMenu.makeSub(4,4,'Classe',0,7)
	oMenu.makeSub(4,5,'Agr.Ativ x Ativ x Transação','xproc/asp/relacao_master_.asp',7)
	oMenu.makeSub(4,6,'Atividade x Empresa','xproc/asp/relacao_ativ_emp_.asp',7)
	...
	oMenu.makeSubSub(4,4,0,'Novo......................','xproc/asp/cenario/cad_classe_mega.asp',1)



//MAIN 4 - Contato
oMenu.makeMain(5,'CENÁRIO',0)

              oMenu.makeSub(5,0,'Cenário',0,1)

	oMenu.makeSubSub(5,0,0,'Novo......................','xproc/asp/cenario/cad_cenario.asp',3)
	oMenu.makeSubSub(5,0,1,'Alterar Dados..........','xproc/asp/cenario/altera_Cenario.asp',3)
	oMenu.makeSubSub(5,0,2,'Editar...................','xproc/asp/cenario/selec_Mega_Proc_Sub_Cenario.asp',3)
