...
//raiz = 'http://www2.sinergia.petrobras.com.br/xproc'
//Ie var
...
oMenu.mainwidth=70 //A largura do menuitems principal em pixel ou%
...
oMenu.subsubwidth=160 //Caso você não queira a largura igual a do submenu
...
oMenu.makeMain(posicao,'FUNÇÃO',0)
	...
	oMenu.makeSub(posicao,12,'Libera Mapeamento',raiz + '/asp/funcao/sel_func_libera_mapeamento.asp',qtd_3)
...
oMenu.makeMain(posicao,'PERFIL',0)
    ...
    oMenu.makeSub(posicao,8,'Termos Mega ',0,qtd_3)
    oMenu.makeSub(posicao,9,'Assuntos Mega ',0,qtd_3)
	oMenu.makeSub(posicao,10,'Orie. Perfil',raiz + '/asp/orie_perfil/seleciona_macro_perfil.asp?pOpt=5',qtd_3)
...
oMenu.makeMain(posicao,'CURSOS',0)
	...
	oMenu.makeSubSub(posicao,0,6,'Pré Requisito',raiz + '/asp/curso/seleciona_curso.asp?option=4',qtd_30)
	oMenu.makeSubSub(posicao,0,7,'Lib.Manual (LM)',raiz + '/asp/treinamento/seleciona_lm.asp',qtd_30)
...
oMenu.makeMain(posicao,'CONSULTA',0)
	...
	oMenu.makeSubSub(posicao,pos_Sub,15,'Desenvolv. em Atraso', raiz + '/asp/cenario/rel_desenv_atrasado.asp',qtd_61)
	oMenu.makeSubSub(posicao,pos_Sub,16,'Consulta Validação de Escopo ', raiz + '/asp/cenario/consulta_escopo_cenario.asp',qtd_61)	
