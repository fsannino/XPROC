...
oMenu.makeMain(2,'CONSULTA',0)
	...
	oMenu.makeSub(2,7,'Relações de Carga','xproc/asp/rel_agrativtran.asp',9)
...
oMenu.makeMain(3,'USUÁRIO',0)
	oMenu.makeSub(3,0,'Cadastro','xproc/asp/em_desenvolvimento.asp',2)
	oMenu.makeSub(3,1,'Acesso4','xproc/asp/cadas_acesso.asp',2)
