...
oMenu.mainwidth=100 //A largura do menuitems principal em pixel ou%
...
//MAIN 4 - Contato
oMenu.makeMain(0,'ESCOPO',0)

	qtd_0=6;
	oMenu.makeSub(0,0,'Agrup.(Mstr List R3)',0,qtd_0)
	oMenu.makeSub(0,1,'Atividade',0,qtd_0)
	oMenu.makeSub(0,2,'Transação',0,qtd_0)
	oMenu.makeSub(0,3,'Empresa/Unidade',0,qtd_0)
	oMenu.makeSub(0,4,'Ag.Ativ x Ativ x Tran','xproc/asp/relacao_master_.asp',qtd_0)
	oMenu.makeSub(0,5,'Atividade x Empresa','xproc/asp/relacao_ativ_emp_.asp',qtd_0)    
	qtd_00=3;
	oMenu.makeSubSub(0,0,0,'Novo......................','xproc/asp/cad_modulo.asp',qtd_00)
	oMenu.makeSubSub(0,0,1,'Alterar...................','xproc/asp/altera_modulo.asp',qtd_00)
	oMenu.makeSubSub(0,0,2,'Excluir...................','xproc/asp/exclusao.asp?ID=1',qtd_00)
    qtd_01=3;
	oMenu.makeSubSub(0,1,0,'Novo......................','xproc/asp/cad_atividade.asp',qtd_01)
	oMenu.makeSubSub(0,1,1,'Alterar...................','xproc/asp/altera_atividade.asp',qtd_01)
	oMenu.makeSubSub(0,1,2,'Excluir...................','xproc/asp/exclusao.asp?ID=2',qtd_01)
    qtd_02=3;
	oMenu.makeSubSub(0,2,0,'Novo......................','xproc/asp/cad_transacao.asp',qtd_02)
	oMenu.makeSubSub(0,2,1,'Alterar...................','xproc/asp/altera_transacao.asp',qtd_02)
	oMenu.makeSubSub(0,2,2,'Excluir...................','xproc/asp/exclusao.asp?ID=3',qtd_02)
    qtd_03=3;
	oMenu.makeSubSub(0,3,0,'Novo......................','xproc/asp/cad_empresa.asp',qtd_03)
	oMenu.makeSubSub(0,3,1,'Alterar...................','xproc/asp/altera_empresa.asp',qtd_03)
	oMenu.makeSubSub(0,3,2,'Excluir...................','xproc/asp/exclusao.asp?ID=4',qtd_03)

oMenu.makeMain(1,'PROCESSO',0)
	//Sub items:
	// makeSub(MAIN_NUM,SUB_NUM,'TEXT','LINK',TOTAL,'FRAME_TARGET') (set link to 0 if you want submenus of this menu item)	
    qtd_1=3;
	oMenu.makeSub(1,0,'Processo......................',0,qtd_1)
	oMenu.makeSub(1,1,'Sub-Processo.....',0,qtd_1)
	oMenu.makeSub(1,2,'Decomposição..................',0,qtd_1)
	qtd_10=3;
	oMenu.makeSubSub(1,0,0,'Novo......................','xproc/asp/cadas_processo.asp?txtOpc=1',qtd_10)
	oMenu.makeSubSub(1,0,1,'Alterar...................','xproc/asp/altera_processo.asp',qtd_10)
	oMenu.makeSubSub(1,0,2,'Excluir...................','xproc/asp/exclui_.asp',qtd_10)
    qtd_11=3;
	oMenu.makeSubSub(1,1,0,'Novo......................','xproc/asp/cadas_sub_processo.asp?txtOpc=1',qtd_11)
	oMenu.makeSubSub(1,1,1,'Alterar...................','xproc/asp/altera_sub_processo.asp?txtOpc=1',qtd_11)
	oMenu.makeSubSub(1,1,2,'Excluir...................','xproc/asp/exclui.asp',qtd_11)
	qtd_12=1;
	oMenu.makeSubSub(1,2,0,'Por Sub-Processo','xproc/asp/selec_Mega_Proc_Sub_Processo.asp?txtOpc=1',qtd_12)

//MAIN 4 - Contato
oMenu.makeMain(2,'CENÁRIO',0)

	qtd_2=1;
    oMenu.makeSub(2,0,'Cenário',0,qtd_2)	
    oMenu.makeSub(2,1,'Classe',0,qtd_2)

	qtd_20=3;
	oMenu.makeSubSub(2,0,0,'Novo......................','xproc/asp/cenario/cad_cenario.asp',qtd_20)
 	oMenu.makeSubSub(2,0,1,'Alterar','xproc/asp/cenario/altera_cenario.asp',qtd_20)
	oMenu.makeSubSub(2,0,2,'Excluir','xproc/asp/cenario/excluir_cenario.asp',qtd_20)
	oMenu.makeSubSub(2,0,3,'Editar Cenário/Transação','xproc/asp/cenario/selec_Mega_Proc_Sub_Cenario.asp',qtd_20)
	oMenu.makeSubSub(2,0,4,'Copia Cenario Onda','xproc/asp/cenario/copia_cenario_onda.asp',qtd_20)
	oMenu.makeSubSub(2,0,5,'Editar Ordem Cenário','xproc/asp/cenario/sel_cenario_altera_sequencia.asp',qtd_20)
	qtd_21=1;
	oMenu.makeSubSub(2,1,0,'Alterar Classe','xproc/asp/cenario/alterar_classe.asp',qtd_21)

oMenu.makeMain(3,'FUNÇÃO',0)

	qtd_3=1;
    oMenu.makeSub(3,0,'Função',0,qtd_3)

	qtd_30=6;
	oMenu.makeSubSub(3,0,0,'Nova','xproc/asp/funcao/cad_funcao.asp',qtd_30)
	oMenu.makeSubSub(3,0,1,'Alterar','xproc/asp/funcao/altera_funcao.asp',qtd_30)
	oMenu.makeSubSub(3,0,2,'Excluir','xproc/asp/funcao/exclui_funcao.asp',qtd_30)
	oMenu.makeSubSub(3,0,3,'Edit Rel Func x Trans','xproc/asp/funcao/edita_func_tra_selec_Meg_Fun.asp',qtd_30)
	oMenu.makeSubSub(3,0,4,'Relacao Func x Trans','xproc/asp/funcao/selec_Mega_Funcao.asp',qtd_30)
	oMenu.makeSubSub(3,0,5,'Relacao Func x Trans2','xproc/asp/funcao/selec_Mega_Funcao_outro.asp',qtd_30)
	
//MAIN 2 - Seguros
oMenu.makeMain(4,'DESENHO PROC',0)

//	qtd_3=1;
//    oMenu.makeSub(3,0,'Função',0,qtd_3)

oMenu.makeMain(5,'CASES',0)

//	qtd_3=1;
//    oMenu.makeSub(3,0,'Função',0,qtd_3)
		
//	oMenu.makeSubSub(1,2,14,'Chama LOTUS','http://164.85.62.152/comsinergia/treinamento.nsf',qtd_12)

//MAIN 2 - Seguros
oMenu.makeMain(6,'CONSULTA',0)
	...
	oMenu.makeSubSub(posicao,pos_Sub,4,'Funções Conflitantes',raiz + '/asp/funcao/rel_func_confl.asp',qtd_62)
...
//MAIN 3 - Serviços
oMenu.makeMain(7,'USUÁRIO',0)

	qtd_7=2;
	oMenu.makeSub(7,0,'Cadastro','xproc/asp/cad_usuario.asp',qtd_7)
	oMenu.makeSub(7,1,'Acesso','xproc/asp/cadas_acesso.asp',qtd_7)
