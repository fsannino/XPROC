...
oMenu.menuplacement=new Array('0','80','160','240','320','400','480') //os primeiros 3 números são a posição horizontal dos menus
...
oMenu.makeMain(posicao,'FUNÇÃO',0)
    ...
    oMenu.makeSub(posicao,9,'Sub-Módulo Mega ',0,qtd_3)
	oMenu.makeSub(posicao,10,'Orient das Funcao',raiz + '/asp/orie_mape/seleciona_funcao.asp?pOpt=CF',qtd_3)
	...
	oMenu.makeSubSub(posicao,4,1,'Rel Função sem Assunto',raiz + '/asp/funcao/inclui_ori_gerais_mapeamento.asp',qtd_30)
	...
	qtd_30=3;	
	oMenu.makeSubSub(posicao,9,0,'Inclui Sub-Módulo Mega',raiz + '/asp/orie_mape/seleciona_mega_processo.asp?pOpt=IM&pOpt2=M',qtd_30)
	oMenu.makeSubSub(posicao,9,1,'Altera Sub-Módulo Mega',raiz + '/asp/orie_mape/seleciona_mega_processo.asp?pOpt=AM&pOpt2=M',qtd_30)
	oMenu.makeSubSub(posicao,9,2,'Excluir Sub-Módulo Mega',raiz + '/asp/orie_mape/seleciona_mega_processo.asp?pOpt=EM&pOpt2=M',qtd_30)
...
//	oMenu.makeSubSub(posicao,0,2,'Excluir',raiz + '/asp/curso/seleciona_curso.asp?option=5',qtd_30)
	oMenu.makeSubSub(posicao,0,2,'Curso x Função',raiz + '/asp/curso/seleciona_curso.asp?option=2',qtd_30)
	...
	oMenu.makeSubSub(posicao,0,5,'Pré Requisito',raiz + '/asp/curso/seleciona_curso.asp?option=4',qtd_30)
...
oMenu.makeMain(posicao,'CONSULTA',0)
	...
	oMenu.makeSubSub(posicao,pos_Sub,4,'Relat Pré Requis.',raiz + '/asp/curso/curso_prerequisito.asp',qtd_62)
