...
While (NOT rdsUsuario.EOF)
         if (Trim(str_Usuario) = Trim(rdsUsuario.Fields.Item("USUA_CD_USUARIO").Value)) then %>
          <option value="<%=(rdsUsuario.Fields.Item("USUA_CD_USUARIO").Value)%>" selected ><%=(rdsUsuario.Fields.Item("USUA_TX_NOME_USUARIO").Value) & " - " & (rdsUsuario.Fields.Item("USUA_CD_USUARIO").Value) & " - " & (rdsUsuario.Fields.Item("USUA_TX_CATEGORIA").Value)%></option>
          <% else %>
          <option value="<%=(rdsUsuario.Fields.Item("USUA_CD_USUARIO").Value)%>" ><%=(rdsUsuario.Fields.Item("USUA_TX_NOME_USUARIO").Value) & " - " & (rdsUsuario.Fields.Item("USUA_CD_USUARIO").Value) & " - " & (rdsUsuario.Fields.Item("USUA_TX_CATEGORIA").Value)%></option>
          <% end if %>
          <%
  rdsUsuario.MoveNext()
Wend
