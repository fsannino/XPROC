...
'response.Write("str1" & request("str01") & "<p>")
'response.Write("str2" & request("str02") & "<p>")
...
response.write " sel1" & sel1 & "<br>"
response.write " sel2" & sel2 & "<br>"
...
function manda01()
	...
	window.location="selecao_usu_func.asp?opti=1&selOnda="+document.frm1.selOnda.value+"&hidTpChamada="+document.frm1.hidTpChamada.value
	}

function manda02()
	{
	carrega_txt1(document.frm1.list1);
	window.location="selecao_usu_func.asp?opti=1&lista="+document.frm1.txtorgao.value+"&str01="+document.frm1.Str01.value+"&str02="+document.frm1.Str02.value
	}

function manda03()
	{
	carrega_txt1(document.frm1.list1);
	window.location="selecao_usu_func.asp?opti=1&lista="+document.frm1.txtorgao.value+"&str01="+document.frm1.Str01.value+"&str02="+document.frm1.Str02.value+"&str03="+document.frm1.Str03.value+"&Chave="+document.frm1.chave.value+"&Atrib="+document.frm1.atribb.value
	}
...
<form name="frm1" method="POST" action="../Apoio/Clis/valida_cad_orgao_cli.asp">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
    ...
    <tr bgcolor="#00FF99"> 
      ...
      <td height="20" width="23%"><img src="../../imagens/teste/aprova_01.gif" width="14" height="12"> </td>
    </tr>
  </table>
<p align="center" style="word-spacing: 0; margin-top: 0; margin-bottom: 0">&nbsp;</p>
  <table border="0" width="80%" cellspacing="3" cellpadding="2">
    <tr>
      ...
      <td>&nbsp;</td>
      <td><strong><font size="3" face="Verdana, Arial, Helvetica, sans-serif">Sele&ccedil;&atilde;o de registros para exporta&ccedil;&atilde;o</font></strong></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF"><input name="hidTpChamada" type="hidden" value="<%=str_Tipo%>"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr> 
      ...
      <td width="5%"><b></b></td>
      <td width="80%"><select size="1" name="selOnda"  onChange="manda01()">
  ...
  <table border="0" width="80%" height="329">
    <tr>
