...
<form name="frm1" method="POST" action="">
  ...
  <table width="94%"  border="0" cellspacing="5" cellpadding="1">
    <tr bgcolor="#000099">
      <td width="25%"><div align="left"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Descri&ccedil;&atilde;o</font></strong></div></td>
      <td width="9%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Criado por</font></strong></div></td>
      <td width="8%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif"> Cria&ccedil;&atilde;o</font></strong></div></td>
      ...
      <td width="15%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">&Uacute;ltima Exporta&ccedil;&atilde;o </font></strong></div></td>
      <td width="11%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Usu-Func (Todos) </font></strong></div></td>
      <td width="11%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Usu-Func (Ok) </font></strong></div></td>
      <td width="10%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Usu-Func (n&atilde;o Ok)</font></strong></div></td>
    </tr>
	<% do while not rds_Lote.Eof %>
    <tr>
      <td><div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="consulta_lote_usu_func.asp?pAcao=<%=str_Acao%>&pTipo_Saida=Tela&pLote=<%=rds_Lote("LOTE_NR_SEQ_LOTE")%>&pDescLote=<%=rds_Lote("LOTE_TX_DESCRICAO")%>&pVezesImp=<%=rds_Lote("LOTE_NR_QTD_EXPORTACAO")%>"><%=rds_Lote("LOTE_NR_SEQ_LOTE")%> - <%=rds_Lote("LOTE_TX_DESCRICAO")%></a></font></div></td>
      ...
      <td><div align="center"><a href="consulta_conteudo_mapeados.asp?str_Tipo_Saida=Tela&pLote=<%=rds_Lote("LOTE_NR_SEQ_LOTE")%>&pDescLote=<%=rds_Lote("LOTE_TX_DESCRICAO")%>&pVezesImp=<%=rds_Lote("LOTE_NR_QTD_EXPORTACAO")%>&pOrdem=1"><img src="../../imagens/b04.gif" width="16" height="16" border="0"></a></div></td>
      <td><div align="center"><a href="consulta_conteudo_nao_mapeados.asp?str_Tipo_Saida=Tela&pLote=<%=rds_Lote("LOTE_NR_SEQ_LOTE")%>&pDescLote=<%=rds_Lote("LOTE_TX_DESCRICAO")%>&pVezesImp=<%=rds_Lote("LOTE_NR_QTD_EXPORTACAO")%>&pOrdem=1"><img src="../../imagens/b04.gif" width="16" height="16" border="0"></a></div></td>
    </tr>
    <tr>
      <td height="25" colspan="8"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&Oacute;rg&atilde;o:</font></strong> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rds_Lote("LOTE_TX_ORGAO_SELEC")%></font></td>
    </tr>
    <tr>
      <td height="25" colspan="8"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Fun&ccedil;&atilde;o</font></strong>: <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rds_Lote("LOTE_TX_FUNCAO_SELEC")%></font></td>
    </tr>
    <tr bgcolor="#CCCCCC">
