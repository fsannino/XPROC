    ...
    <tr bgcolor="#00FF99"> 
      <td colspan="3" height="20"><table width="625" border="0" align="center">
        <tr>
          ...
          <td width="50">
	  <% if str_Acao = "I" then %>
		  <a href="consulta_lote_usu_func.asp?pTipo_Saida=Excel&pLote=<%=str_Lote%>&pDescLote=<%=str_DescLote%>&pVezesImp=<%=Request("pVezesImp")%>" target="blank"> <img border="0" src="../../imagens/exp_excel.gif"></a>
		<% end if %>		  
		  </td>
          <td width="28"></td>
          <td width="26">&nbsp;</td>
