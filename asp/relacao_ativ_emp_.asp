...
ssql = ""
ssql="SELECT DISTINCT ATCA_CD_ATIVIDADE_CARGA, ATCA_TX_DESC_ATIVIDADE FROM " & Session("PREFIXO") & "ATIVIDADE_CARGA ORDER BY ATCA_TX_DESC_ATIVIDADE"
...
<form name="frm1" method="post" action="grava_relativemp.asp">
  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td width="68%"> 
        <select name="selAtividade" size="1" onchange="javascript:Confirma()">
