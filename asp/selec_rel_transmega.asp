...
<form name="frm1" method="post" action="rel_transmega.asp">
  ...
  <table width="87%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td width="10%"></td>
      <td width="17%"></td>
      <td width="73%"><font face="Verdana" size="3" color="#330099">Relatório de
              Transações x Mega-Processo</font></td>
    </tr>
    <tr> 
      <td width="10%">&nbsp;</td>
      <td width="17%">&nbsp;</td>
    ...
    <tr> 
      <td width="10%"><font color="#330099" face="Verdana" size="2"><b>&nbsp;</b></font></td>
      <td width="17%"><font size="2" face="Verdana" color="#330099"><b>Mega 
        Processo</b></font></td>
      <td width="73%"> 
...
%>
    ...
    <tr> 
      <td width="10%"><font size="2" face="Verdana" color="#330099"><b>&nbsp;</b></font></td>
      <td width="17%"><font size="2" face="Verdana" color="#330099"><b>(DONO)</b></font></td>
      <td width="73%">&nbsp;</td>
    </tr>
    <tr> 
      <td width="10%">&nbsp;</td>
      <td width="17%">&nbsp;</td>
      <td width="73%">&nbsp;<img border="0" src="../imagens/b021.gif" align="absmiddle">
        <font face="Verdana" size="1" color="#FF9900">Este Relatório exibe
        todas as transações relacionadas com Mega-Processos diferentes de seu
        Dono</font> </td>
    </tr>
    <tr> 
      <td width="10%">&nbsp;</td>
