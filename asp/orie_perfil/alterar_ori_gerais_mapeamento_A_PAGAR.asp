...
<form name="frm1" method="POST" action="valida_inc_alt_exc_orientacoes.asp">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="26%"><a href="relat_ori_gerais_mape_perfil.asp">aaaaaaa</a></td>
    </tr>
  </table>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
    ...
    <tr> 
      ...
      <td><font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif">Digite 
        as orienta&ccedil;&otilde;es finalizando cada linha com um &lt;br&gt;</font><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp; 
        </font></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
