...
if str_Opt = "IT" then
   ...
   atual=0
   set rs=db.execute("SELECT MAX(ORTE_NR_SEQUENCIAL) AS CODIGO FROM  PERFIL_ORIEN_MEGA_TERMOS WHERE MEPR_CD_MEGA_PROCESSO =" & str_MegaProcesso)
...
'	   response.Write("<p> fim ")
       if str_Orientacoes(i) <> "" and str_Termos(i) <> "" then
		  ...
		  atual = atual + 1
          ssql=""
          ssql="INSERT INTO " & Session("PREFIXO") & "PERFIL_ORIEN_MEGA_TERMOS ("
...
elseif str_Opt = "AT" then
   ...
   if str_Orientacoes <> "" then
      int_Tot_Orientacoes = int_Tot_Orientacoes + 1
      ssql=""
      ssql=ssql & "UPDATE PERFIL_ORIEN_MEGA_TERMOS SET "
...
elseif str_Opt = "ET" then
   ...
   if str_CdTermo <> "" then
      int_Tot_Orientacoes = int_Tot_Orientacoes + 1
      ssql=""
      ssql=ssql & "DELETE FROM PERFIL_ORIEN_MEGA_TERMOS "
      ssql=ssql & " WHERE ORTE_NR_SEQUENCIAL = " & str_CdTermo
	  ssql=ssql & " AND MEPR_CD_MEGA_PROCESSO = " & str_MegaProcesso
      db.execute(ssql)	
   end if  
...
%>
  ...
  <table border="0" width="889" height="162">
    ...
    <tr> 
      <td height="37"></td>
      <td height="37"> <p align="right"><a href="seleciona_ori_mega_perfil_termo.asp?pOpt=AT"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
    ...
    <tr> 
      <td height="37"></td>
      <td height="37"> <p align="right"><a href="seleciona_ori_mega_perfil_termo.asp?pOpt=ET"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
      <td height="37"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Voltar 
