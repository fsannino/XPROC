...
str_SQL_Mac_Per = str_SQL_Mac_Per & " MCPE_TX_SITUACAO <> 'MR' "
if str_Opt = 1 then ' PARA ALTERAÇÃO
   str_SQL_Mac_Per = str_SQL_Mac_Per & " AND MCPE_TX_SITUACAO not in ('EL','ER','EP') "
end if
if str_Opt = 2 then ' PARA EXCLUSÃO
   str_SQL_Mac_Per = str_SQL_Mac_Per & " AND MCPE_TX_SITUACAO not in ('EL','ER','EP') "
end if
...
window.location.href='seleciona_funcao.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value+'&selSubModulo='+document.frm1.selSubModulo.value+'&pOPT='+document.frm1.txtOPT.value+'&txtSubModulo='+document.frm1.txtSubModulo.value
}
...
window.location.href='seleciona_macro_perfil.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value+'&selFuncPrinc='+document.frm1.selFuncPrinc.value+'&pOPT='+document.frm1.txtOPT.value
}

function Confirma()
{
   if((document.frm1.selMacroPerfil.selectedIndex == 0)&&
      (document.frm1.txtNomeTecnico.value == ""))
      {
      alert("É obrigatória a seleção ou a digitação de um Macro Perfil !");
      ...
      if(document.frm1.txtOPT.value == 4)
        {
        document.frm1.action="relaciona_micro_libera_mapeamento.asp";
        //document.frm1.target="corpo";
        document.frm1.submit();
        }		
...
<form method="POST" action="alterar_excluir_ori_mega_mape_perfil.asp" name="frm1">
...
elseif str_OPT  = 2 then
   ...
   str_Msg = " A opção de exclusão de Macro Perfil não excluirá os dados do sistema XPROC. Após a confirmação, o sistema verificará se o Macro Perfil já foi criado no R/3. Caso positivo, será encaminhado uma mensagem para o grupo G3 para providenciar a exclusão no R/3 e receberá o status de EXCLUÍDO. Caso contrário, somente receberá o status de EXCLUÍDO"
elseif str_OPT  = 3 then
   str_Titulo = "EDIÇÃO DE OBJETOS"
elseif str_OPT  = 4 then
   str_Titulo = "Liberação de Micro Perfil para mapeamento"
elseif str_OPT  = 5 then
   str_Titulo = "Selecione Função/Macro Perfil para Orientações em Perfil"
...
%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="73">
    ...
    <tr> 
      ...
      <td width="7%" height="35">&nbsp;</td>
      <td width="20%" height="35"> 
        <div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099"><b>Macro 
          Perfil :</b></font></div>
      </td>
      <td width="67%" height="35"><b> 
        <select size="1" name="selMacroPerfil">
    ...
    <tr> 
      ...
      <td width="67%" height="35"> 
        <input type="text" name="txtNomeTecnico">
      </td>
    </tr>
    <tr> 
      <td width="6%" height="35">&nbsp;</td>
  ...
  <p align="center"><font color="#FF0000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=str_Msg%></font></p>
</form>
</body>
</html>
