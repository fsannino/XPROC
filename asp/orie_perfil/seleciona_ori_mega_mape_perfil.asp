...
{
//alert(" entrei")
window.location.href='seleciona_ori_mega_mape_perfil.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value+'&pOPT='+document.frm1.txtOpt.value
}
  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td width="70%"><font color="#003366" size="3" face="Verdana, Arial, Helvetica, sans-serif">Selecione 
        o Mega-Processo - Perfil - <%=str_Acao%></font></td>
    </tr>
    <tr> 
      <td width="10%">&nbsp;</td>
      <td width="20%">&nbsp;</td>
