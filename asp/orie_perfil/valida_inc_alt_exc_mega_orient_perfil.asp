...
if str_Opt = "IO" then
   ...
   atual=0
   set rs=db.execute("SELECT MAX(ORIE_NR_SEQUENCIAL) AS CODIGO FROM  PERFIL_ORIEN_MEGA WHERE MEPR_CD_MEGA_PROCESSO =" & str_MegaProcesso)
...
elseif str_Opt = "AO" then
  ...
  ' response.Write(" fim orientacao ")
   if str_Orientacoes <> "" then
      int_Tot_Orientacoes = int_Tot_Orientacoes + 1
      ssql=""
      ssql=ssql & "UPDATE PERFIL_ORIEN_MEGA SET "
...
elseif str_Opt = "EO" then
   ...
   if str_CdOrient <> "" then
      int_Tot_Orientacoes = int_Tot_Orientacoes + 1
      ssql=""
      ssql=ssql & "DELETE FROM PERFIL_ORIEN_MEGA "
      ssql=ssql & " WHERE ORIE_NR_SEQUENCIAL = " & str_CdOrient
	  ssql=ssql & " AND MEPR_CD_MEGA_PROCESSO = " & str_MegaProcesso
	  'response.Write(ssql)
      db.execute(ssql)	
...
%>
  ...
  <p style="margin-top: 0; margin-bottom: 0" align="center"><font face="Verdana" color="#330099" size="3">Cadastro 
    de Orienta&ccedil;&otilde;es Mega - Perfil </font></p>
  ...
  <table border="0" width="889" height="162">
    ...
    <tr> 
      <td width="287" height="37"></td>
      <td width="26" height="37"> <p align="right"><a href="seleciona_mega_processo.asp?pOpt=IO"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
    ...
    <tr> 
      <td height="37"></td>
      <td height="37"> <p align="right"><a href="seleciona_ori_mega_mape_perfil.asp?pOpt=AO"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
    ...
    <tr> 
      <td height="37"></td>
      <td height="37"> <p align="right"><a href="seleciona_ori_mega_mape_perfil.asp?pOpt=EO"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
      <td height="37"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Voltar 
