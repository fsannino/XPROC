...
str_SQL = str_SQL & " WHERE (dbo.FUNCAO_NEGOCIO.FUNE_CD_FUNCAO_NEGOCIO = '" & RS("FUNE_CD_FUNCAO_NEGOCIO") & "')"
set rdsPerfil = db.Execute(str_SQL)
if not rdsPerfil.EOF then
%>
<table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="3"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><strong>Orienta&ccedil;&otilde;es dos Perfis </strong></font></div></td>
  </tr>
<%	str_Macro_Anterior = ""
	Do while not rdsPerfil.EOF
		if str_Macro_Anterior <> rdsPerfil("MCPE_TX_NOME_TECNICO") then
  %>
  <tr>
    <td width="17%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Nome Técnico Macro</font></td>
    <td width="83%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><%=rdsPerfil("MCPE_TX_NOME_TECNICO")%></strong></font></td>
  </tr>
  <tr>
    <td width="17%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Desc Macro</font></td>
    <td width="83%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><%=rdsPerfil("MCPE_TX_DESC_MACRO_PERFIL")%></strong></font></td>
  </tr>
  <% end if %>
  <tr>
    <td width="17%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Nome Técnico Micro</font></td>
    <td width="83%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rdsPerfil("MIPE_TX_NOME_TECNICO")%></font></td>
  </tr>
  <tr>
    <td width="17%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Desc Micro</font></td>
    <td width="83%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rdsPerfil("MIPE_TX_DESC_MICRO_PERFIL")%></font></td>
  </tr>
  <tr>
    <td width="17%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Orientação Micro</font></td>
    <td width="83%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rdsPerfil("MIPE_TX_ORIENTACAO")%></font></td>
  </tr>

  <%
  		rdsPerfil.movenext
		if not rdsPerfil.Eof then
			str_Macro_Anterior = rdsPerfil("MCPE_TX_NOME_TECNICO")
		end if
  	Loop
	%>
</table>  
