	...
	<body>	
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%" height="188">
		  ...
		  <tr> 
			...
			<table width="973" border="0" cellpadding="2" cellspacing="2">
			  <tr bgcolor="#ECE9CF">
				<td colspan="10" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Informa&ccedil;&otilde;es Sobre o Curso</b></font>
				</td>
				<td colspan="2" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Informa&ccedil;&otilde;es sobre BPPs</b></font>
				</td>
				<td colspan="7" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Informa&ccedil;&otilde;es Sobre o Material Did&aacute;tico</b></font>
				</td>
			  </tr>
			  <tr bgcolor="#ECE9CF">
				<td width="40" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Sit. Curso</b></font>
				</td>
				<td width="41" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Curso</b></font>
				</td>
				<td width="67" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>T&iacute;tulo</b></font>
				</td>
				<td width="26" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Nº Usu</b></font>
				</td>
				<td width="49" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Carga Hor</b></font>
				</td>
				<td width="58" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Pr&eacute; Requis.</b></font>
				</td>
				<td width="47" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>M&eacute;t de Aplic.</b></font>
				</td>			
				<td width="56" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Status do Curso</b></font>
				</td>
				<td colspan="2" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Previs&atilde;o</b></font>
				</td>
				<td width="70" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Quant. BPPs rel Curso</b></font>
				</td>
				<td width="70" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Quant. BPPs ass Curso</b></font>
				</td>
				<td width="49" align="center" rowspan="2">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Quant. Unid Cad</b></font>
				</td>
				<td colspan="6" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Status</b></font>
				</td>
			  </tr>
			  <tr bgcolor="#ECE9CF">	    
				<td width="37" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Data de Ini</b></font>
				</td>
				<td width="37" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Data de Fim</b></font>
				</td>       
				  
				<td width="30" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Em Elab</b></font>
				</td>
				<td width="26" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Lib p/ PW</b></font>
				</td>
				<td width="30" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Em Ajus</b></font>
				</td>
				<td width="35" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Em Valid</b></font>
				</td>
				<td width="41" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Aprov</b></font>
				</td>
				<td width="48" align="center">
					<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Lib p/ Eq. Pedag</b></font>
				</td>
			  </tr>		
				<%
			...
			if not rs_curso.eof then			
				...
				do until rs_curso.eof = true
					...
					ssql = ""
					'ssql = "SELECT COUNT(USMA_CD_USUARIO) AS CONTA, CURS_CD_CURSO FROM USU_CUR_FUN WHERE USMA_IN_VALIDADO = 'S' AND FUUS_IN_PRIORITARIO=1 "
			      ...
			      <%
					      ...
					      <img src="amarelo.gif" border="0" title="Em Aprovação com Eq. Treinamento"> 
						   ...
						   <%
							...
							<td width="41" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_cd_curso")%><!--Curso--></font>
							</td>
							<td width="67" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_nome_curso")%><!--T&iacute;tulo--></font>
							</td>
							<td width="26" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=int_usuarios%></font>
							</td>
							<td width="49" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_carga_horaria")%><!--Carga Hor&aacute;ria--></font>
							</td>
							<td width="58" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_pre_requisito")%><!--Pr&eacute; Requisito--></font>
							</td>
							<td width="47" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_metodo")%><!--M&eacute;todo de Aplica&ccedil;&atilde;o--></font>
							</td>						
							<td width="56" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_status")%><!--Status do Curso--></font>
							</td>
							
							<td width="37" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_previsao_inicio")%><!--Data de In&iacute;cio--></font>
							</td>
							<td width="37" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_previsao_termino")%><!--Data de T&eacute;rmino--></font>
							</td>  
							
							<td width="70" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_qtd_BPP_rel_curso")%><!--QTD BPP rel Curso--></font>
							</td>  
							
							<td width="70" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_qtd_BPP_ass_curso")%><!--QTD BPP ass Curso--></font>
							</td>    
							
							<td width="49" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_qtd_unidades")%><!--QTD Unidades--></font>
							</td>       
							  
							<td width="30" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_em_elaboracao")%><!--Em Elabora&ccedil;&atilde;o--></font>
							</td>
							<td width="26" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_liberado_procwork")%><!--Liberado para Procwork--></font>
							</td>
							<td width="30" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_em_ajuste")%><!--Em Ajuste--></font>
							</td>
							<td width="35" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_em_validacao")%><!--Em Valida&ccedil;&atilde;o--></font>
							</td>
							<td width="41" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_aprovado")%><!--Aprovado--></font>
							</td>
							<td width="48" align="center">
								<font color="#000080" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs_curso("demo_liberados_eq_pedagogica")%><!--Liberado para a Equipe Pedag&oacute;gica--></font>
							</td>
						</tr>					
						 <%
					intTotal = intTotal + 1
