...
<table width="100%" border="0">
  <!--<tr> 
    <td colspan="3"><table width="89%" border="0">
        <tr> 
          <td width="5%">&nbsp;</td>
          <td width="95%" class="campob">Quem executa:</td>
        </tr>
      </table></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    ...
    <td valign="top" class="campob">Quem executa:</td>     
    <td colspan="3">
    <table width="750" border="0">
        <tr> 
          <td width="198"> 
			<select name="lstRespTecSinGeral" size="5" class="listResponsavel" id="lstRespTecSineGeral">
