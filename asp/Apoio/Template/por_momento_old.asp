...
<table width="80%" border="0">
  <tr> 
    <td width="55%"><div align="center"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>CONSULTA 
        POR MOMENTO</strong></font></div></td>
...
if seleciona=1 then
	...
	ssql=ssql+"WHERE (dbo.APOIO_LOCAL_MULT.APLO_NR_SITUACAO = 1) AND (dbo.APOIO_LOCAL_MULT.APLO_NR_MOMENTO = " & momento & ") "
  ...
  <tr bgcolor="#CCCCCC"> 
    ...
    <td width="258" bgcolor="#CCCCCC"><div align="left"><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">M&oacute;dulo</font></strong></div></td>	
  ...
  <tr valign="middle" bgcolor="<%=cor%>"> 
    <td colspan="2" bgcolor="#FFFFFF" width="39"><font color="#FFFFFF">&nbsp;</font></td>
    <td height="26" width="230" valign="top"> <pre><font color="#0000FF" size="1" face="Arial, Helvetica, sans-serif"><a href="detalhes.asp?op=<%=opti%>&chave=<%=UCASE(rs("CHAVE"))%>"><%=rtrim(rs("NOME"))%></a></font></pre></td>
