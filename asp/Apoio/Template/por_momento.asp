...
ssql=""
ssql="SELECT DISTINCT dbo.APOIO_LOCAL_MULT.APLO_NR_MOMENTO FROM dbo.APOIO_LOCAL_MULT "
ssql=ssql+"ORDER BY dbo.APOIO_LOCAL_MULT.APLO_NR_MOMENTO"
...
<table width="80%" border="0">
  <tr> 
    <td width="55%"><div align="center"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>CONSULTA 
        POR MOMENTO - APOIADOR LOCAL</strong></font></div></td>
...
if trim(momento)=trim(fonte("APLO_NR_MOMENTO")) then
	seleciona=0
	figura="baixo"
else
	seleciona=0
...
case 2
	mom_atual="MOMENTO 2"
case 12
	mom_atual="MOMENTO 1 e 2"
case else
	mom_atual="Nenhum Momento"
end select 

if mom_atual<>"Nenhum Momento" then
%>
  <tr bgcolor="#FFFFFF"> 
    <td width="26"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif"><a name="<%=fonte("APLO_NR_MOMENTO")%>"><img src="<%=figura%>.jpg" width="17" height="20"></a></font></td>
    <td width="7"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
    <td height="28" colspan="4" width="512"><strong><font color="#000066" size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;<a href="por_momento.asp?op=<%=opti%>&momento=<%=fonte("APLO_NR_MOMENTO")%>#<%=fonte("APLO_NR_MOMENTO")%>"><%=mom_atual%></a></font></strong><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
...
'set fonte2=db.execute("SELECT DISTINCT APOIO_LOCAL_MULT.APLO_NR_MOMENTO, APOIO_LOCAL_ORGAO.ORME_CD_ORG_MENOR FROM APOIO_LOCAL_MULT INNER JOIN APOIO_LOCAL_ORGAO ON APOIO_LOCAL_MULT.USMA_CD_USUARIO = APOIO_LOCAL_ORGAO.USMA_CD_USUARIO WHERE APOIO_LOCAL_MULT.APLO_NR_MOMENTO=" & momento & " ORDER BY APOIO_LOCAL_ORGAO.ORME_CD_ORG_MENOR")
set fonte2=db.execute("SELECT DISTINCT APOIO_LOCAL_MULT.APLO_NR_MOMENTO, APOIO_LOCAL_ORGAO.ORME_CD_ORG_MENOR, APOIO_LOCAL_ORGAO.APLO_NR_ATRIBUICAO FROM APOIO_LOCAL_MULT INNER JOIN APOIO_LOCAL_ORGAO ON APOIO_LOCAL_MULT.USMA_CD_USUARIO = APOIO_LOCAL_ORGAO.USMA_CD_USUARIO WHERE APOIO_LOCAL_MULT.APLO_NR_MOMENTO=" & momento & " AND APOIO_LOCAL_ORGAO.APLO_NR_ATRIBUICAO = 1 ORDER BY APOIO_LOCAL_ORGAO.ORME_CD_ORG_MENOR")
...
%>  
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="7"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
	<%
	IF LEN(fonte2("ORME_CD_ORG_MENOR"))=2 THEN
		COMPL=""
	ELSE
		COMPL=""	
	END IF			
	%>
    <td height="28" colspan="4" width="512"><strong><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif"><a name="<%=fonte2("ORME_CD_ORG_MENOR")%>"><img src="<%=figura2%>.jpg" width="17" height="20"></a></font><font color="#000066" size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;<a href="por_momento.asp?op=<%=opti%>&orgao=<%=fonte2("ORME_CD_ORG_MENOR")%>&momento=<%=fonte("APLO_NR_MOMENTO")%>#<%=fonte2("ORME_CD_ORG_MENOR")%>"><%=atual("APOIO")%><%=COMPL%></a></font></strong><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
    <td width="66"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
  </tr>
<%
...
if seleciona2=1 then
	...
	ssql=ssql+"dbo.APOIO_LOCAL_MULT.APLO_NR_MOMENTO, dbo.APOIO_LOCAL_MULT.APLO_NR_ATRIBUICAO "
	...
	ssql=ssql+"WHERE (dbo.APOIO_LOCAL_MULT.APLO_NR_SITUACAO = 1) AND (dbo.APOIO_LOCAL_MULT.APLO_NR_ATRIBUICAO=1) AND (dbo.APOIO_LOCAL_MULT.APLO_NR_MOMENTO = " & momento & ") AND (dbo.APOIO_LOCAL_ORGAO.ORME_CD_ORG_MENOR = '" & orgao & "')"
  ...
  <tr bgcolor="#CCCCCC"> 
    ...
    <td width="117" bgcolor="#CCCCCC"><p align="center"><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">Lotação</font></strong></td>
