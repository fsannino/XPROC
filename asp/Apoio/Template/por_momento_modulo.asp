...
<table width="80%" border="0">
  <tr> 
    <td width="55%"><div align="center"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>CONSULTA 
        POR MOMENTO X ASSUNTO - APOIADOR LOCAL</strong></font></div></td>
...
%>
  <tr bgcolor="#FFFFFF"> 
    ...
    <td height="28" colspan="4" width="512"><strong><font color="#000066" size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;<a href="por_momento_modulo.asp?op=<%=opti%>&momento=<%=fonte("APLO_NR_MOMENTO")%>#<%=fonte("APLO_NR_MOMENTO")%>"><%=mom_atual%></a></font></strong><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
...
ssql=ssql+"WHERE APOIO_LOCAL_MULT.APLO_NR_MOMENTO=" & momento & " AND APOIO_LOCAL_MODULO.APLO_NR_ATRIBUICAO = 1 "
...
if trim(modulo)=trim(fonte2("SUMO_NR_CD_SEQUENCIA")) then
	...
	'set atual=db.execute("SELECT SUMO_TX_DESC_SUB_MODULO AS APOIO FROM SUB_MODULO WHERE SUMO_NR_CD_SEQUENCIA=" & fonte2("SUMO_NR_CD_SEQUENCIA") & "")
...
if seleciona2=1 then
	...
	ssql=ssql+"dbo.APOIO_LOCAL_MULT.APLO_NR_MOMENTO "
	...
	ssql=ssql+"WHERE (dbo.APOIO_LOCAL_MULT.APLO_NR_SITUACAO = 1) AND (dbo.APOIO_LOCAL_MULT.APLO_NR_MOMENTO = " & momento & ") AND (dbo.APOIO_LOCAL_MODULO.SUMO_NR_CD_SEQUENCIA = " & modulo & ") AND (dbo.APOIO_LOCAL_MODULO.APLO_NR_ATRIBUICAO=1)"
