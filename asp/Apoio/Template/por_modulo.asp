...
ssql=""
ssql="SELECT DISTINCT dbo.APOIO_LOCAL_MODULO.SUMO_NR_CD_SEQUENCIA, dbo.SUB_MODULO.SUMO_TX_DESC_SUB_MODULO "
ssql=ssql+"FROM         dbo.APOIO_LOCAL_MODULO INNER JOIN "
ssql=ssql+"dbo.SUB_MODULO ON dbo.APOIO_LOCAL_MODULO.SUMO_NR_CD_SEQUENCIA = dbo.SUB_MODULO.SUMO_NR_CD_SEQUENCIA "
ssql=ssql+"ORDER BY dbo.SUB_MODULO.SUMO_TX_DESC_SUB_MODULO"
...
<table width="80%" border="0">
  <tr> 
    <td width="55%"><div align="center"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>CONSULTA 
        POR ASSUNTO - APOIADOR LOCAL</strong></font></div></td>
...
%>
  ...
  if seleciona=1 then
	...
	ssql=ssql+"dbo.APOIO_LOCAL_MODULO.SUMO_NR_CD_SEQUENCIA, APOIO_LOCAL_MODULO.APLO_NR_ATRIBUICAO "
	...
	ssql=ssql+"WHERE (dbo.APOIO_LOCAL_MULT.APLO_NR_SITUACAO = 1) AND (APOIO_LOCAL_MODULO.APLO_NR_ATRIBUICAO=1) AND (dbo.APOIO_LOCAL_MODULO.SUMO_NR_CD_SEQUENCIA = " & modulo & ") "
