...
SSQL=SSQL+"dbo.USUARIO_MAPEAMENTO ON dbo.APOIO_LOCAL_MULT.USMA_CD_USUARIO = dbo.USUARIO_MAPEAMENTO.USMA_CD_USUARIO WHERE (dbo.APOIO_LOCAL_MULT.APLO_NR_SITUACAO = 1) AND (dbo.APOIO_LOCAL_MULT.APLO_NR_ATRIBUICAO=1)"
...
<table width="80%" border="0">
  <tr> 
    <td width="55%"><div align="center"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>CONSULTA 
        POR NOME - APOIADOR LOCAL</strong></font></div></td>
...
<table width="98%" border="0">
  <tr bgcolor="#CCCCCC"> 
    ...
    <td width="7%" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">Onda</font></strong></div></td>
...
%>
  <tr valign="top" bgcolor="<%=cor%>"> 
	...
	%>
	<td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><%=temp("lotacao")%></font></div></td>
    ...
    <td> <div align="center"> 
        <%
      set onda = db.execute("SELECT * FROM APOIO_LOCAL_ONDA WHERE USMA_CD_USUARIO='" & UCASE(rs("CHAVE")) & "'")
      sl_onda=""
