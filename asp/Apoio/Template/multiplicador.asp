...
SSQL=""
SSQL="SELECT DISTINCT dbo.APOIO_LOCAL_MULT.USMA_CD_USUARIO AS CHAVE, dbo.APOIO_LOCAL_MULT.APLO_NR_ATRIBUICAO AS ATRIBUICAO, dbo.USUARIO_MAPEAMENTO.USMA_TX_NOME_USUARIO AS NOME, "
...
SSQL=SSQL+"dbo.APOIO_LOCAL_MULT.APLO_NR_SITUACAO AS SITUACAO "
SSQL=SSQL+"FROM dbo.APOIO_LOCAL_MULT INNER JOIN "
SSQL=SSQL+"dbo.USUARIO_MAPEAMENTO ON dbo.APOIO_LOCAL_MULT.USMA_CD_USUARIO = dbo.USUARIO_MAPEAMENTO.USMA_CD_USUARIO WHERE (dbo.APOIO_LOCAL_MULT.APLO_NR_SITUACAO = 1) AND (dbo.APOIO_LOCAL_MULT.APLO_NR_ATRIBUICAO=2)"
...
<table width="80%" border="0">
  <tr> 
    <td width="55%"><div align="center"><font color="#000066" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>CONSULTA 
        DE MULTIPLICADORES</strong></font></div></td>
...
<table width="98%" border="0">
  <tr bgcolor="#CCCCCC"> 
    <td width="19%" height="44"><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">Nome</font></strong></td>
    <td width="9%" bgcolor="#CCCCCC"><div align="left"><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">Lota&ccedil;&atilde;o</font></strong></div></td>
    <td width="7%" bgcolor="#CCCCCC"><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif"><strong>Atribui&ccedil;&atilde;o</strong></font></td>
    <td width="9%" bgcolor="#CCCCCC"><div align="center"><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif"><strong>Momento</strong></font></div></td>
    <td width="6%" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">Matricula</font></strong></div></td>
    <td width="6%" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">Chave</font></strong></div></td>
    <td width="7%" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">Ramal</font></strong></div></td>
    ...
    <td width="26%" bgcolor="#CCCCCC"><div align="left"><strong><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">&Oacute;rgao 
...
%>
  <tr valign="top" bgcolor="<%=cor%>"> 
    ...
    %>
    <td> <div align="left"><font size="1" face="Arial, Helvetica, sans-serif"><%=temp("LOTACAO")%></font></div></td>
    <%
	...
	%>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><%=momento%></font></div></td>
    <td> <div align="center"> 
...
<p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font color="#000099">Total 
  de Multiplicadores</font></strong><font color="#000099"> :</font> <%=conta%></font></p>
<p>&nbsp;</p>
</body>
</html>