...
ssql=ssql+"INNER JOIN dbo.ONDA ON dbo.APOIO_LOCAL_ONDA.ONDA_CD_ONDA = dbo.ONDA.ONDA_CD_ONDA "
...
if seleciona=1 then
	...
	ssql=ssql+"dbo.USUARIO_MAPEAMENTO.USMA_TX_MATRICULA AS MATRICULA, dbo.USUARIO_MAPEAMENTO.USUA_TX_RAMAL AS RAMAL, dbo.APOIO_LOCAL_ONDA.ONDA_CD_ONDA, "
	...
	ssql=ssql+"WHERE (dbo.APOIO_LOCAL_MULT.APLO_NR_SITUACAO = 1) AND (dbo.APOIO_LOCAL_ONDA.ONDA_CD_ONDA = " & onda & ") "
