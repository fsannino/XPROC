...
<script language="javascript" src="troca_lista2.js"></script>
...
<form name="frm1" method="POST" action="valida_cad_orgao.asp">
  ...
  <table width="798" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
    ...
    <tr bgcolor="#00FF99"> 
      ...
      <td height="20" width="119"> <p align="right"> <img border="0" src="../../imagens/confirma_f02.gif" onclick="Confirma()"> 
      </td>
...
<p align="center" style="word-spacing: 0; margin-top: 0; margin-bottom: 0">&nbsp;</p>
  <table border="0" width="80%" cellspacing="3" cellpadding="2">
    ...
    <tr>
      <td width="19%" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="18%" bgcolor="#000080"><b><font face="Verdana" size="2" color="#FFFFFF">Atribuição&nbsp;&nbsp;</font></b></td>
      <td width="82%"><font color="#000080" face="Verdana" size="2"><%=ATRIB%> - <%=TIPO%></font></td>
    </tr>
  </table>
  <table border="0" width="93%">
    <tr>
      <td width="54%"></td>
      <td width="46%">
  <p align="center" style="word-spacing: 0; margin-top: 0; margin-bottom: 0"><b><font face="Verdana" color="#800000" size="1">Para
  Excluir um Item da Lista,&nbsp;</font></b></p>
  <p align="center" style="word-spacing: 0; margin-top: 0; margin-bottom: 0"><b><font face="Verdana" color="#800000" size="1"> selecione-o e pressione a tecla DELETE /DEL</font></b></p>
      </td>
    </tr>
  </table>
  <table border="0" width="100%" height="310">
    <tr>
      ...
      <td width="38%" height="22"><font color="#000080" face="Verdana" size="2"><b>Órgão
        Aglutinador</b></font></td>
      <td width="4%" align="center" height="22"></td>
	  <td width="47%" rowspan="11">

<select size="16" name="list1" onKeyUp="apaga_item(event)">
<%
if operacao=1 then
...
&nbsp;
    ...
    <tr>
      ...
      <td width="38%" height="28"><select size="1" name="Str01" onChange="manda01()">
      ...
      <td width="4%" align="center" height="28"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image16','','../../imagens/continua_F02.gif',1)" onClick="move(document.frm1.Str01,document.frm1.list1,0)"><img name="Image16" border="0" src="../../imagens/continua_F01.gif" width="24" height="24"></a></td>
    </tr>
    <tr>
      <td width="9%" height="22"></td>
      <td width="38%" height="22"><font color="#000080" face="Verdana" size="2"><b>Órgão
    ...
    <tr>
      <td width="9%"></td>
      <td width="38%"><select size="1" name="Str02" onChange="manda02()">
      ...
      <td width="4%" align="center"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image16','','../../imagens/continua_F02.gif',1)" onClick="move(document.frm1.Str02,document.frm1.list1,0)"><img name="Image16" border="0" src="../../imagens/continua_F01.gif" width="24" height="24"></a></td>
    </tr>
    <tr>
      <td width="9%" height="22"></td>
      <td width="38%" height="22"><font color="#000080" face="Verdana" size="2"><b> Gerência</b></font></td>
      <td width="4%" align="center" height="22"></td>
    </tr>
    <tr>
      <td width="9%" height="28"></td>
      <td width="38%" height="28"><select size="1" name="Str03" onChange="manda03()">
      ...
      <td width="4%" align="center" height="28"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image16','','../../imagens/continua_F02.gif',1)" onClick="move(document.frm1.Str03,document.frm1.list1,0)"><img name="Image16" border="0" src="../../imagens/continua_F01.gif" width="24" height="24"></a></td>
    </tr>
    <tr>
      <td width="9%" height="21"></td>
      <td width="38%" height="21"><font color="#000080" face="Verdana" size="2"><b> Gerência Setorial</b></font></td>
      <td width="4%" align="center" height="21"></td>
    </tr>
    <tr>
      <td width="9%"></td>
      <td width="38%"><select size="1" name="Str04" onChange="manda04()">
      <OPTION VALUE="0">== Selecione o Nível ==</OPTION>
        <%
      ...
      <td width="4%" align="center"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image16','','../../imagens/continua_F02.gif',1)" onClick="move(document.frm1.Str04,document.frm1.list1,0)"><img name="Image16" border="0" src="../../imagens/continua_F01.gif" width="24" height="24"></a></td>
    </tr>
    <tr>
      <td width="9%" height="21"></td>
      <td width="38%" height="21"><font color="#000080" face="Verdana" size="2"><b>Órgão
        Menor</b></font></td>
      <td width="4%" align="center" height="21"></td>
    </tr>
    <tr>
      <td width="9%" height="27"></td>
      <td width="38%" height="27"><select size="1" name="Str05">
      <OPTION VALUE="0">== Selecione o Nível ==</OPTION>
        <%
      ...
      <td width="4%" align="center" height="27"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image16','','../../imagens/continua_F02.gif',1)" onClick="move(document.frm1.Str05,document.frm1.list1,0)"><img name="Image16" border="0" src="../../imagens/continua_F01.gif" width="24" height="24"></a></td>
    </tr>
    <tr>
      <td width="9%" height="21"></td>
