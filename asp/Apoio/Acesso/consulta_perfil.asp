...
<form name="frm1" method="POST" action="gera_consulta_perfil.asp" target="_top">
   <p align="center" style="word-spacing: 0; margin-top: 0; margin-bottom: 0">&nbsp; </p>
   <table border="0" width="75%">
              <tr><td width="71%">
<p align="center"><b><font face="Verdana" color="#000080">Verificação de Perfil de Acesso R/3</font></b></p>
                         </td>
              </tr>
		   </table>
