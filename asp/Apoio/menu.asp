...
<form name="frm1" method="POST" action="valida_cad_orgao.asp">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
        ...
        <table width="154" border="0" align="right" cellpadding="0" cellspacing="0" bgcolor="#0000CC">
          ...
          <tr> 
            <td bgcolor="#330099" height="12" width="39" valign="middle" align="center"> 
              <div align="center">&nbsp;<b><font color="#000080" face="Verdana" size="4"></font></b></div>
            </td>
            <td bgcolor="#330099" height="12" width="36" valign="middle" align="center"> 
              <div align="center">&nbsp;</div>
            </td>
            <td bgcolor="#330099" height="12" width="27" valign="middle" align="center"> 
              <div align="center"><b><font color="#000080" face="Verdana" size="4"><a href="itens.asp?chave=<%=Session("CdUsuario")%>"><img src="../../imagens/voltar.gif" alt="Sele&ccedil;&atilde;o de Aplica&ccedil;&atilde;o" width="30" height="30" border="0"></a></font></b></div>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr bgcolor="#00FF99"> 
      <td height="20"><font color="#000066" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=tipo%></font></td>
      <td height="20">&nbsp;
      ...
      <td height="20"><div align="center"><font color="#000066" face="Verdana, Arial, Helvetica, sans-serif"><strong>
          </strong></font></div></td>
      <td height="20">&nbsp; </td>
      <td height="20">&nbsp; </td>
    </tr>
  ...
  <p align="center" style="word-spacing: 0; margin-top: 0; margin-bottom: 0"><b><font color="#000080" face="Verdana" size="4">APOIADORES LOCAIS E MULTIPLICADORES </font></b></p>
  <p align="center" style="word-spacing: 0; margin-top: 0; margin-bottom: 0">&nbsp;</p>
  <table border="0" width="87%" height="265">
    <tr>
      <td width="47%" height="261" align="right" valign="top" bordercolor="#000080"> 
        <table border="0" width="856" height="1">
          <tr> 
            <td width="182" rowspan="3" height="65" align="center"></td>
            <td width="157" rowspan="3" height="65" align="right"><img border="0" src="cadastro.jpg" width="88" height="61"></td>
            <td width="2" height="23"></td>
            <td width="489" height="23"></td>
          </tr>
          <tr> 
            <td width="2" height="23"></td>
            <td width="489" height="23"><b><font color="#000080" face="Verdana" size="2"><a href="#" onClick="javascript:procura(1)">NOVO 
              APOIADOR / MULTIPLICADOR</a></font></b></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td width="182" height="9" align="center"></td>
            <td width="157" height="9" align="right"></td>
            <td width="2" height="9"></td>
            <td width="489" height="9"></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td width="489" height="22"><b><font color="#000080" face="Verdana" size="2"><a href="#" onClick="javascript:procura(2)">EDITAR 
              - EXCLUIR APOIADOR / MULTIPLICADOR</a></font></b></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td width="157" rowspan="3" height="70" align="right"><img border="0" src="lupa.jpg" width="91" height="69"></td>
            <td width="2" height="26"></td>
            <td width="489" height="26"></td>
          </tr>
          <tr> 
            <td width="2" height="25"></td>
            <td width="489" height="25"><b><font face="Verdana" size="2"><a href="Template/index.asp?op=1">TEMPLATES 
              DE CONSULTAS</a></font></b></td>
          </tr>
          <tr> 
            <td width="2" height="11"></td>
            <td width="489" height="11"></td>
          ...
          <tr> 
            <td width="182" height="1" align="center"></td>
            <td width="157" height="1" align="right"></td>
            <td width="2" height="1"></td>
            <td width="489" height="1"></td>
          </tr>
        </table>
