...
<form name="frm1" method="POST" action="valida_cad_orgao_cli.asp">
  ...
  <table width="798" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
    ...
    <tr bgcolor="#00FF99"> 
      ...
      <td height="37">
        <p align="right"><a href="menu_cli.asp?cli=<%=Session("cli")%>"><img src="../../../imagens/volta_f02.gif" width="24" height="24" border="0"></a> </td>
...
%>
          ...
          &nbsp; <a href="#" onclick="apaga_item2()"><img src="../excluir.gif" width="110" height="25" border="0" align="absmiddle"></a><BR>
