...
db.execute("DELETE FROM " & Session("prefixo") & "CLI_ORGAO WHERE USMA_CD_USUARIO='" & REQUEST("CHAVE") & "'")
...
Do Until contador = tamanho + 1
    ...
    If str_temp = "," Then
		...
		if tamanho2=2 then		
			...
			ssql=""
			ssql="INSERT INTO " & Session("PREFIXO") & "CLI_ORGAO(USMA_CD_USUARIO,ORME_CD_ORG_MENOR,ATUA_TX_OPERACAO,ATUA_CD_NR_USUARIO,ATUA_DT_ATUALIZACAO)"
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
  ...
  <p style="margin-top: 0; margin-bottom: 0" align="center"><font size="3" face="Verdana" color="#000080">Coordenadores</font></p>
...
<table border="0" width="889" height="86">
  <tr>
      ...
      <td width="26" height="28"><a href="menu_cli.asp?cli=2"><img src="../../../imagens/selecao_F02.gif" width="22" height="20" border="0" align="right"></a></td>
  ...
  <tr>
    <td width="287" height="23"></td>
            <td width="26" height="23">
              <p align="right"><a href="cad_orgao_cli.asp?chave=<%=request("chave")%>"><img src="../../../imagens/selecao_F02.gif" width="22" height="20" border="0"></a></td>
