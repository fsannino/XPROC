...
%>
<p><b><font face="Verdana" size="2">Total de Registros por Dia / Situação - Por Grupo de Solucionadores</font></b></p>
...
<table border="1" cellspacing="1" style="border-collapse: collapse" bordercolor="#758A8A" width="44%" id="AutoNumber1" height="53">
           ...
           <tr>
        	...
        	do until tipo_status.eof=true
	           ...
	           ssql=ssql+" AND SITUACAO='" & tipo_status("SITUACAO") & "' AND CATEGORIA='" & categ & "'"
