...
function redefine()
{
window.location.href='rel_geral.asp'
}
function manda1()
{
window.location.href='rel_geral.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value
}
function manda2()
{
window.location.href='rel_geral.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value+'&selProcesso='+document.frm1.selProcesso.value
}
</script>

<body topmargin="0" leftmargin="0">
<form method="POST" action="gera_rel_geral_back.asp" name="frm1">
