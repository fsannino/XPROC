...
conn_Treinasin.cursorlocation = 3
    ...
    If int_NumReg_Curso > 0 Then
        ...
        Do Until int_NumReg_Curso = int_Loop_Curso
			...
			str_SQL = str_SQL & " AND SUBSTRING(CHAVE,1,1) IN ('H','I','J','K','L','M','N')"			
            ...
            If int_NumReg_TabIncr > 0 Then
                ...
                Do Until int_NumReg_TabIncr = int_Loop_TabIncr
                    ...
                    str_Cd_Usu_Anterior <> rds_TabIncr("CHAVE")
                        ...
                        End If
                    Loop
			'RESPONSE.Write(rds_TabIncr("CHAVE"))
			'IF Trim(str_Cd_Usu_Anterior) = "IS1O" THEN 
			'   RESPONSE.Write(" ACHEI" & "<P>")
			'   RESPONSE.Write(" Qtd aprovado : " & int_Aprovado & "<P>")
			   'RESPONSE.End()
			'end if                    
...
Sub f_grava_registro_curso(str_Cd_Usu_Anterior, str_Cd_Curso, str_Status)
			...
			'RESPONSE.Write(rds_TabIncr("CHAVE"))
			'IF Trim(str_Cd_Usu_Anterior) = "IS1O" and str_Cd_Curso = "MES213" THEN 
			'   RESPONSE.Write(" ACHEI" & "<P>")
			'   RESPONSE.Write(" Curso : " & str_Cd_Curso & "<P>")
			'   RESPONSE.Write(" Status : " & str_Status & "<P>")			   
			   'RESPONSE.End()
			'end if
...
'	IF str_Cd_Usu_Anterior = "IS1O" and str_Cd_Curso = "MES213" THEN 
'	   RESPONSE.Write("aPROV - " & rstRepeticao("USAP_TX_APROVEITAMENTO") & "<p>")
'	   RESPONSE.Write("-  sTATUS - " & str_Status  & "<p>")
'	   'RESPONSE.End()	   
'	END IF
	...
	'				IF str_Cd_Usu_Anterior = "IS1O" and str_Cd_Curso = "MES213" THEN 
				'	   RESPONSE.Write("2aPROV - " & rstRepeticao("USAP_TX_APROVEITAMENTO") & "<p>")
				'	   RESPONSE.Write("-  2sTATUS - " & str_Status  & "<p>")
				'	   'RESPONSE.End()	   
'					END IF
	...
	'				IF str_Cd_Usu_Anterior = "IS1O" and str_Cd_Curso = "MES213" THEN 
				'	   RESPONSE.Write("3aPROV - " & rstRepeticao("USAP_TX_APROVEITAMENTO") & "<p>")
				'	   RESPONSE.Write("-  3sTATUS - " & str_Status  & "<p>")
				'	   'RESPONSE.End()	   
				'	END IF
...
'response.Redirect("importa_usuario_treinasin3.asp")
%>
<html>
<head>
<script>
