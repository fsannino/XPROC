...
function importacao() 
	...
	window.open('importacao.asp?par_PaginaPrint=importa_usuario_treinasin1.asp','jan1','toolbar=no, location=no, scrollbars=no, status=no, directories=no, resizable=no, menubar=no, fullscreen=no, height=50, width=250, status=no, top=200, left=260');
	}
...
<form name="frm1" method="POST" action="">
  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="1">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><a href="javascript:importacao()">Importa Usu&aacute;rio Treinasin1 </a></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
