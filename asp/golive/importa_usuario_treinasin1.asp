...
conn_Treinasin.cursorlocation = 3
    ...
    str_SQL = str_SQL & " USUARIO_APROVADO"
    str_SQL = str_SQL & " WHERE USAP_TX_APROVEITAMENTO = ' '"
    Set rds_CursoAprovado = conn_Cogest.Execute(str_SQL)
    ...
    If int_NumReg_Curso > 0 Then
        ...
        Do Until int_NumReg_Curso = int_Loop_Curso
			...
			str_SQL = str_SQL & " AND SUBSTRING(CHAVE,1,1) IN ('D','E','F','G')"
