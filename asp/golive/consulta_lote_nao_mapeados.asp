...
str_SQL = str_SQL & " ,dbo.GOLI_FUNCAO_USUARIO_SEM_PERFIL.USMA_CD_USUARIO"
str_SQL = str_SQL & " , dbo.USUARIO_MAPEAMENTO.USMA_TX_NOME_USUARIO "
str_SQL = str_SQL & " , dbo.GOLI_FUNCAO_USUARIO_SEM_PERFIL.FUNE_CD_FUNCAO_NEGOCIO"
str_SQL = str_SQL & " , dbo.FUNCAO_NEGOCIO.FUNE_TX_TITULO_FUNCAO_NEGOCIO"
str_SQL = str_SQL & " FROM dbo.GOLI_FUNCAO_USUARIO_SEM_PERFIL INNER JOIN"
str_SQL = str_SQL & " dbo.USUARIO_MAPEAMENTO ON "
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_SEM_PERFIL.USMA_CD_USUARIO = dbo.USUARIO_MAPEAMENTO.USMA_CD_USUARIO INNER JOIN"
str_SQL = str_SQL & " dbo.FUNCAO_NEGOCIO ON "
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_SEM_PERFIL.FUNE_CD_FUNCAO_NEGOCIO = dbo.FUNCAO_NEGOCIO.FUNE_CD_FUNCAO_NEGOCIO"
str_SQL = str_SQL & " WHERE dbo.GOLI_FUNCAO_USUARIO_SEM_PERFIL.LOTE_NR_SEQ_LOTE = " & str_Lote
if str_Ordem = 1 then
	str_SQL = str_SQL & " order by dbo.GOLI_FUNCAO_USUARIO_SEM_PERFIL.USMA_CD_USUARIO  "
else
	str_SQL = str_SQL & " order by dbo.GOLI_FUNCAO_USUARIO_SEM_PERFIL.FUNE_CD_FUNCAO_NEGOCIO "
end if	
...
<form name="frm1" method="POST" action="">
  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="1">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif">Rela&ccedil;&atilde;o de usu&aacute;rios aprovados em fun&ccedil;&atilde;o e  n&atilde;o mapeados em Perfil </font></div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
  ...
  <table width="97%"  border="0" cellspacing="5" cellpadding="1">
    <tr>
      <td width="38%" bgcolor="#00FFFF"><div align="left"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif"> <a href="consulta_lote_nao_mapeados.asp?pLote=<%=str_Lote%>&str_Tipo_Saida=Tela&pOrdem=1">Usu&aacute;rio</a></font></strong></div></td>
      <td width="49%" bgcolor="#00FFFF"><div align="left"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="consulta_lote_nao_mapeados.asp?pLote=<%=str_Lote%>&str_Tipo_Saida=Tela&pOrdem=2">Fun&ccedil;&atilde;o</a></font></strong></div></td>
    ...
    <tr>
      ...
      <td>
	    <div align="center">
		<div align="center"><strong><font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif">Sem perfil</font></strong></div>    </tr>
  ...
  <p align="center">&nbsp;</p>
  <% else %>
  <p align="center">Não existem registros a serem apresentados</p>
  <% end if %>
</form>
</body>
<script>
