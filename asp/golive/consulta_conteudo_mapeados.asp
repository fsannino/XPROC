...
str_SQL = str_SQL & " and dbo.GOLI_FUNCAO_USUARIO.USFU_TX_INDICA_GERA_SAIDA = 'S'"
if str_Ordem = 1 then
...
<form name="frm1" method="POST" action="">
  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="1">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif">Rela&ccedil;&atilde;o de usu&aacute;rios aprovados em fun&ccedil;&atilde;o e   mapeados em Perfil </font></div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
  ...
  <table width="97%"  border="0" cellspacing="5" cellpadding="1">
    ...
    <tr>
      ...
      <td>
	    <div align="center">
		<div align="center"><strong><img src="../../imagens/aprova_02.gif" width="14" height="12"></strong></div>    </tr>
  ...
  <p align="center">Total  mapeado : <%=int_Tot_Nao_Mapeado%></p>
  <p align="center">&nbsp;</p>
  <p align="center">&nbsp;</p>
  <% else %>
