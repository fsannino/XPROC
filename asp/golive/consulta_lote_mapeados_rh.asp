...
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.LOTE_NR_SEQ_LOTE, dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.USMA_CD_USUARIO, "
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.FUNE_CD_FUNCAO_NEGOCIO, "
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.MCPR_NR_SEQ_MACRO_PERFIL, "
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.MIPE_NR_SEQ_MICRO_PERFIL, dbo.MICRO_PERFIL_R3.MIPE_TX_NOME_TECNICO, "
str_SQL = str_SQL & " dbo.VISAO_R3.VISA_NR_SEQ_VISAO,"
str_SQL = str_SQL & " dbo.VISAO_R3.VISA_TX_NOME_TECNICO"
str_SQL = str_SQL & " FROM dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH INNER JOIN"
str_SQL = str_SQL & " dbo.MICRO_PERFIL_R3 ON "
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.MCPR_NR_SEQ_MACRO_PERFIL = dbo.MICRO_PERFIL_R3.MCPR_NR_SEQ_MACRO_PERFIL AND "
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.MIPE_NR_SEQ_MICRO_PERFIL = dbo.MICRO_PERFIL_R3.MIPE_NR_SEQ_MICRO_PERFIL INNER JOIN"
str_SQL = str_SQL & " dbo.VISAO_R3 ON dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.VISA_NR_SEQ_VISAO = dbo.VISAO_R3.VISA_NR_SEQ_VISAO"
str_SQL = str_SQL & " WHERE LOTE_NR_SEQ_LOTE = " &  str_Lote
str_SQL = str_SQL & " order by dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.USMA_CD_USUARIO, "
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.MCPR_NR_SEQ_MACRO_PERFIL, "
str_SQL = str_SQL & " dbo.GOLI_FUNCAO_USUARIO_COM_PERFIL_RH.MIPE_NR_SEQ_MICRO_PERFIL "
...
%>
  ...
  <table width="58%"  border="0" cellspacing="5" cellpadding="1">
    <tr bgcolor="#000099">
      ...
      <td width="48%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Vis&atilde;o</font></strong></div></td>
    </tr>
	<% 
	str_Cd_Usu_anterior = ""
    ...
    <tr>
      ...
      <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rds_Lote_Usu_Fun("VISA_TX_NOME_TECNICO")%></font></div></td>
    </tr>
    ...
    <tr>
      ...
      <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Z:BC_USO_GERAL</font></div></td>
      <td>&nbsp;</td>
    </tr>
<%
			str_Cd_Usu_anterior = rds_Lote_Usu_Fun("USMA_CD_USUARIO")
