...
function Confirma() 
	...
	if(document.frm1.selMegaProcesso.value==0)
		{
    ...
    <tr>
      ...
      <td height="33" colspan="3"><div align="center">
        <table width="100%"  border="0" cellspacing="0" cellpadding="1">
          <tr>
            <td width="14%">&nbsp;</td>
            <td width="62%"><font color="#000080" face="Verdana">Criação de Lote para exportação</font></td>
    ...
    <tr>
      ...
      <td height="24">        <table width="100%"  border="0" cellspacing="0" cellpadding="1">
        ...
        %>
            ...
            <td width="45%"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1611','','../../imagens/continua_F02.gif',1)" onClick="move(document.frm1.Str02,document.frm1.list1,0);carrega_txt1(document.frm1.selFuncaoSele);carrega_txt2(document.frm1.list1);"><img src="../../imagens/continua_F01.gif" alt="Incluir &Iacute;tem" name="Image1611" width="25" height="24" border="0" id="Image161"></a><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1611111','','../../imagens/continua_F02.gif',1)" onClick="move_tudo(document.frm1.Str02,document.frm1.list1,0);carrega_txt1(document.frm1.selFuncaoSele);carrega_txt2(document.frm1.list1);"><img src="../../imagens/seta_dupla_direita.gif" alt="Incluir todos os Ítem" name="Image1611111" width="24" height="24" border="0" id="Image161"></a></td>
          </tr>
        </table></td>
      <td height="24">&nbsp;</td>
    </tr>
