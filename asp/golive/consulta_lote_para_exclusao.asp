...
<form name="frm1" method="POST" action="">
  ...
  <table width="87%"  border="0" cellspacing="5" cellpadding="1">
    <tr bgcolor="#000099">
      ...
      <td width="10%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Exclui Lote </font></strong></div></td>
    </tr>
	<% do while not rds_Lote.Eof %>
    <tr>
      <td><div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rds_Lote("LOTE_NR_SEQ_LOTE")%> - <%=rds_Lote("LOTE_TX_DESCRICAO")%></font></div></td>
      ...
      <td><div align="center"><a href="consulta_lote_mapeados.asp?str_Tipo_Saida=Tela&pLote=<%=rds_Lote("LOTE_NR_SEQ_LOTE")%>&pDescLote=<%=rds_Lote("LOTE_TX_DESCRICAO")%>&pVezesImp=<%=rds_Lote("LOTE_NR_QTD_EXPORTACAO")%>&pOrdem=1"><img src="../../imagens/b04.gif" width="16" height="16" border="0"></a></div></td>
      <td><div align="center"><a href="excluir_lote.asp?str_Tipo_Saida=Tela&pLote=<%=rds_Lote("LOTE_NR_SEQ_LOTE")%>&pDescLote=<%=rds_Lote("LOTE_TX_DESCRICAO")%>&pVezesImp=<%=rds_Lote("LOTE_NR_QTD_EXPORTACAO")%>&pOrdem=1"><img src="../../imagens/cancelar_01.gif" width="16" height="15" border="0"></a></div></td>
    </tr>
    <tr>
