...
<form name="frm1" method="POST" action="">
  ...
  <table width="94%"  border="0" cellspacing="5" cellpadding="1">
    <tr bgcolor="#000099">
      ...
      <td width="6%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Criado por</font></strong></div></td>
      <td width="7%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif"> Cria&ccedil;&atilde;o</font></strong></div></td>
      <td width="10%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Vezes Exportadas </font></strong></div></td>
      <td width="10%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">&Uacute;ltima Exporta&ccedil;&atilde;o </font></strong></div></td>
      <td width="5%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Usu-Func (Ok) </font></strong></div></td>
      <td width="12%"><div align="center"><strong><font color="#FFFF00" size="2" face="Verdana, Arial, Helvetica, sans-serif">Usu-Func (n&atilde;o Ok)</font></strong></div></td>
    </tr>
	...
	%>
      	<a href="consulta_lote_mapeados_rh.asp?str_Tipo_Saida=Tela&pLote=<%=rds_Lote("LOTE_NR_SEQ_LOTE")%>&pDescLote=<%=rds_Lote("LOTE_TX_DESCRICAO")%>&pVezesImp=<%=rds_Lote("LOTE_NR_QTD_EXPORTACAO")%>&pOrdem=1"><img src="../../imagens/b04.gif" width="16" height="16" border="0">
	<%
		end if
	%></a></div></td>
      <td><div align="center"><a href="consulta_lote_nao_mapeados.asp?str_Tipo_Saida=Tela&pLote=<%=rds_Lote("LOTE_NR_SEQ_LOTE")%>&pDescLote=<%=rds_Lote("LOTE_TX_DESCRICAO")%>&pVezesImp=<%=rds_Lote("LOTE_NR_QTD_EXPORTACAO")%>&pOrdem=1"><img src="../../imagens/b04.gif" width="16" height="16" border="0"></a></div></td>
    ...
    <tr>
      <td height="25" colspan="9"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&Oacute;rg&atilde;o:</font></strong> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rds_Lote("LOTE_TX_ORGAO_SELEC")%></font></td>
    </tr>
    <tr>
      <td height="25" colspan="9"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Fun&ccedil;&atilde;o</font></strong>: <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rds_Lote("LOTE_TX_FUNCAO_SELEC")%></font></td>
    </tr>
    <tr bgcolor="#CCCCCC">
