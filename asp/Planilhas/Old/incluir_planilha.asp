...
<form method="post" name="frm1" action="valida_incluir_planilha.asp">
<font face="Arial Narrow" size="3"> 
<input type="hidden" name="planilha" size="20" value="<%=REQUEST("ID")%>"></font>
  ...
  <tr bgcolor="#00FF99">
    <td colspan="3" height="20">
      <table width="625" border="0" align="center">
        <tr>
            <td width="26"><img border="0" src="../../imagens/confirma_f02.gif" width="24" height="24" onclick="javascript:document.frm1.submit()"></td>
          <td width="119"><b><font size="2" face="Verdana" color="#330099">Incluir</font></b></td>
          <td width="27">&nbsp;</td>
          <td width="80"></td>
          <td width="88"></td>
...
<p><b><font face="Arial Narrow" size="4"><%=valor%>   - </font></b><font face="Arial Narrow" size="2">Preencha
os campos em clique em &quot;Incluir&quot;</font></p>
...
<table border="0" width="100%">
   ...
   <td width="56%" bgcolor="<%=cor%>">
    <textarea rows="2" name="<%=ucase(rs.fields(contador).name) & "_" & contador_linha%>" cols="20"></textarea></td>
   <%
   contador = contador+1
   loop
   CONTADOR=0
