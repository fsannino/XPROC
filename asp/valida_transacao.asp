...
<%
str_cod = request("CadCod")
str_tran = Request("CadTransacao")

set db = Server.CreateObject("ADODB.Connection")
db.Open Session("Conn_String_Cogest_Gravacao")

ssql=""
ssql="INSERT INTO " & Session("PREFIXO") & "TRANSACAO "
ssql=ssql & "VALUES('" & ucase(str_tran) & "', "
ssql=ssql & "'C', '" & Session("CdUsuario") & "','" & ucase(str_cod) & "', GETDATE())"
...
<form method="POST" action="valida_altera_processo.asp?mega=<%=str_MegaProcesso%>&Proc=<%=str_Processo%>">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="3%"></td>
      <td width="24%"></td>
      <td width="59%"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000099" size="2"><b>Transação 
    ...
    <tr> 
      ...
      <td width="59%">
        <table width="74%" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr> 
            <td height="41"><a href="cad_transacao.asp"><img src="../imagens/selecao_F02.gif" width="22" height="20" border="0"></a></td>
            <td height="41"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Volta 
              para tela de Cadastro de Transa&ccedil;&atilde;o</font></td>
          </tr>
          <tr> 
