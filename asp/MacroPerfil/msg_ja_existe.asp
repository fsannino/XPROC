<%
if request("txtTitFuncao") <> "" then
   str_funcao = UCase(Trim(request("txtTitFuncao")))
else
   str_funcao = "0"
end if
if request("opt") <> "" then
...
if request("tpDel") <> "" then
   str_Del = request("tpDel")
else
   str_Del = ""
end if
...
<table width="88%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="96%" height="36"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#000099"> 
      <% if str_Opt = 0 then
	      str_Msg = "Já existe um Macro-Perfil cadastrado com este Nome Técnico : " 
		  int_Volta_Tela = "-2"
         elseif str_Opt = 1 then
	      str_Msg = " Registro atualizado com sucesso. "
		  str_funcao = ""	   
		  int_Volta_Tela = "-3"
         elseif str_Opt = 2 then
	      str_Msg = " Registro excluído com sucesso. "
		  str_funcao = ""	   
		  int_Volta_Tela = "-3"
         elseif str_Opt = 3 then
	      str_Msg = " Não encontrado o Macro Perfil a ser excluído. "
		  str_funcao = ""	   
		  int_Volta_Tela = "-3"
         elseif str_Opt = 4 then
	      str_Msg = " Já existe um Macro-Perfil cadastrado com esta Função : "
		  int_Volta_Tela = "-2"
	   end if 
	%>
      </font></b></font></td>
  ...
  <tr> 
    <td width="96%"> 
      <div align="center"><font color="#000099"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="3"><%=str_funcao%>&nbsp; </font></b></font></div>
    </td>
  </tr>
  <tr> 
    <td width="96%">&nbsp;</td>
  ...
  <tr> 
    <td width="96%"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <% if str_Opt = 0 OR str_Opt = 4  then %>
        <tr> 
          <td width="278">&nbsp;</td>
          <td height="1" valign="middle" align="left" width="24"> 
          ...
          <td height="30" valign="middle" align="left" width="357"> <font face="Verdana" color="#330099" size="2">Retornar 
            para Tela Cadastro de Macro-Perfil</font></td>
        </tr>
        <% elseif str_Opt = 1 then %>
        <tr> 
          <td width="278">&nbsp;</td>
          <td height="1" valign="middle" align="left" width="24"> 
            <div align="right"><a href="seleciona_macro_perfil.asp?pOPT=1"> <img border="0" src="../../imagens/selecao_F02.gif" align="right"></a></div>
          </td>
          <td height="30" valign="middle" align="left" width="357"> <font face="Verdana" color="#330099" size="2">Retornar 
            para Tela Alteração de Macro-Perfil</font></td>
        </tr>
        <% elseif str_Opt = 2 then %>
        <tr> 
          <td width="278">&nbsp;</td>
          <td height="1" valign="middle" align="left" width="24"> 
            <div align="right"><a href="seleciona_macro_perfil.asp?pOPT=2"> <img border="0" src="../../imagens/selecao_F02.gif" align="right"></a></div>
          </td>
          <td height="30" valign="middle" align="left" width="357"> <font face="Verdana" color="#330099" size="2">Retornar 
            para Tela Exclusão de Macro-Perfil</font></td>
        </tr>
        <% end if %>
        <tr> 
