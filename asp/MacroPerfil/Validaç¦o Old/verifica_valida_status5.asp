...
set rs=conn_db.execute("SELECT * FROM " & Session("PREFIXO") & "MACRO_PERFIL WHERE MEPR_CD_MEGA_PROCESSO=" & request("selMegaProcesso")  & " AND MCPE_TX_SITUACAO='EC'")
%>
<html>
<head>
<STYLE type=text/css>
    ...
    <td colspan="3" height="20">
      <table width="625" border="0" align="center">
        ...
        <table border="0" width="89%">
          <tr>
            <td width="10%" bgcolor="#330099" align="center"><b><font face="Verdana" size="1" color="#FFFFFF">Validar</font></b></td>
            <td width="26%" bgcolor="#330099"><b><font face="Verdana" size="1" color="#FFFFFF">Macro
              - Perfil</font></b></td>
            <td width="64%" bgcolor="#330099"><b><font face="Verdana" size="1" color="#FFFFFF">Descrição</font></b></td>
          </tr>
          <%
          tem=0
          ...
          <tr>
            <td width="10%" align="center">
              <p align="center"><font color="#330099" face="Verdana" size="1"><input type="checkbox" name="macro_<%=trim(RS("MCPE_TX_NOME_TECNICO"))%>" value="1" onclick="Toggle(this)"></font></td>
            <td width="26%"><font color="#330099" face="Verdana" size="1"><%=RS("MCPE_TX_NOME_TECNICO")%></font></td>
            <td width="64%"><font color="#330099" face="Verdana" size="1"><%=RS("MCPE_TX_DESC_MACRO_PERFIL")%></font></td>
            </tr>
            <%
            tem=tem+1
            RS.MOVENEXT
