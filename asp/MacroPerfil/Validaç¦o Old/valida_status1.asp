...
set rs=conn_db.execute("SELECT * FROM " & Session("PREFIXO") & "MACRO_PERFIL WHERE MEPR_CD_MEGA_PROCESSO=" & request("Mega")  & " AND MCPE_TX_SITUACAO='EE' OR MCPE_TX_SITUACAO='NA' OR MCPE_TX_SITUACAO='EA'")
%>
<html>
<head>
<STYLE type=text/css>
  ...
  <tr bgcolor="#00FF99">
    <td colspan="3" height="20">&nbsp;
        ...
        <table width="512" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
            <td height="41" width="176" align="right"><a href="selec_valida_status1.asp"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
