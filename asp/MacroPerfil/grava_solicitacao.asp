    ...
    <tr> 
      ...
      <td width="59%">
        <table width="74%" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr> 
            <td height="41"><a href="rel_funcao_transacao.asp?txtMacroPerfil=<%=str_MacroPerfil%>&selFuncao=<%=str_Funcao%>&txtNomeTecnico=<%=str_Nome_Tecnico%>"><img src="../../imagens/selecao_F02.gif" width="22" height="20" border="0"></a></td>
