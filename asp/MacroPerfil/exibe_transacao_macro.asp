...
str_SQL_Trans = str_SQL_Trans  & " " & Session("PREFIXO") & "TRANSACAO.TRAN_TX_DESC_TRANSACAO, MEPR_CD_MEGA_PROCESSO, MACRO_PERFIL_TRANSACAO.MCPT_NR_SITUACAO_PROCESSAMENTO,  "
...
<form method="POST" action="../Funcao/grava_funcao_m_p_s_a_trans.asp" name="frm1">
  ...
  <table width="879" border="0" cellpadding="0" cellspacing="0" align="center" height="180">
    ...
    <tr> 
      <td height="2" bgcolor="#0099CC" width="171"> 
      ...
      <td height="2" bgcolor="#0099CC" width="708"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="32%"><strong><font size="2"><img src="../../imagens/novo_registro_02_off.gif" width="22" height="22"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"> 
              Transa&ccedil;&atilde;o inclu&iacute;da na fun&ccedil;&atilde;o</font></font></strong></td>
            <td width="32%"><strong><font size="2"><img src="../../imagens/desiste_F01.gif" width="24" height="24"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">Transa&ccedil;&atilde;o 
              exclu&iacute;da na fun&ccedil;&atilde;o</font></font></strong></td>
            <td width="31%"><img src="../../imagens/confirma_f02.gif" width="24" height="24"><strong><font size="2"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">N&atilde;o 
              processado </font></font></strong></td>
            <td width="5%">&nbsp;</td>
          </tr>
        </table>
      </td>
        ...
        <table width="870" border="0" cellspacing="3" cellpadding="0">
          ...
          <tr bgcolor="<%=ls_Cor_Linha%>"> 
            ...
            <td width="11" bgcolor="<%=ls_Cor_Linha%>"> 
              <p align="center">&nbsp;</p></td>
            <td width="11" bgcolor="<%=ls_Cor_Linha%>">&nbsp;</td>
          </tr>
          <% end if %>
          <tr bgcolor="<%=ls_Cor_Linha%>"> 
            ...
            <td width="25"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><%=rdsTransacao("TRAN_CD_TRANSACAO")%> </b></font></td>
            <%	str_SQL = ""
            ...
            <% if rdsTransacao("MCPT_NR_SITUACAO_PROCESSAMENTO") = 0 then
			      str_Var3 = "confirma_f02.gif"
				  str_Texto3 = ""			
			   elseif rdsTransacao("MCPT_NR_SITUACAO_PROCESSAMENTO") = 1 then
			...
			%>			  
            <td width="11" bgcolor="<%=ls_Cor_Linha%>">
              <p align="center"><img src="../../imagens/<%=str_Var3%>" width="24" height="24" alt="<%=str_Texto3%>"> 
              </p></td>
          </tr>
          <% 
		  	conta=conta+1
