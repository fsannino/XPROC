...
<%
str_cod = Request("CodTransacao")
str_Param = request("DescTransacao")

set db = Server.CreateObject("ADODB.Connection")
db.Open Session("Conn_String_Cogest_Gravacao")

ssql=""
ssql="UPDATE " & Session("PREFIXO") & "TRANSACAO "
ssql=ssql & "SET TRAN_TX_DESC_TRANSACAO='" & Ucase(str_Param) & "' "
ssql=ssql & "WHERE TRAN_CD_TRANSACAO='" & str_cod & "'"
...
db.execute(ssql)
'call grava_log(str_cod,"" & Session("PREFIXO") & "TRANSACAO","A",1)
