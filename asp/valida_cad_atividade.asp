...
<%
str_Ativ = Request("CadAtividade")
str_Seq = Request("CadSequencia")

if isnull(str_Seq) then
	str_Seq=0
end if
...
set rs=db.execute("SELECT MAX(ATCA_CD_ATIVIDADE_CARGA) AS CAMPO FROM " & Session("PREFIXO") & "ATIVIDADE_CARGA")
...
ssql=""
ssql="INSERT INTO " & Session("PREFIXO") & "ATIVIDADE_CARGA ( "
ssql=ssql & " ATCA_TX_DESC_ATIVIDADE,ATCA_CD_ATIVIDADE_CARGA "
ssql=ssql & " ,ATUA_TX_OPERACAO,ATUA_CD_NR_USUARIO "
ssql=ssql & " ,ATUA_DT_ATUALIZACAO,ATCA_NR_SEQUENCIA "
ssql=ssql & ") VALUES('" & ucase(str_Ativ) & "', " & ls_int_Proximo & ","
ssql=ssql & "'C', '" & Session("CdUsuario") & "', GETDATE()," & str_Seq & ")"
...
<%'=ucase(str_Ativ)%></td>
      <td colspan="2" height="20" width="6"><%'=str_Seq%></td>
...
<%'=ssql%></td>
  ...
  <table width="748" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="19"></td>
      <td width="141"></td>
      <td colspan="2"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000099" size="2"><b>Atividade 
        Cadastrada com Sucesso</b></font></td>
      <td width="24"></td>
    </tr>
    <%else%>
    <tr> 
      <td width="19"></td>
      <td width="141"></td>
      <td colspan="2"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#800000">Não 
    ...
    <tr> 
      ...
      <td colspan="2"> 
        <table width="74%" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr> 
            <td height="41"><a href="cad_atividade.asp"><img src="../imagens/selecao_F02.gif" width="22" height="20" border="0"></a></td>
            <td height="41"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Volta 
              para tela de Cadastro de Atividade</font></td>
          </tr>
          <tr> 
