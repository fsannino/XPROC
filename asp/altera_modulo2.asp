...
<%
str_cod = Request("CodModulo")
str_Param = request("DescModulo")

set db = Server.CreateObject("ADODB.Connection")
db.Open Session("Conn_String_Cogest_Gravacao")

ssql=""
ssql="UPDATE " & Session("PREFIXO") & "MODULO_R3 "
ssql=ssql & "SET MODU_TX_DESC_MODULO='" & str_Param & "' "
ssql=ssql & "WHERE MODU_CD_MODULO=" & str_cod
...
db.execute(ssql)
'call grava_log(str_cod,"" & Session("PREFIXO") & "MODULO_R3","A",1)
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="59%"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000099" size="2"><b>Agrupamento 
        ( Master List R/3 ) Atualizado com Sucesso!</b></font></td>
      <td width="14%"></td>
    </tr>
    <%else%>
    <tr> 
