...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td width="63%" bgcolor="#0066CC"><b><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Mega-Processo</font></b></td>
    <td width="16%">&nbsp;</td>
  </tr>
  <tr> 
    <td width="9%">&nbsp;</td>
  ...
  <tr> 
    ...
    <td width="63%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="altera_processo.asp?selMegaProcesso=<%=rdsMegaProcesso("MEPR_CD_MEGA_PROCESSO")%>"><%=rdsMegaProcesso("MEPR_TX_DESC_MEGA_PROCESSO")%></a></font></td>
    <td width="16%">&nbsp;</td>
  </tr>
