...
function goToURL2() {
	window.location.href='exclui3.asp?selMegaProcesso='+document.formulario.selMegaProcesso.value+'&selProcesso='+document.formulario.selProcesso.value
}
function goToURL3() {
	window.location.href='exclui4.asp?selMegaProcesso='+document.formulario.selMegaProcesso.value+'&selProcesso='+document.formulario.selProcesso.value+'&selSubProcesso='+document.formulario.selSubProcesso.value
}
//-->
</script>
...
<table border="0" width="615">
  <tr>
    <td width="278"></td>
    <td width="323">
      <p style="margin-top: 0; margin-bottom: 0"><font face="Verdana" color="#000080" size="3">Exclusão
      de Sub-Processo</font>
  ...
  <table border="0" width="753">
    <tr>
      <td width="95"></td>
      <td width="210"><font face="Verdana" size="2" color="#000080"><b>Selecione o Mega-Processo&nbsp;&nbsp;</b></font></td>
      <td width="428"><font face="Arial" size="2"><select size="1" name="selMegaProcesso" onChange="MM_goToURL('parent','exclui2.asp?txtOpc=1&amp;selMegaProcesso=');return document.MM_returnValue">
  <option value=0>== Selecione ==</option>
    ...
    <tr>
      <td width="95"></td>
      <td width="210"><font face="Verdana" size="2" color="#000080"><b>Selecione o Processo&nbsp;</b></font></td>
      <td width="428"><font face="Arial" size="2">
  <select size="1" name="selProcesso" onChange="javascript:goToURL2()">
    ...
    <tr>
      <td width="95"></td>
      <td width="210"><font face="Verdana" size="2" color="#000080"><b>Selecione
  o Sub-Processo&nbsp;</b></font></td>
      <td width="428"><font face="Arial" size="2"> <select size="1" name="selSubProcesso" onChange="javascript:goToURL3()">
    <option value=0>== Selecione ==</option>
    <%
    DO UNTIL RS3.EOF=TRUE
    IF trim(request.querystring("selSubProcesso"))= trim(rs3("SUPR_CD_SUB_PROCESSO"))THEN
    %>
    <option selected value=<%=rs3("SUPR_CD_SUB_PROCESSO")%>><%=rs3("SUPR_TX_DESC_SUB_PROCESSO")%></option>
	<%
	VALOR=RS3("SUPR_TX_DESC_SUB_PROCESSO")
	ELSE
	%>
  ...
  Atual - Sub-Processo : <%=valor%></b></font></p>
  <p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
      </td>
    </tr>
  </table>
