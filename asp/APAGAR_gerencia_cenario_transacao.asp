...
str_SQL_Cenario = str_SQL_Cenario & " " & Session("PREFIXO") & "CENA_CD_CENARIO, " & Session("PREFIXO") & "CENA_TX_TITULO_CENARIO"
str_SQL_Cenario = str_SQL_Cenario & " FROM " & Session("PREFIXO") & "CENARIO"
str_SQL_Cenario = str_SQL_Cenario & " WHERE " & Session("PREFIXO") & "MEPR_CD_MEGA_PROCESSO = " & str_MegaProcesso
str_SQL_Cenario = str_SQL_Cenario & " AND " & Session("PREFIXO") & "PROC_CD_PROCESSO = " & str_Processo 
str_SQL_Cenario = str_SQL_Cenario & " AND " & Session("PREFIXO") & "SUPR_CD_SUB_PROCESSO = " & str_SubProcesso 
str_SQL_Cenario = str_SQL_Cenario & " order by " & Session("PREFIXO") & "CENA_TX_TITULO_CENARIO "
  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    ...
    <tr> 
      ...
      <td width="52%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','gerencia_cenario_transacao.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%" height="25"> 
        <select name="selProcesso" onChange="MM_goToURL2('self','gerencia_cenario_transacao.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%"> 
        <select name="selSubProcesso" onChange="MM_goToURL3('self','gerencia_cenario_transacao.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
