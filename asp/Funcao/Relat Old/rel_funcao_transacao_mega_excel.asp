...
set rsorigem=db.execute("SELECT * FROM " & Session("PREFIXO") & "MEGA_PROCESSO ORDER BY MEPR_CD_MEGA_PROCESSO")
...
<p align="left" style="margin-top: 0; margin-bottom: 0"><font size="2"><font face="Verdana"><b><font color="#0000CC">Mega-Processo</font>
</b><font size="1" face="Arial Unicode MS" color="#0000CC"> :&nbsp;</font></font><font size="1" face="Arial Unicode MS" color="#0000CC"><%=UCASE(VALOR)%></font>

</font>

<p align="left" style="margin-top: 0; margin-bottom: 0">&nbsp;

<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" id="AutoNumber1" width="680" height="76">
  ...
  %>
  <td width="99" height="34" rowspan="2" bgcolor="#D6F8FC" valign="middle">
    <p align="center" style="margin-top: 0; margin-bottom: 0"><font face="Verdana" size="1"><%=tit_funcao%>  
    </font></p>
 </td>
  <%
  rs.movenext
  ...
  <tr>
   ...
   IF RSTEMP.EOF=TRUE THEN
	%>
   <td width="99" height="21" bgcolor="<%=color%>">
      <p style="margin-top: 0; margin-bottom: 0" align="center"></td>
    <%
	ELSE
	%>
    <td width="100" height="21" bgcolor="<%=color%>">
