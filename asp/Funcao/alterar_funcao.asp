...
set pai=db.execute("SELECT * FROM " & Session("PREFIXO") & "FUNCAO_NEGOCIO WHERE FUNE_TX_INDICA_REFERENCIADA = 0 AND FUNE_CD_FUNCAO_NEGOCIO<>'" & str_funcao & "' AND MEPR_CD_MEGA_PROCESSO=" & str_MegaProcesso & " ORDER BY FUNE_TX_TITULO_FUNCAO_NEGOCIO")
...
str_Sub_Modulo = str_Sub_Modulo & " " & Session("PREFIXO") & "SUB_MODULO.SUMO_NR_CD_SEQUENCIA, "
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
  ...
  <table border="0" width="869" height="348">
    <tr> 
      <td width="23" height="25"></td>
      <td width="99" height="25" valign="top">&nbsp;</td>
      <td height="25" colspan="2"> <font size="2"> <font face="Verdana, Arial, Helvetica, sans-serif"> 
        <font color="#330099"> 
        <input type="hidden" name="selMegaProcesso" value="<%=str_MegaProcesso%>">
        <%'=rs_SubModulo("MEPR_TX_DESC_MEGA_PROCESSO")%>
        </font></font></font></td>
      <td width="429" height="25"> <p align="right"><font face="Verdana" size="2" color="#330099"><b>Fun&ccedil;&atilde;o 
          Gen&eacute;rica: 
	...
	%> <tr>
      <td width="23" height="25"></td>
      <td width="99" height="25" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
      ...
      <td height="25" colspan="3"> <table width="100%" border="0">
          <tr> 
            <td width="59%">&nbsp;</td>
            <td width="41%"><div align="right"><font face="Verdana" size="2" color="#330099"><b>Fun&ccedil;&atilde;o 
                em Uso: 
                <%if rs_func("FUNE_TX_INDICA_EM_USO") = "1" then%>
                <input name="chkEmUso" type="checkbox" id="chkEmUso" value="1" checked>
                <%else%>
                <input name="chkEmUso" type="checkbox" id="chkEmUso" value="0">
                <%end if%>
                </b></font></div></td>
          </tr>
        </table></td>
    ...
    <tr>
      ...
      <td height="25" colspan="3"> <table width="100%" border="0">
          <tr> 
            ...
            <td width="41%"><div align="right"><font face="Verdana" size="2" color="#330099"><b>Fun&ccedil;&atilde;o 
                Antecipada: 
                <%if rs_func("FUNE_NM_ANTECIPADA") = "1" then%>
                <input name="chkAntec" type="checkbox" value="1" checked <%=block%>>
                <%else%>
                <input name="chkAntec" type="checkbox" value="1" <%=block%>>
                <%end if%>
                </b></font></div></td>
          </tr>
    ...
    <tr>
      <td width="23" height="25">&nbsp;</td>
      <td width="99" height="25" valign="top"> &nbsp;</td>
      <td height="25" colspan="3"> <p align="right" style="margin-top: 0; margin-bottom: 0"><font face="Verdana" size="1" color="#FF0000">As Funções Antecipadas não </font></p>
         <p align="right" style="margin-top: 0; margin-bottom: 0"><font face="Verdana" size="1" color="#FF0000">fazem parte do Escopo atual</font></td>
    </tr>
    <%end if%>
    <tr>
      <td height="86" rowspan="4"></td>
      <td height="86" rowspan="4" valign="top"><font face="Verdana" size="2" color="#330099"><b>Assunto</b></font></td>
      <td width="254" height="86" rowspan="4"><p><font color="#31009C" size="1" face="Verdana, Arial, Helvetica, sans-serif">Assuntos Dispon&iacute;veis </font>
        </p>
        <p>
          <select name="selAssunto" size="5" multiple>
            <%do until rs_SubModulo.eof=true
		set temp1=db.execute("SELECT * FROM FUNCAO_NEGOCIO_SUB_MODULO WHERE FUNE_CD_FUNCAO_NEGOCIO='" & str_funcao & "' AND SUMO_NR_CD_SEQUENCIA=" & rs_SubModulo("SUMO_NR_CD_SEQUENCIA"))
      ...
      <td height="86" rowspan="4"><p><font color="#31009C" size="1" face="Verdana, Arial, Helvetica, sans-serif">Assuntos Selecionado </font>
        </p>
        <p>
		...
		ssql=ssql+"WHERE FUNCAO_NEGOCIO.FUNE_CD_FUNCAO_NEGOCIO='" & str_funcao & "' "		
    ...
    <tr>
      <td height="21"><div align="center"><img src="continua_F01.gif" width="24" height="24" onClick="move(document.frm1.selAssunto,document.frm1.listAss,1)"></div></td>
    </tr>
    <tr>
      <td height="21"><div align="center"><img src="continua2_F01.gif" width="24" height="24" onClick="move(document.frm1.listAss,document.frm1.selAssunto,1)"></div></td>
    </tr>
    <tr>
      <td height="21">&nbsp;</td>
    </tr>
    <tr> 
      <td width="23" height="25"></td>
      <td width="99" height="25" valign="top"><font face="Verdana" size="2" color="#330099"><b>Fun&ccedil;&atilde;o 
        R/3</b></font></td>
      <td height="25" colspan="3"> <input type="text" name="txtfuncao" size="58" value="<%=rs_func("FUNE_TX_TITULO_FUNCAO_NEGOCIO")%>" maxlength="100"> 
      </td>
    </tr>
    <tr> 
      <td width="23" height="83"></td>
      <td width="99" height="83" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
      ...
      <td height="83" valign="top" colspan="3"> <p align="left" style="margin-top: 0; margin-bottom: 0"> 
    ...
    <tr> 
      ...
      <td width="99" height="19" valign="top"><input type="hidden" name="pai" size="10" value="0"> 
      </td>
      <td height="19" valign="top" colspan="3"><input name="txtAss" type="hidden" id="txtAss"> </td>
    </tr>
  </table>
...
<table border="0" cellpadding="0" cellspacing="0" width="841">
  <tr>
    ...
    <td width="686" height="19" bgcolor="#D3D3D3">&nbsp;</td>
  </tr>
  <tr>
    <td width="90" height="19" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="102" height="19" bgcolor="#D3D3D3">&nbsp;</td>
    <td width="686" height="19" bgcolor="#D3D3D3"><font face="Verdana" size="1" color="#330099"><b>Se
  ...
  <tr>
    ...
    <td width="686" height="19" bgcolor="#D3D3D3"><select size="1" name="selFuncaoPai" onchange="javascript:verifica_valor()">
          <option value="0">== Selecione a Funcao Pai ==</option>
          <%do until pai.eof=true
          if trim(rs_func("FUNE_CD_FUNCAO_NEGOCIO_PAI"))=trim(pai("FUNE_CD_FUNCAO_NEGOCIO")) then
          %>
          <option selected value=<%=pai("FUNE_CD_FUNCAO_NEGOCIO")%>><%=pai("FUNE_CD_FUNCAO_NEGOCIO")%>-<%=pai("FUNE_TX_TITULO_FUNCAO_NEGOCIO")%></option>
          <%else%>
  ...
  <tr>
    ...
    <td width="686" height="13" bgcolor="#D3D3D3"><font face="Verdana" size="1" color="#330099">(Este 
