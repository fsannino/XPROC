...
if (document.frm1.selFuncao.selectedIndex == 0)
	{ 
     ...
     {
	 document.frm1.txtDescMegaProcesso.value = document.frm1.selMegaProcesso.options[document.frm1.selMegaProcesso.selectedIndex].text;	 
	 document.frm1.txtDescFuncao.value = document.frm1.selFuncao.options[document.frm1.selFuncao.selectedIndex].text;	 	 
     document.frm1.submit();
	 }
	}
...
<form name="frm1" method="post" action="edita_funcao_transacao.asp">
  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    <tr> 
      ...
      <td width="46%" height="5"> 
        <div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"> 
          Edita Fun&ccedil;&atilde;o R/3 x Transa&ccedil;&atilde;o</font> 
        </div>
      </td>
    ...
    <tr> 
      ...
      <td width="46%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','edita_func_tra_selec_Meg_Fun.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
      ...
      <td width="11%">
        <input type="hidden" name="txtDescMegaProcesso" value="1">
      </td>
      <td width="17%"> 
        <%'=str_SQL_MegaProc%>
      </td>
...
While (NOT rdsFuncao.EOF)
          ...
          <option value="<%=(rdsFuncao.Fields.Item("FUNE_CD_FUNCAO_NEGOCIO").Value)%>" selected ><%=(rdsFuncao.Fields.Item("FUNE_TX_TITULO_FUNCAO_NEGOCIO").Value)%></option>
          <% else %>
          <option value="<%=(rdsFuncao.Fields.Item("FUNE_CD_FUNCAO_NEGOCIO").Value)%>"><%=(rdsFuncao.Fields.Item("FUNE_TX_TITULO_FUNCAO_NEGOCIO").Value)%></option>
          <% end if %>
          <%
  rdsFuncao.MoveNext()
Wend
...
%>
      ...
      <td width="11%" height="25">
        <input type="hidden" name="txtDescFuncao" value="1">
      </td>
    ...
    <tr> 
      ...
      <td width="46%">&nbsp; </td>
      <td width="11%" height="21"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp; 
        </font></td>
