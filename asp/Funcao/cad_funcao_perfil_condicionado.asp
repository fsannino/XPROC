...
str_SQL_Perf_Cond = ""
str_SQL_Perf_Cond = str_SQL_Perf_Cond & " SELECT " & Session("PREFIXO") & "PERFIL_CONDICIONAL.MEPR_CD_MEGA_PROCESSO, "
str_SQL_Perf_Cond = str_SQL_Perf_Cond & " " & Session("PREFIXO") & "PERFIL_CONDICIONAL.PECO_CD_PERFIL_CONDICIONADO, "
str_SQL_Perf_Cond = str_SQL_Perf_Cond & " " & Session("PREFIXO") & "PERFIL_CONDICIONAL.PECO_TX_DESCRICAO
str_SQL_Perf_Cond = str_SQL_Perf_Cond & " FROM " & Session("PREFIXO") & "PERFIL_CONDICIONAL "
str_SQL_Perf_Cond = str_SQL_Perf_Cond & " WHERE " & Session("PREFIXO") & "PERFIL_CONDICIONAL.MEPR_CD_MEGA_PROCESSO = " & str_MegaProcesso
'response.write str_SQL_Proc_Sub_Proc
Set rdsPerf_Cond = Conn_db.Execute(str_SQL_Perf_Cond)
...
<form method="POST" action="grava_funcao_m_p_s_a_trans.asp" name="frm1">
  ...
  <table border="0" width="736" height="6" align="center">
    <tr> 
      <td width="155" height="1"> </td>
      <td height="1" colspan="4" width="633"> </td>
    </tr>
    <tr> 
      <td width="155" height="1"> </td>
      <td height="1" colspan="4" width="633"> </td>
    ...
    <tr> 
      ...
      <td height="4" colspan="4" width="633"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
  ...
  <table width="666" border="0" cellpadding="0" cellspacing="0" align="center" height="180">
    ...
    <tr valign="top"> 
      <td colspan="2" height="10"> 
        <% If rdsPerf_Cond.EOF then
		        ls_msg = "Não encontrado Perfil Condicionado para esta seleção"
			 else
				ls_msg = ""
			 end if			 	
		  %>
        <%=ls_msg%> 
        <% do while Not rdsPerf_Cond.EOF
		   %>
        <table width="666" border="0" cellspacing="3" cellpadding="0">
          ...
          <tr bgcolor="<%=ls_Cor_Linha%>"> 
            ...
            <td width="530"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b><%=rdsPerf_Cond("PECO_CD_PERFIL_CONDICIONADO, ")%> </b>- <%=rdsPerf_Cond("PECO_TX_DESCRICAO")%></font></td>
            <td width="64" bgcolor="<%=ls_Cor_Linha%>"> 
              <div align="center"> 
                ...
                <% ls_SQL = ""
                   ...
                   ls_SQL = ls_SQL & " " & Session("PREFIXO") & "FUN_NEG_PER_CON.PECO_CD_PERFIL_CONDICIONADO, "
                   ls_SQL = ls_SQL & " " & Session("PREFIXO") & "FUN_NEG_PER_CON.FUNE_CD_FUNCAO_NEGOCIO "
                   ls_SQL = ls_SQL & " FROM " & Session("PREFIXO") & "FUN_NEG_PER_CON "
                   ls_SQL = ls_SQL & " WHERE " & Session("PREFIXO") & "FUN_NEG_PER_CON.PECO_CD_PERFIL_CONDICIONADO = '" & 1 & "'"  
                   ls_SQL = ls_SQL & " and " & Session("PREFIXO") & "FUN_NEG_PER_CON.FUNE_CD_FUNCAO_NEGOCIO = '" & 1 & "'"
          ...
          <tr bgcolor="<%=ls_Cor_Linha%>"> 
            ...
            <td width="64" bgcolor="<%=ls_Cor_Linha%>">&nbsp;</td>
          </tr>
          <tr bgcolor="<%=ls_Cor_Linha%>"> 
            <td width="60">&nbsp;</td>
            <td width="530"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b><%=rdsAtiv_Trans("TRAN_CD_TRANSACAO")%> </b>- <%=rdsAtiv_Trans("TRAN_TX_DESC_TRANSACAO")%></font></td>
            <td width="64" bgcolor="<%=ls_Cor_Linha%>">&nbsp;</td>
          </tr>
          <% 
