...
do until rs.eof=true
	...
	ssql=""
	ssql="UPDATE " & Session("Prefixo") & "FUNCAO_NEGOCIO SET FUNE_TX_INDICA_CRITICA =" & val
...
<table border="0" width="94%" height="114">
  ...
  <tr>
    ...
    <td width="5%" align="center" height="39"><a href="sel_func_critico.asp"><img src="selecao_F02.gif" border="0" align="left"></a></td>
    <td width="61%" colspan="2" height="39"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Voltar
      para a tela de Associação de Funções Críticas</font></td>
  </tr>
  <tr>
