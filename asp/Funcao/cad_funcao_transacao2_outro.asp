...
str_SQL_Proc_Sub_Proc = str_SQL_Proc_Sub_Proc & " WHERE " & Session("PREFIXO") & "RELACAO_FINAL.MEPR_CD_MEGA_PROCESSO = " & str_MegaProcesso2
...
<form method="POST" action="grava_funcao_m_p_s_a_trans.asp" name="frm1">
  ...
  <table border="0" width="736" height="94" cellpadding="0" cellspacing="0" align="center">
    <tr> 
      ...
      <td width="499" height="21" colspan="2"><font face="Verdana" color="#330099" size="3">Relação 
        Fun&ccedil;&atilde;o R/3 x Transação - Outro Mega</font></td>
      <td height="21" width="67"> <div align="center"><font face="Verdana" size="1" color="#330099">Transações 
          inseridas</font></div></td>
    </tr>
    <tr> 
      <td width="10" height="14">&nbsp;</td>
      <td width="160" height="14"> <div align="right"><font size="2"><font face="Verdana" color="#330099">Mega-Processo: 
          </font></font></div></td>
      <td width="249" height="14"><b><font face="Verdana" size="2" color="#330099"><%=str_MegaProcesso%>-<%=ls_str_DescMegaProcesso%> 
      ...
      <td width="250" rowspan="3" align="center">
<div align="center"><img src="../../Flash/preloader.gif" name="loader" width="190" height="50" id="loader"></div></td>
      <td height="14" width="67"> <div align="center"><b><font face="Verdana" size="2" color="#330099"><a href="javascript:exibe_transacao()"><img border="0" src="../../imagens/icon_empresa.gif" align="absmiddle"></a></font></b></div></td>
    </tr>
    <tr> 
      <td width="10" height="14">&nbsp;</td>
      <td width="160" height="14"> <div align="right"><font face="Verdana" size="2" color="#330099">Fun&ccedil;&atilde;o 
          R/3: </font></div></td>
      <td width="249" height="14"><b><font face="Verdana" size="2" color="#330099"><%=str_Funcao%> 
    ...
    <tr> 
      ...
      <td width="249" height="23"><b><font face="Verdana" size="2" color="#330099"><%=ls_str_TituloFuncao%></font><font face="Verdana" size="1" color="#330099"> 
    ...
    <tr bgcolor="#0099CC"> 
      ...
      <td width="499" height="4" colspan="2"></td>
  ...
  <table border="0" width="779" height="6" align="center">
    ...
    <tr> 
      ...
      <td height="4" colspan="4"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso2" onChange="MM_goToURL1('self','cad_funcao_transacao2_outro.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td height="4" colspan="4"> 
        <select name="selProcesso" onChange="MM_goToURL1('self','cad_funcao_transacao2_outro.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td height="15" colspan="4"> 
        <select name="selSubProcesso" onChange="MM_goToURL1('self','cad_funcao_transacao2_outro.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
        ...
        <table width="82%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr> 
            ...
            <td width="78%"> <font face="Arial, Helvetica, sans-serif" size="2" color="#003300"><b> 
              <select name="selAtividadeCarga" onChange="MM_goToURL1('self','cad_funcao_transacao2_outro.asp');return document.MM_returnValue">
                <% 
		  if str_Opc <> "1" then %>
        ...
        <table width="666" border="0" cellspacing="3" cellpadding="0">
          ...
          <tr bgcolor="<%=ls_Cor_Linha%>"> 
            <td width="60"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
              ...
              <%'=str_MegaProcesso2%> </font></td>
            <td width="530"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
              <%   str_SQL = ""
                   ...
                   str_SQL = str_SQL & " WHERE " & Session("PREFIXO") & "TRANSACAO_MEGA.TRAN_CD_TRANSACAO = '" & rdsAtiv_Trans("TRAN_CD_TRANSACAO") & "'" 
				   str_SQL = str_SQL & " order by " & Session("PREFIXO") & "MEGA_PROCESSO.MEPR_CD_MEGA_PROCESSO "
                   'str_SQL = str_SQL & " AND TRANSACAO_MEGA.MEPR_CD_MEGA_PROCESSO = " & str_MegaProcesso2				   
				   ...
				   IF not rdsExiste2.EOF then
				      Do While not rdsExiste2.EOF
                         a = rdsExiste2("MEPR_TX_DESC_MEGA_PROCESSO")
				 ...
				 %>
              <b><%=rdsAtiv_Trans("TRAN_CD_TRANSACAO")%> </b>- <%=rdsAtiv_Trans("TRAN_TX_DESC_TRANSACAO")%><i><font color="#999999"><%=str_Mega%></font></i></font></td>
            <td width="64" bgcolor="<%=ls_Cor_Linha%>"> 
              <div align="center"> 
				...
				%>
                <a href="javascript:MM_goToURL5('self','exc_funcao_trans.asp',this,'selFuncao=<%=str_Funcao%>&selMegaProcesso2=<%=rdsProc_Sub_Proc("MEPR_CD_MEGA_PROCESSO")%>&selProcesso=<%=rdsProc_Sub_Proc("PROC_CD_PROCESSO")%>&selSubProcesso=<%=rdsProc_Sub_Proc("SUPR_CD_SUB_PROCESSO")%>&selAtividadeCarga=<%=rdsProc_Sub_Proc("ATCA_CD_ATIVIDADE_CARGA")%>&selModulo=<%=rdsAtiv_Trans("MODU_CD_MODULO")%>&selTransacao=<%=rdsAtiv_Trans("TRAN_CD_TRANSACAO")%>','imgMarca<%=ls_Seq%>')"> 
                <% 
				   if loo_Existe = True then  				   				   
				%>
                <img src="../../imagens/<%=ls_Imagem%>" width="16" height="16" align="absmiddle" border="1" name="imgMarca<%=ls_Seq%>"></a> 
                <%
				   end if
				%>
              </div>
