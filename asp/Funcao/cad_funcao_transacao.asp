  ...
  <table border="0" width="779" height="6" align="center">
    ...
    <tr> 
      ...
      <td height="4" colspan="4"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso2" onChange="MM_goToURL1('self','cad_funcao_transacao.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td height="4" colspan="4"> 
        <select name="selProcesso" onChange="MM_goToURL1('self','cad_funcao_transacao.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td height="15" colspan="4"> 
        <select name="selSubProcesso" onChange="MM_goToURL1('self','cad_funcao_transacao.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
          ...
          <table width="82%" border="0" cellspacing="0" cellpadding="0">
            <tr> 
              ...
              <td width="78%"> <font face="Arial, Helvetica, sans-serif" size="2" color="#003300"><b> 
                <select name="selAtividadeCarga" onChange="MM_goToURL1('self','cad_funcao_transacao.asp');return document.MM_returnValue">
                  <% 
		  if str_Opc <> "1" then %>
