...
<form name="frm1" method="post" action="cad_funcao_transacao2.asp">
  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    ...
    <tr> 
      <td width="26%">&nbsp;</td>
      <td width="46%"> 
        <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Para 
          outros Megas</font></div>
      </td>
      <td width="11%">&nbsp;</td>
      <td width="17%">&nbsp;</td>
    </tr>
    <tr> 
      ...
      <td width="46%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','selec_Mega_Funcao_outro.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <% If str_MegaProcesso = 11 or str_MegaProcesso = 5  then	 
