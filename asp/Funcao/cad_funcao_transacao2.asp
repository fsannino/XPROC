...
function MM_goToURL5() { //v3.0
 ...
 if(x.src == valor) {
	...
	{
  // if(document.frm1.imgMarca1.src == "http://www.s6000ws12.corp.petrobras.biz/xproc/imagens/b03.gif") 
...
<form method="POST" action="grava_funcao_m_p_s_a_trans.asp" name="frm1">
  ...
  <table border="0" width="736" height="94" cellpadding="0" cellspacing="0" align="center">
    <tr> 
      ...
      <td height="21" colspan="2"><font face="Verdana" color="#330099" size="3">Relação 
    ...
    <tr> 
      ...
      <td width="328" height="14"><b><font face="Verdana" size="2" color="#330099"><%=str_MegaProcesso%>-<%=ls_str_DescMegaProcesso%> 
      ...
      <td width="171" rowspan="3"><div align="center"><img src="../../Flash/preloader.gif" name="loader" width="190" height="50" id="loader"></div></td>
    ...
    <tr> 
      ...
      <td width="160" height="14"> <div align="right"><font face="Verdana" size="2" color="#330099">Fun&ccedil;&atilde;o 
          R/3: </font></div></td>
      <td width="328" height="14"><b><font face="Verdana" size="2" color="#330099"><%=str_Funcao%> 
    ...
    <tr> 
      ...
      <td width="328" height="23"><b><font face="Verdana" size="2" color="#330099"><%=ls_str_TituloFuncao%></font><font face="Verdana" size="1" color="#330099"> 
  ...
  <table border="0" width="779" height="6" align="center">
    ...
    <tr> 
      ...
      <td height="4" colspan="4"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso2" onChange="MM_goToURL1('self','cad_funcao_transacao2.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td height="4" colspan="4"> 
        <select name="selProcesso" onChange="MM_goToURL1('self','cad_funcao_transacao2.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td height="15" colspan="4"> 
        <select name="selSubProcesso" onChange="MM_goToURL1('self','cad_funcao_transacao2.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
        ...
        <table width="82%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr> 
            ...
            <td width="78%"> <font face="Arial, Helvetica, sans-serif" size="2" color="#003300"><b> 
              <select name="selAtividadeCarga" onChange="MM_goToURL1('self','cad_funcao_transacao2.asp');return document.MM_returnValue">
                <% 
		  if str_Opc <> "1" then %>
...
'		str_SQL_Ativ_Trans2 = str_SQL_Ativ_Trans2 & " AND FUNE_CD_FUNCAO_NEGOCIO = '" & str_Funcao & "')"
		...
		'response.write str_SQL_Ativ_Trans2
		'response.End()
