...
<body topmargin="0" leftmargin="0" bgcolor="#FFFFFF" onLoad="pega_tamanho();MM_preloadImages('../../imagens/continua_F02.gif','../../imagens/continua2_F02.gif')">
<form method="POST" action="valida_cad_funcao.asp" name="frm1">
  ...
  <table width="771" height="65" border="0">
    <tr>
      ...
      <td height="24" colspan="3" valign="middle"><select size="1" name="selMegaProcesso" onChange="javascript:manda1()">
      ...
      <td width="161" height="24" valign="middle">
    ...
    <tr>
      ...
      <td height="21" valign="middle"><font face="Verdana" size="2" color="#330099"><b>
  ...
  <table border="0" width="771" height="313">
    <% 'If str_MegaProcesso = 11 then
	'if InStrRev("11/10", Right("00" & str_MegaProcesso, 2)) <> 0 then	 
	'if rs_mega("MEPR_CD_MEGA_PROCESSO") = 11 then
	%>
    <tr> 
      ...
      <td width="179" height="25" rowspan="5" align="center" valign="middle"> <select name="selAssunto" size="5" multiple>
      ...
      <td width="199" rowspan="5" align="center" valign="middle"><select size="5" name="select">
        <%do until rs_SubModulo.eof=true%>
        <%
					rs_SubModulo.movenext
					loop
      ...
      <td width="161" height="25" rowspan="5"><font face="Verdana" size="2" color="#330099"><b> 
        </b></font></td>
    </tr>
    <tr>
      <td align="center" valign="middle"><input name="imageField" type="image" src="continua_F01.gif" width="24" height="24" border="0"></td>
    </tr>
    <tr>
      <td align="center" valign="middle">&nbsp;</td>
    </tr>
    <tr>
      <td align="center" valign="middle"><input name="imageField2" type="image" src="continua2_F01.gif" width="24" height="24" border="0"></td>
    </tr>
    <tr>
      <td align="center" valign="middle">&nbsp;</td>
    </tr>
    ...
    <tr> 
      ...
      <td width="121" height="25" valign="top"><font face="Verdana" size="2" color="#330099"><b>Fun&ccedil;&atilde;o 
        R/3</b></font></td>
      <td height="25" colspan="4"> <input type="text" name="txtfuncao" size="58" maxlength="100"> 
      </td>
    </tr>
    <tr> 
      ...
      <td width="121" height="121" valign="top"><font face="Verdana" size="2" color="#330099"><b> 
        ...
        <input type="hidden" name="txtQua" size="20"> <input type="hidden" name="txtImp" size="20"> 
      </td>
