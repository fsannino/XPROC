...
ssql = ssql & "FUNCAO_NEGOCIO.FUNE_TX_TIPO_CLASS "
...
ssql = ssql & " WHERE FUNCAO_NEGOCIO.MEPR_CD_MEGA_PROCESSO=" & str_mega 
...
<html>
	...
	<body topmargin="0" leftmargin="0" link="#0000FF" vlink="#0000FF" alink="#0000FF">
		<form method="POST" action="valida_func_classifica.asp" name="frm1">          
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr> 				  
				  <td colspan="3" align="center"><p align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#330099"><b>Define o Tipo de Classificação para Função</b></font></td>
				</tr>
				<tr> 
				  <td width="32%">&nbsp;</td>
				  <td width="48%">&nbsp;</td>
				...
				<% if rs.EOF then %>
				<tr>				  
				  <td colspan="3" align="center"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Não foi encontrado resultado para esta consulta.</font></div></td>
				</tr>
			...
			<table border="0" width="85%" cellspacing="0" cellpadding="2" height="75">
			  <tr>
				...
				<td width="3%" bgcolor="#000080" height="21" colspan="3"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF" size="2">&nbsp;<b>Fun&ccedil;&atilde;o de Negócio</></font></td>
			  </tr>
			  <tr>
				<td height="21"></td>
				<td height="21"><span class="style1"></span></td>
				<td><span class="style1"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="relaciona_func_classifica.asp?pOrdem=1&selMegaProcesso=<%=str_Mega%>&selSubModulo=<%=str_SubModulo%>">C&oacute;digo</a></font></b></span></td>
				<td height="21"><span class="style1"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">ou <a href="relaciona_func_classifica.asp?pOrdem=2&selMegaProcesso=<%=str_Mega%>&selSubModulo=<%=str_SubModulo%>">T&iacute;tulo</a> - (escolha ordena&ccedil;&atilde;o) </font></b></span></td>
			  </tr>
			  <% 
			  int_Tot_Registro = 0
			  int_TipoClass = "0"
			  do until rs.eof=true
				  ...
				  int_TipoClass  = rs("FUNE_TX_TIPO_CLASS")	
				  %>
				  <tr>
					...
					<td width="3%" height="33" bgcolor="<%=cor%>">
					  <p align="center">
						<font size="1">
							<select name="sel_<%=rs("fune_cd_funcao_negocio")%>">
							  <%if int_TipoClass = "0" then%>
								<option value="0" selected>&nbsp;NENHUMA&nbsp;</option>
							  <%else%>
								<option value="0">&nbsp;NENHUMA&nbsp;</option>
							  <%end if%>
								
							  <%if int_TipoClass = "1" then%>
								<option value="1" selected>&nbsp;EBP</option>
							  <%else%>
								<option value="1">&nbsp;EBP</option>
							  <%end if%>
							  
							  <%if int_TipoClass = "2" then%>
								<option value="2" selected>&nbsp;EMERGE</option>
							  <%else%>
								<option value="2">&nbsp;EMERGE</option>
							  <%end if%>
							</select>				  		
						 </font>
					</td>				
			...
			<p align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Total de Registros:&nbsp;<%=int_Tot_Registro%></font></p>
		</form>		
		<p>&nbsp;</p>
