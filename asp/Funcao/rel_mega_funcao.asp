...
<form name="frm1" method="post" action="gera_rel_mega_funcao.asp">
  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    ...
    <tr> 
      ...
      <td width="46%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','rel_mega_funcao.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
