   ...
   if str_Uso = 1 then
      ...
      if str_Desuso = 1 then
         str_usoDesuso = " AND FUNE_TX_INDICA_EM_USO = '0' "
     	 ...
     	 str_usoDesuso = " AND FUNE_TX_INDICA_EM_USO = '2' "
	  end if	 
	end if        	  
end if
...
if str_MegaProcesso = 0 then
	...
	ssql = ssql & "AND FUNE_CD_FUNCAO_NEGOCIO NOT IN (SELECT DISTINCT FUNE_CD_FUNCAO_NEGOCIO FROM CURSO_FUNCAO)"	
	...
	if str_modulo <> "0" then
		...
		ssql = ssql & " AND FUNC_NEG.FUNE_CD_FUNCAO_NEGOCIO NOT IN (SELECT DISTINCT FUNE_CD_FUNCAO_NEGOCIO FROM CURSO_FUNCAO)"		
...
<html>
		...
		<form method="POST" action="" name="frm1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
				  <td>
					<div align="center">
					  <p align="left" style="margin-top: 0; margin-bottom: 0"><font face="Verdana" color="#330099" size="3">Relatório de Fun&ccedil;&atilde;o Sem Cursos</font></div>
				  </td>
				</tr>
			</table>
			...
			<table border="0" width="100%">
			  <tr>
				<td width="35%" bgcolor="#330099"><b><font face="Verdana" size="2" color="#FFFFFF">Mega-Processo</font></b></td>
				<td width="65%" bgcolor="#330099"><b><font face="Verdana" size="2" color="#FFFFFF">Função</font></b></td>				
			  </tr>
			  <%          
			  tem=0
			  int_Tot_Mega = 0
			  ...
			  <tr>
					...
					%>
					<td width="35%" bgcolor="<%=cor%>"><font face="Verdana" size="2" color="#330099"><b><%=strNomeMega%></b></font></td>
					<%
					if atual2 <> ant2 then
					...
					%>
					<td width="65%" bgcolor="<%=cor%>"><font face="Verdana" size="2" color="#330099"><%=strNomeFuncao%></font></td>
					<%					
					tem = tem + 1
    ...
    <tr>
			...
			<p align="center">Total Registro: <%=tem%>
