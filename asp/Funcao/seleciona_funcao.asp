...
if str_OPT <> 5 then
   if str_OPT <> 4 and str_OPT <> 9 then
	   if str_OPT <> 8 then
...
<%
if str_OPT <> 8 and str_OPT <> 10 then
%>
<script>
function manda()
{
window.location.href='seleciona_funcao.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value+'&selSubModulo='+'&pOPT='+document.frm1.txtOPT.value
}
...
function Confirma()
{
   if(document.frm1.selMegaProcesso.selectedIndex == 0)
    ...
    if((document.frm1.txtOPT.value != 6)&&(document.frm1.txtOPT.value != 7)&&(document.frm1.txtOPT.value != 8)&&(document.frm1.txtOPT.value != 9))
	  { 
	  ...
	  if(document.frm1.txtOPT.value == 9)
        {		
        document.frm1.action="rel_func_curso.asp";        
        document.frm1.submit();
        }								
     }
}
...
function Confirma()
{
   if((document.frm1.txtOPT.value != 6)&&(document.frm1.txtOPT.value != 7)&&(document.frm1.txtOPT.value != 8)&&(document.frm1.txtOPT.value != 10))
	  { 
      if(document.frm1.selFuncao.selectedIndex == 0)
        {
        alert("É obrigatória a seleção de uma FUNÇÃO DE NEGÓCIO!");
      ...
      if(document.frm1.txtOPT.value == 8)
	   ...
	   if(document.frm1.txtOPT.value == 10)
        {		
        document.frm1.action="rel_func_sem_curso.asp";        
        document.frm1.submit();
        }				 
     }
}
...
<form method="POST" action="alterar_funcao.asp" name="frm1">
  ...
  <tr bgcolor="#00FF99">
    ...
    <%
if str_OPT  = 1 then
   str_Titulo = "ALTERAÇÃO DE FUNÇÃO"
elseif str_OPT  = 2 then
   str_Titulo = "EXCLUSÃO DE FUNÇÃO"
elseif str_OPT  = 3 then
   str_Titulo = "FUNÇÃO DE NEGÓCIO X TRANSAÇÕES - MESMO MEGA"
elseif str_OPT  = 4 then
   str_Titulo = "FUNÇÃO DE NEGÓCIO X TRANSAÇÕES - OUTRO MEGA"
elseif str_OPT  = 5 then
   str_Titulo = "CONSULTA FUNÇÃO X TRANSAÇÃO"
elseif str_OPT  = 6 then
   str_Titulo = "ALTERAÇÃO DE ASSUNTO EM MASSA"
elseif str_OPT  = 7 then
   str_Titulo = "RELAÇÃO DE FUNÇÃO SEM ASSUNTO"
elseif str_OPT  = 8 then
   str_Titulo = "RELAÇÃO DE FUNÇÃO CONFLITANTE"
elseif str_OPT  = 9 then
   str_Titulo = "RELAÇÃO DE FUNÇÃO X CURSO"
elseif str_OPT  = 10 then
   str_Titulo = "RELAÇÃO DE FUNÇÃO SEM CURSO" 
else
