...
str_SQL=""
str_SQL = str_SQL+"SELECT DISTINCT FUNCAO_NEGOCIO.FUNE_CD_FUNCAO_NEGOCIO, FUNCAO_NEGOCIO.FUNE_TX_TITULO_FUNCAO_NEGOCIO "
str_SQL = str_SQL+"FROM FUNCAO_NEGOCIO_SUB_MODULO "
str_SQL = str_SQL+"RIGHT JOIN FUNCAO_NEGOCIO ON "
str_SQL = str_SQL+"FUNCAO_NEGOCIO_SUB_MODULO.FUNE_CD_FUNCAO_NEGOCIO= FUNCAO_NEGOCIO.FUNE_CD_FUNCAO_NEGOCIO "
str_SQL = str_SQL+" WHERE FUNCAO_NEGOCIO.FUNE_NR_SEQUENCIA > 0 " 
str_SQL = str_SQL+" AND FUNCAO_NEGOCIO_SUB_MODULO.SUMO_NR_CD_SEQUENCIA IS NULL "
...
<form name="frm1" method="POST" action="../Cenario/grava_alteracao_assunto.asp">
  ...
  <table width="100%" border="0">
    ...
    <tr> 
      <td>&nbsp;</td>
      <td><div align="center"><font color="#330099" size="3" face="Verdana">Assuntro 
          de Fun&ccedil;&atilde;o</font></div></td>
  ...
  <table width="85%" height="27" border="0" cellspacing="3">
    <% str_Contador = 0
     do until rs.eof=true
       str_Contador = str_Contador + 1
  %>
    <tr> 
      <td width="10%" height="21"><b></b></td>
      <td width="90%"><font face="Verdana" size="2"><a href="../funcao/exibe_dados_funcao.asp?selMegaProcesso=<%=str_MegaProcesso%>&selFuncao=<%=rs("FUNE_CD_FUNCAO_NEGOCIO")%>"><%=rs("FUNE_CD_FUNCAO_NEGOCIO")%></a>- <%=rs("FUNE_TX_TITULO_FUNCAO_NEGOCIO")%></font></td>
    </tr>
    <%
    rs.movenext
    loop
