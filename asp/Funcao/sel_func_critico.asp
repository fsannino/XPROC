...
function manda()
{
window.location.href='sel_func_critico.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value
}
...
<form method="POST" action="relaciona_func_critico.asp" name="frm1">
