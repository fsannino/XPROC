...
do until rs.eof=true
	val = request("func_" & rs("FUNE_CD_FUNCAO_NEGOCIO"))
	if val=1 then
		val=val
	else
		val=0
	...
	ssql=""
	ssql="UPDATE " & Session("Prefixo") & "FUNCAO_NEGOCIO SET FUNE_TX_LIBERADO_MANUT_PERF =" & val
...
<table border="0" width="94%" height="114">
  ...
  <tr>
    ...
    <td width="5%" align="center" height="39"><a href="sel_func_libera_mapeamento.asp"><img src="selecao_F02.gif" border="0" align="left"></a></td>
    <td width="61%" colspan="2" height="39"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Voltar
      para a tela de Sele&ccedil;&atilde;o de Fun&ccedil;&atilde;o </font></td>
  </tr>
  <tr>
