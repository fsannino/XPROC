...
'response.redirect "http://its_server3/mail_resp_exc.asp?mega=" & Request("selMegaProcesso2") & "&user=" & Session("CdUsuario") & "&opt=exclusão&funcao="& str_funcao &"&transac=" & str_transacao & "&chave=" & session("CdUsuario")
response.redirect "mail_resp_exc.asp?mega=" & Request("selMegaProcesso2") & "&user=" & Session("CdUsuario") & "&opt=exclusão&funcao="& str_funcao &"&transac=" & str_transacao & "&chave=" & session("CdUsuario")
