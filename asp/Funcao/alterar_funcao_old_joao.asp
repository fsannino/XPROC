...
function manda1()
{
window.location.href='alterar_funcao.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value+'&selFuncao='+document.frm1.selFuncao.value
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
  ...
  <table width="750" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="748"><%'=rs_func("FUNE_TX_TP_FUN_NEG")%></td>
    </tr>
  </table>
  <table border="0" width="749" height="164">
    <tr> 
      <td width="72" height="25"></td>
      <td width="150" height="25" valign="top"><font face="Verdana" size="2" color="#330099"><b>Mega-Processo</b></font></td>
      <td width="367" height="25"> 
        <select size="1" name="selMegaProcesso" onChange="javascript:manda1()">
          <option value="0">== Selecione o Mega-Processo ==</option>
          <%do until rs.eof=true
          if trim(str_MegaProcesso)=trim(rs("MEPR_CD_MEGA_PROCESSO")) then
                	%>
