    ...
    <td colspan="3" height="20">
      <table width="625" border="0" align="center">
        <tr>
          ...
          <td width="50"></td>
          <td width="26">&nbsp;</td>
            <td width="94"><img src="../imagens/print.gif" width="90" height="35" border="0" onclick="javascript:print()"></td>
          <td width="128">
            <p align="center"><a href="gera_rel_geral_excel.asp?selMegaProcesso=<%=mega%>&amp;selProcesso=<%=proc%>&amp;selSubProcesso=<%=subr%>&amp;selModulo=<%=modulo%>&amp;selAtividade=<%=atividade%>&amp;selTransacao=<%=transacao%>" target="blank"><img border="0" src="../imagens/exp_excel.gif"></a></td>
          <td width="50"></td>
          <td width="28"></td>
          <td width="26">&nbsp;</td>
          <td width="159"></td>
