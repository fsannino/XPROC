...
<table border="0" width="615">
  ...
  <table border="0" width="708">
    <tr>
      ...
      <td width="397"><font face="Arial" size="2"><select size="1" name="selMegaProcesso" onChange="MM_goToURL('parent','exclui2.asp?txtOpc=1&amp;selMegaProcesso=');return document.MM_returnValue">
