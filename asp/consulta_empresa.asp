...
if str_ativ=0 then
	...
	set rs=db.execute("SELECT * FROM " & Session("PREFIXO") & "ATIVIDADE_CARGA_EMPRESA_UNID WHERE ATCA_CD_ATIVIDADE_CARGA=" & str_ativ)
end if
%>
<html>
<head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <%
    if str_ativ>0 then
    set rs1=db.execute("SELECT * FROM " & Session("PREFIXO") & "ATIVIDADE_CARGA WHERE ATCA_CD_ATIVIDADE_CARGA=" & str_ativ)
    valor=rs1("ATCA_TX_DESC_ATIVIDADE")
    %>
    <td width="62%">&nbsp;<font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000080"><b>Empresas 
      para a Atividade : </b><%=str_ativ%> - <%=valor%></font></td>
    <%end if%>
    <td width="16%">&nbsp;</td>
  </tr>
  <%if str_ativ=0 then%>
  <tr> 
    <td width="9%">&nbsp;</td>
    <td width="13%" bgcolor="#0066CC"><b><a href="consulta_empresa.asp?order=1"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">C&oacute;digo</font></a></b></td>
    <td width="62%" bgcolor="#0066CC"><b><a href="consulta_empresa.asp?order=2"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Empresas</font></a></b></td>
    <td width="16%">&nbsp;</td>
  </tr>
  <%ELSE%>
  <tr> 
