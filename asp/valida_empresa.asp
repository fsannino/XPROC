...
<%
str_emp = Request("CadEmpresa")

set db = Server.CreateObject("ADODB.Connection")
db.Open Session("Conn_String_Cogest_Gravacao")

set rs=db.execute("SELECT MAX(EMPR_CD_NR_EMPRESA) AS CAMPO FROM " & Session("PREFIXO") & "EMPRESA_UNIDADE")
...
ssql=""
ssql="INSERT INTO " & Session("PREFIXO") & "EMPRESA_UNIDADE "
ssql=ssql & " ( EMPR_TX_NOME_EMPRESA, EMPR_CD_NR_EMPRESA"
ssql=ssql & " ,ATUA_TX_OPERACAO, ATUA_CD_NR_USUARIO, "
ssql=ssql & " ATUA_DT_ATUALIZACAO"
ssql=ssql & ") VALUES('" & ucase(str_emp) & "', "
...
<form method="POST" action="valida_altera_processo.asp?mega=<%=str_MegaProcesso%>&Proc=<%=str_Processo%>">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="3%"></td>
      <td width="24%"></td>
      <td width="59%"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000099" size="2"><b>Empresa 
    ...
    <tr> 
      ...
      <td width="59%">
        <table width="83%" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr> 
            <td height="41"><a href="cad_empresa.asp"><img src="../imagens/selecao_F02.gif" width="22" height="20" border="0"></a></td>
            <td height="41"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Volta 
              para tela de Cadastro de Empresa / Unidade</font></td>
          </tr>
          <tr> 
