...
if (document.frm1.selUsuario.selectedIndex == 0)
     { 
	 alert("A seleção de um usuário é obrigatório!");
     document.frm1.selUsuario.focus();
     return;
     }
	 else
     {
 	  window.location.href='relacao_usu_mega_proc.asp?selUsu='+document.frm1.selUsuario.value
	 }
 }
...
<form name="frm1" method="post" action="relacao_usu_mega_proc.asp">
  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td width="6%">&nbsp;</td>
      <td width="26%">&nbsp;</td>
      <td width="68%"><font color="#003366" size="3" face="Verdana, Arial, Helvetica, sans-serif">Acesso 
    ...
    <tr> 
      ...
      <td width="68%"> 
        <select name="selUsuario" size="1" onchange="javascript:Confirma()">
