...
function MM_goToURL3() { //v3.0
  ...
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+document.frm1.selSubProcesso.value+"'");
}
...
<form name="frm1" method="post" action="form_relaciona_ativ_trans3.asp">
  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    <tr>
      ...
      <td width="12%"><%'=str_Opc%></td>
      <td width="17%"> <%'=str_MegaProcesso%><%'=str_Processo%></td>
    </tr>
    <tr> 
      <td width="19%"> 
      ...
      <td width="52%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','selec_Mega_Proc_Sub_Processo.asp?txtOpc=2');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%" height="25"> 
        <select name="selProcesso" onChange="MM_goToURL2('self','selec_Mega_Proc_Sub_Processo.asp?txtOpc=3',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
      ...
      <td width="12%" height="25"> 
        <table width="60" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="30"> 
              <div align="center"><a href="javascript:MM_goToURL4('self','cadas_Processo.asp',this)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image13','','../imagens/novo_registro_02.gif',1)"><img name="Image13" border="0" src="../imagens/novo_registro_02_off.gif" width="22" height="22" alt="Inclui novo Processo"></a></div>
            </td>
            <td width="30"> 
              <div align="center"><a href="JavaScript:history.go()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image14','','../imagens/atualiza_02.gif',1)"><img name="Image14" border="0" src="../imagens/atualiza_02_off.gif" width="22" height="22" alt="Recarrega novo Processo"></a></div>
            </td>
          </tr>
        </table>
      </td>
...
%>
      ...
      <td width="12%" height="21"> 
        <table width="60" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="30">
              <div align="center"><a href="javascript:MM_goToURL5('self','cadas_sub_processo.asp',this)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image15','','../imagens/novo_registro_02.gif',1)"><img name="Image15" border="0" src="../imagens/novo_registro_02_off.gif" width="22" height="22" alt="Inclui novo Sub Processo"></a></div>
            </td>
            <td width="30">
              <div align="center"><a href="JavaScript:history.go()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image16','','../imagens/atualiza_02.gif',1)"><img name="Image16" border="0" src="../imagens/atualiza_02_off.gif" width="22" height="22" alt="Recarrega novo Sub Processo"></a></div>
            </td>
          </tr>
        </table>
