...
<%
str_cod = Request("CodEmpresa")
str_Param = request("DescEmpresa")

set db = Server.CreateObject("ADODB.Connection")
db.Open Session("Conn_String_Cogest_Gravacao")

ssql=""
ssql="UPDATE " & Session("PREFIXO") & "EMPRESA_UNIDADE "
ssql=ssql & "SET EMPR_TX_NOME_EMPRESA='" & str_Param & "' "
ssql=ssql & "WHERE EMPR_CD_NR_EMPRESA=" & str_cod
...
db.execute(ssql)
'call grava_log(str_cod,"" & Session("PREFIXO") & "EMPRESA_UNIDADE","A",1)
