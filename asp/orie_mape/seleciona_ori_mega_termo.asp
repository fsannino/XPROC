...
window.location.href='seleciona_ori_mega_termo.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value+'&pOpt='+document.frm1.txtOpt.value
}
  ...
  //else
	// {
     ...
     if(document.frm1.txtOpt.value == "AT")
       {
       document.frm1.action="alterar_excluir_ori_mega_mape_termos.asp";
  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td width="70%"><font color="#003366" size="3" face="Verdana, Arial, Helvetica, sans-serif">Selecione 
        o Mega-Processo - Termo - <%=str_Acao%></font></td>
    </tr>
    <tr> 
      <td width="10%">&nbsp;</td>
      <td width="20%">&nbsp;</td>
...
%>
    ...
    <tr> 
      ...
      <td width="20%"><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b>Selecione 
          Termo :</b></font></div></td>
      <td width="70%"><select name="selTermo" size="1" id="selTermo">
