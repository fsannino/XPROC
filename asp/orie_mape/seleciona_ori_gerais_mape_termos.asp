...
str_SQL = str_SQL & " from FUN_ORIEN_GERAL_TERMOS "
...
function Confirma()
{
  ...
  if (document.frm1.selTermo.selectedIndex == 0)
   ...
   if(document.frm1.txtOpt.value == "A")
     {
     document.frm1.action="alterar_excluir_ori_gerais_mape_termos.asp";
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="53%"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Seleciona 
          termos novos Relevantes - GERAL - <%=str_Titulo%></font></div></td>
