...
{
//alert(" entrei")
window.location.href='seleciona_ori_mega_mapeamento.asp?selMegaProcesso='+document.frm1.selMegaProcesso.value+'&pOPT='+document.frm1.txtOpt.value
}
...
{ 
  ...
  if (document.frm1.selOrient.selectedIndex == 0)
     { 
	 alert("A seleção de uma Orientação é obrigatório!");
     document.frm1.selOrient.focus();
     return;	 
	 }
     if(document.frm1.txtOpt.value == "AO")
       {
       document.frm1.action="alterar_excluir_ori_mega_mapeamento.asp";
       //document.frm1.target="corpo";
       document.frm1.submit();
       }
     if(document.frm1.txtOpt.value == "EO")
       {
       document.frm1.action="alterar_excluir_ori_mega_mapeamento.asp";
       //document.frm1.target="corpo";
       document.frm1.submit();
...
<form name="frm1" method="post" action="">
  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0">
	...
	<% str_Acao = ""
	   If str_Opt = "AO" then
	      str_Acao = "ALTERAÇÃO"
	   elseIf str_Opt = "EO" then
	      str_Acao = "EXCLUSÃO"
	   elseIf str_Opt = "ZO" then
	      str_Acao = "XXXXX"	   
	   end if
	%>
    <tr> 
      ...
      <td width="70%"><font color="#003366" size="3" face="Verdana, Arial, Helvetica, sans-serif">Selecione 
        o Mega-Processo - <%=str_Acao%></font></td>
    </tr>
    <tr> 
      <td width="10%">&nbsp;</td>
      <td width="20%">&nbsp;</td>
      <td width="70%"><div align="right"><a href="relat_ori_gerais_mega_mapeamento.asp?txtMegaProcesso=<%=str_MegaProcesso%>"><img src="../../imagens/conteudo_01.gif" width="18" height="22" border="0"></a><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
          <a href="relat_ori_gerais_mega_mapeamento.asp?txtMegaProcesso=<%=str_MegaProcesso%>">Relat&oacute;rio 
          completo</a> </font> </div></td>
    </tr>
    <tr> 
      <td width="10%">&nbsp;</td>
      <td width="20%"><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b>Mega-Processo 
          : </b></font></div></td>
...
%>
    ...
    <tr> 
      ...
      <td width="70%"> <table width="89%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="61%">&nbsp;</td>
    ...
    <tr> 
      <td width="10%">&nbsp;</td>
      <td width="20%"><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b>Selecione 
          Orienta&ccedil;&atilde;o :</b></font></div></td>
      <td width="70%"><select name="selOrient" size="1" id="selOrient">
          <option value="0">== Selecione uma Orientação ==</option>
          <% set rs=Conn_db.execute(str_SQL)
		     do until rs.eof=true %>
          <option value="<%=rs("ORIE_NR_SEQUENCIAL")%>"><%=rs("ORIE_NR_SEQUENCIAL")%> 
          - <%=Left(rs("ORIE_TX_ORIENTACOES"),90)%></option>
          <% rs.movenext
			loop %>
        </select></td>
    </tr>
