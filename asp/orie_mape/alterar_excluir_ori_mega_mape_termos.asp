...
If str_Opt = "ET" then
   response.redirect "valida_inc_alt_exc_mega_termos.asp?txtOpt=ET&txtCdTermo="&str_Cd_Termo&"&txtMegaProcesso="&str_MegaProcesso
end if
...
str_SQL = str_SQL & " and ORTE_NR_SEQUENCIAL = " & str_Cd_Termo
...
<form name="frm1" method="POST" action="valida_inc_alt_exc_mega_termos.asp">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="53%"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Alterar 
          termos novos Relevantes - Mega</font></div></td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td></td>
      <td><input name="txtOpt" type="hidden" value="<%=str_Opt%>"> <input name="txtCdTermo" type="hidden" value="<%=str_Cd_Termo%>"> 
