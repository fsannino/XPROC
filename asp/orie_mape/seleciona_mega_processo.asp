  ...
  //else
	// {
     ...
     if(document.frm1.txtOpt.value == "IO")
       {
       document.frm1.action="inclui_ori_mega_mapeamento.asp";
       //document.frm1.target="corpo";
       document.frm1.submit();
       }
     if(document.frm1.txtOpt.value == "IT")
       {
       document.frm1.action="inclui_ori_mega_mape_termos.asp";
       //document.frm1.target="corpo";
       document.frm1.submit();
       }
     ...
     if(document.frm1.txtOpt.value == "IM")
       {
       document.frm1.action="inclui_ori_mega_mape_submodulo.asp";
       //document.frm1.target="corpo";
       document.frm1.submit();
       }
     if(document.frm1.txtOpt.value == "AM")
       {
       document.frm1.action="alterar_excluir_ori_mega_mape_submodulo.asp";
       //document.frm1.target="corpo";
       document.frm1.submit();
       }
...
<form name="frm1" method="post" action="inclui_ori_mega_mapeamento.asp">
  ...
  <table width="88%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td width="5%">&nbsp;</td>
      <td width="29%">&nbsp;</td>
      <td width="66%"><font color="#003366" size="3" face="Verdana, Arial, Helvetica, sans-serif">Selecione 
        <%=str_Titulo%></font></td>
    </tr>
    <tr> 
      <td width="5%">&nbsp;</td>
      <td width="29%"><input type="hidden" name="txtOpt" value="<%=str_Opt%>">
        <input type="hidden" name="txtOpt2" value="<%=str_Opt2%>"></td>
      <td width="66%"><div align="right"><a href="relat_ori_gerais_mega_mapeamento.asp?txtMegaProcesso=<%=str_MegaProcesso%>"><img src="../../imagens/conteudo_01.gif" width="18" height="22" border="0"></a><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
          <a href="relat_ori_gerais_mega_mapeamento.asp?txtMegaProcesso=<%=str_MegaProcesso%>">Relat&oacute;rio 
          completo</a> </font> </div></td>
    </tr>
    <tr> 
      <td width="5%">&nbsp;</td>
      <td width="29%"><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b>Mega-Processo 
          : </b></font></div></td>
      <td width="66%"> <select name="selMegaProcesso"  onChange="javascript:manda1()">
