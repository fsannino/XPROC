...
set rs=db.execute("SELECT MAX(ORTE_NR_SEQUENCIAL) AS CODIGO FROM  FUN_ORIEN_GERAL_TERMOS")
...
str_SQL = str_SQL & " from FUN_ORIEN_MEGA_MODULO "
...
if not rdsDescModulo.EOF then
   response.redirect "msg.asp?pOpt=0"
end if
...
str_SQL = str_SQL & " FUN_ORIEN_MEGA_MODULO.MEPR_CD_MEGA_PROCESSO "
str_SQL = str_SQL & " , FUN_ORIEN_MEGA_MODULO.SUMO_NR_CD_SEQUENCIA "
str_SQL = str_SQL & " , FUN_ORIEN_MEGA_MODULO.ORTE_TX_DESCRICAO "
str_SQL = str_SQL & " , SUB_MODULO.SUMO_TX_DESC_SUB_MODULO "
str_SQL = str_SQL & " FROM dbo.FUN_ORIEN_MEGA_MODULO INNER JOIN dbo.SUB_MODULO ON dbo.FUN_ORIEN_MEGA_MODULO.SUMO_NR_CD_SEQUENCIA = dbo.SUB_MODULO.SUMO_NR_CD_SEQUENCIA "
...
<form name="frm1" method="POST" action="valida_inc_alt_exc_mega_submodulo.asp">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="53%"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Incluir 
          descri&ccedil;&atilde;o para Assunto - MEGA</font></div></td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
        <input name="txtOpt" type="hidden" value="IM">
    ...
    <tr> 
      <td></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Assunto 
