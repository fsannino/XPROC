...
if str_Opt = "I" then
   ...
   For i = 1 to 4
       if str_Orientacoes(i) <> "" then
		  ...
		  atual = atual + 1
          ssql=""
          ssql="INSERT INTO " & Session("PREFIXO") & "FUN_ORIEN_GERAL ("
...
elseif str_Opt = "A" then
   ...
   if str_Orientacoes <> "" then
      int_Tot_Orientacoes = int_Tot_Orientacoes + 1
      ssql=""
      ssql=ssql & "UPDATE FUN_ORIEN_GERAL SET "
...
elseif str_Opt = "E" then
   ...
   if str_CdOrient <> "" then
      int_Tot_Orientacoes = int_Tot_Orientacoes + 1
      ssql=""
      ssql=ssql & "DELETE FROM FUN_ORIEN_GERAL "
      ssql=ssql & " WHERE ORIE_NR_SEQUENCIAL = " & str_CdOrient
	  'response.Write(ssql)
      db.execute(ssql)	
   end if  
...
%>
  ...
  <p style="margin-top: 0; margin-bottom: 0" align="center"><font face="Verdana" color="#330099" size="3">Cadastro 
    de Orienta&ccedil;&otilde;es</font></p>
  ...
  <table border="0" width="889" height="162">
    ...
    <tr> 
      <td width="287" height="37"></td>
      <td width="26" height="37"> <p align="right"><a href="inclui_ori_gerais_mapeamento.asp"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
    ...
    <tr> 
      <td height="37"></td>
      <td height="37"> <p align="right"><a href="seleciona_ori_gerais_mapeamento.asp?pOpt=A"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
    ...
    <tr> 
      <td height="37"></td>
      <td height="37"> <p align="right"><a href="seleciona_ori_gerais_mapeamento.asp?pOpt=E"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
      <td height="37"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Voltar 
