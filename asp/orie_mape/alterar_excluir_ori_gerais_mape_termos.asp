...
If str_Opt = "E" then
   response.redirect "valida_inc_alt_exc_orientacoes_termos.asp?txtOpt=E&txtCdTermo=" & str_Cd_Termo
end if
...
<form name="frm1" method="POST" action="valida_inc_alt_exc_orientacoes_termos.asp">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="53%"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Alterar 
          termos novos Relevantes - GERAL</font></div></td>
