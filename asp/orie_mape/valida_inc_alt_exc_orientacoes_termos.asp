...
if str_Opt = "I" then
   ...
   For i = 1 to 4
       if str_Orientacoes(i) <> "" and str_Termos(i) <> "" then
		  ...
		  atual = atual + 1
          ssql=""
          ssql="INSERT INTO " & Session("PREFIXO") & "FUN_ORIEN_GERAL_TERMOS ("
...
elseif str_Opt = "A" then
   ...
   if str_Orientacoes <> "" then
      int_Tot_Orientacoes = int_Tot_Orientacoes + 1
      ssql=""
      ssql=ssql & "UPDATE FUN_ORIEN_GERAL_TERMOS SET "
...
elseif str_Opt = "E" then
   ...
   if str_CdTermo <> "" then
      int_Tot_Orientacoes = int_Tot_Orientacoes + 1
      ssql=""
      ssql=ssql & "DELETE FROM FUN_ORIEN_GERAL_TERMOS "
      ssql=ssql & " WHERE ORTE_NR_SEQUENCIAL = " & str_CdTermo
	  'response.Write(ssql)
      db.execute(ssql)	
   end if  
...
%>
  ...
  <table border="0" width="889" height="162">
    ...
    <tr> 
      <td width="287" height="37"></td>
      <td width="26" height="37"> <p align="right"><a href="inclui_ori_gerais_mape_termos.asp"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
    ...
    <tr> 
      ...
      <td height="37"> <p align="right"><a href="seleciona_ori_gerais_mape_termos.asp?pOpt=A"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
    ...
    <tr> 
      <td height="27"></td>
      <td height="37"> <p align="right"><a href="seleciona_ori_gerais_mape_termos.asp?pOpt=E"><img src="../../imagens/selecao_F02.gif" border="0"></a></td>
      <td height="37"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Voltar 
