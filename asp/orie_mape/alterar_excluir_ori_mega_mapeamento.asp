...
If str_Opt = "EO" then
   response.redirect "valida_inc_alt_exc_mega_orientacoes.asp?txtOpt=EO&txtCdOrient="&str_Cd_Orient&"&txtMegaProcesso="&str_MegaProcesso
end if
...
<form name="frm1" method="POST" action="valida_inc_alt_exc_mega_orientacoes.asp">
