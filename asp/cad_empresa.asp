...
function Confirma() 
{ 
if (document.form1.CadEmpresa.value == "")
     { 
	 alert("O campo DESCRIÇÃO DA EMPRESA deve ser preenchido!");
     document.form1.CadEmpresa.focus();
     return;
     }
	 else
     {
...
<form name="form1" method="POST" action="valida_empresa.asp">
  ...
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="5%">&nbsp;</td>
      <td width="23%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099"><b>Descrição 
        da Empresa</b></font></td>
      <td width="59%"> 
        <input type="text" name="CadEmpresa" size="59">
      </td>
      <td width="14%">&nbsp;</td>
    </tr>
    <tr> 
