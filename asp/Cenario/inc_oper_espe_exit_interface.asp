...
<form name="frm1" method="POST" action="grava_operacoes_especiais.asp">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr> 
      ...
      <td width="54%"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_MegaProcesso%>-<%=ls_Desc_MegaProcesso%></font></b></td>
      <td width="27%">&nbsp;</td>
    </tr>
    <tr> 
      <td width="2%">&nbsp;</td>
      ...
      <td width="54%"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Processo%>-<%=ls_Desc_Processo%></font></b></td>
      <td width="27%">&nbsp;</td>
    </tr>
    <tr> 
      <td width="2%">&nbsp;</td>
      ...
      <td width="54%"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_SubProcesso%>-<%=ls_Desc_SubProcesso%></font></b></td>
      <td width="27%">&nbsp;</td>
    </tr>
    <tr> 
      <td width="2%">&nbsp;</td>
  ...
  <table width="779" border="0" cellspacing="2" cellpadding="0">
    <tr> 
      <td width="125"> 
        <input type="hidden" name="txtAcao" value="ED">
      </td>
      <td width="648"> 
        <input type="hidden" name="txtCenSeq" value="0">
      </td>
    </tr>
    <tr> 
      <td width="125"> 
      ...
      <td width="648"> 
        <input type="text" name="txtCenarioTrSequencia" size="4" maxlength="4">
      </td>
    </tr>
    <tr> 
      <td width="125"> 
...
While (NOT rdsDesenv.EOF)%>
          <option value="<%=(rdsDesenv.Fields.Item("DESE_CD_DESENVOLVIMENTO").Value)%>"><%=(rdsDesenv.Fields.Item("DESE_CD_DESENVOLVIMENTO").Value)%> - <%=Left((rdsDesenv.Fields.Item("DESE_TX_DESC_DESENVOLVIMENTO").Value),60)%></option>
          <%
  rdsDesenv.MoveNext()
Wend
...
%>
    ...
    <tr> 
      ...
      <td width="648"> 
        <input type="text" name="txtDescTransacao" size="60" maxlength="150">
      </td>
    </tr>
    <tr> 
      <td width="125">&nbsp;</td>
