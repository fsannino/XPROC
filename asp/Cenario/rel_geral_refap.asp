...
str_SQL_Cenario = str_SQL_Cenario & " " & Session("PREFIXO") & "CENARIO_REFAP.CENA_CD_CENARIO, " & Session("PREFIXO") & "CENARIO_REFAP.CENA_TX_TITULO_CENARIO"
str_SQL_Cenario = str_SQL_Cenario & " FROM " & Session("PREFIXO") & "CENARIO_REFAP"
str_SQL_Cenario = str_SQL_Cenario & " WHERE " & Session("PREFIXO") & "CENARIO_REFAP.MEPR_CD_MEGA_PROCESSO = " & str_MegaProcesso
str_SQL_Cenario = str_SQL_Cenario & " order by " & Session("PREFIXO") & "CENARIO_REFAP.CENA_TX_TITULO_CENARIO "
...
str_SQL_Cenario_Tot = str_SQL_Cenario_Tot & " FROM " & Session("PREFIXO") & "CENARIO_REFAP"
str_SQL_Cenario_Tot = str_SQL_Cenario_Tot & " order by " & Session("PREFIXO") & "CENA_TX_TITULO_CENARIO "

set rs_onda=conn_db.execute("SELECT * FROM " & Session("PREFIXO") & "ONDA_REFAP ORDER BY ONDA_TX_DESC_ONDA")
%>
<html>
<head>
<STYLE type=text/css>
...
<form name="frm1" method="post" action="gera_rel_cond_refap.asp">
  ...
  <table width="97%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="129">
    <tr> 
    ...
    <tr> 
      ...
      <td width="52%" height="25"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','rel_geral_refap.asp');return document.MM_returnValue" size="1">
    ...
    <tr> 
      ...
      <td width="52%" height="25"> 
        <select name="ID" size="1">
          ...
          <option value="<%=rdsCenario.Fields.Item("CENA_CD_CENARIO").Value%>" selected ><%=ucase(left((rdsCenario.Fields.Item("CENA_TX_TITULO_CENARIO").Value),60))%></option>
          <% else %>
          <option value="<%=rdsCenario.Fields.Item("CENA_CD_CENARIO").Value%>" ><%=rdsCenario.Fields.Item("CENA_CD_CENARIO").Value%>
          - <%=ucase(left((rdsCenario.Fields.Item("CENA_TX_TITULO_CENARIO").Value),60))%></option>
          <% end if %>
          <%
  rdsCenario.MoveNext()
Wend
