...
<table width="697" border="0" cellspacing="0" cellpadding="0" height="77">
  ...
  <tr> 
    ...
    <td width="112" bgcolor="#0066CC" height="21"><b><a href="altera_classe.asp?order=1"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">C&oacute;digo</font></a></b></td>
    <td width="386" bgcolor="#0066CC" height="21"><b><a href="altera_classe.asp?order=2"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Classe</font></a></b></td>
  ...
  <tr> 
    ...
    <td width="29" height="1">
      <p align="center"><a href="altera_classe.asp?id=<%=rs("CLCE_CD_NR_CLASSE_CENARIO")%>"><img border="0" src="../../imagens/seta_direita_01.jpg" width="21" height="22" alt="Alterar Classe"></a></p>
    </td>
  </tr>
  <% rs.movenext
  Loop
