...
<form name="frm1" method="POST" action="grava_alteracao_assunto.asp">
  <table width="773" height="86" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099" style="margin-bottom: 0">
    <tr> 
    ...
    <tr bgcolor="#00FF99"> 
      ...
      <td height="20" width="213"><table width="625" border="0" align="center">
          <tr> 
  ...
  <table width="100%" border="0">
    ...
    <tr> 
      <td>&nbsp;</td>
      <td><div align="center"><font color="#330099" size="3" face="Verdana">Altera&ccedil;&atilde;o 
          de Assunto</font></div></td>
    ...
    <tr>
      ...
      <td><div align="center"><font color="#330099" size="3" face="Verdana">Mega 
          : </font><font face="Verdana" size="1"><%=str_DsMegaProcesso%></font></div></td>
      <td>&nbsp;</td>
    </tr>
  </table>
  <% str_Contador = 0
  ...
  %>
  <table width="85%" height="59" border="0" cellspacing="3">
    <tr> 
      <td width="10%"><b></b></td>
      <td width="90%"><font face="Verdana" size="2"><a href="gera_rel_geral.asp?id=<%=rs("CENA_CD_CENARIO")%>"><%=rs("CENA_CD_CENARIO")%></a>- <%=rs("CENA_TX_TITULO_CENARIO")%></font></td>
    </tr>
    <tr> 
      <td width="10%"><b><font face="Verdana" size="1" color="#FFFFFF">Descrição 
        do Cenário</font></b></td>
      <td width="90%"><font face="Verdana" size="1"> 
        <input name="txtCenario<%=str_Contador%>" type="hidden" id="txtCenario<%=str_Contador%>" value="<%=rs("CENA_CD_CENARIO")%>">
        <select name="selAssunto<%=str_Contador%>">
          <option value="0"> - Selecione um Assunto -</option>
          <% rs_assunto.movefirst
		  do while not rs_assunto.EOF 
		     if Trim(rs("SUMO_NR_CD_SEQUENCIA")) = Trim(rs_assunto("SUMO_NR_CD_SEQUENCIA"))  then
		  %>
          <option value="<%=rs_assunto("SUMO_NR_CD_SEQUENCIA")%>"selected><%=rs_assunto("SUMO_TX_DESC_SUB_MODULO")%></option>
          <% else %>
