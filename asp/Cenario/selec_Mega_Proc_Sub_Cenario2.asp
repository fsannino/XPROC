...
'response.Write(str_SubProcesso)
...
function MM_goToURL1() { //v3.0
  ...
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"?txtOpc="+document.frm1.txtOpc.value+"&selAssunto="+document.frm1.selAssunto.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso=0&selSubProcesso=0'");
}
function MM_goToURL2() { //v3.0
  var i, args=MM_goToURL2.arguments; document.MM_returnValue = false;
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"?txtOpc="+document.frm1.txtOpc.value+"&selAssunto="+document.frm1.selAssunto.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso=0'");
}
function MM_goToURL3() { //v3.0
  var i, args=MM_goToURL3.arguments; document.MM_returnValue = false;
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"?txtOpc="+document.frm1.txtOpc.value+"&selAssunto="+document.frm1.selAssunto.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"'");
}
function MM_goToURL4() { //v3.0
  var i, args=MM_goToURL4.arguments; document.MM_returnValue = false;
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"?txtOpc=3&selAssunto="+document.frm1.selAssunto.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso=0&selSubProcesso=0'");
}
function MM_goToURL5() { //v3.0
  var i, args=MM_goToURL5.arguments; document.MM_returnValue = false;
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"?txtOpc=3&selAssunto="+document.frm1.selAssunto.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso=0'");
}

function manda_Assunto()
{
window.location.href="selec_Mega_Proc_Sub_Cenario2.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
function manda_Processo()
{
window.location.href="selec_Mega_Proc_Sub_Cenario2.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selAssunto="+document.frm1.selAssunto.value+"&selProcesso="+document.frm1.selProcesso.value
}
function manda_SubProcesso()
{
window.location.href="selec_Mega_Proc_Sub_Cenario2.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selAssunto="+document.frm1.selAssunto.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value
}
function manda_Onda()
{
window.location.href="selec_Mega_Proc_Sub_Cenario2.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selAssunto="+document.frm1.selAssunto.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selOnda="+document.frm1.selOnda.value
}
...
function Confirma()
{
  if ((document.frm1.selCenario.selectedIndex == 0)&&
      (document.frm1.txtCenario.value == 0))
     { 
	 alert("A seleção de um Cenário ou a digitação de um é obrigatório!");
     document.frm1.txtCenario.focus();
     return;
     }
  else	 
     {
...
<form name="frm1" method="post" action="gerencia_cenario_transa.asp">
  ...
  <tr bgcolor="#00FF99"> 
    <td colspan="3" height="20"> 
      <table width="701" border="0" align="center">
          <tr> 
          <td width="29"><a href="javascript:Confirma()"><img src="../../imagens/confirma_f02.gif" width="24" height="24" border="0"></a></td>
          <td width="56"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font color="#330099">Envia</font></b></font></td>
          <td width="29">&nbsp;</td>
          <td width="219"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b></b></font></td>
          <td width="30"></td>
          <td width="56"></td>
          <td width="31">&nbsp;</td>
          <td width="53">&nbsp;</td>
          <td width="160"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b></b></font></td>
        </tr>
      </table>
    </td>
  </tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="9%">&nbsp;</td>
      <td width="74%"> 
        <div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Seleciona 
          Cen&aacute;rio para edi&ccedil;&atilde;o</font></div>
      </td>
      <td width="17%">&nbsp;</td>
    </tr>
  </table>
  <table width="97%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    ...
    <tr> 
      ...
      <td width="52%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','selec_Mega_Proc_Sub_Cenario2.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr>
      <td width="19%" height="22"> 
        <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Assunto
        &nbsp;</font></b>
      </td>
      <td width="59%" colspan="2" height="22"> 
        <select size="1" name="selAssunto" onChange="manda_assunto()">
    ...
    <tr> 
      ...
      <td width="52%" height="25"> 
        <select name="selProcesso" onChange="manda_processo()">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%"> 
        <select name="selSubProcesso" onChange="manda_SubProcesso()">
          <% 
		  if str_Opc <> "1" then %>
...
%>
      ...
      <td width="12%" height="21"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp; 
        </font></td>
      <td width="17%" height="21"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp; 
        </font></td>
    </tr>
    <tr> 
      <td width="21%"> 
        <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Onda</font></b> 
      </td>
      <td width="52%"> 
        <select size="1" name="selOnda" onChange="manda_Onda()">
    ...
    <tr> 
      <td width="21%"> 
        <div align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Cen&aacute;rio</font></b></div>
      </td>
      <td width="52%"> 
        <select name="selCenario" size="1">
          <% 
		  if str_Opc <> "1" then %>
          ...
          <option value="<%=rdsCenario.Fields.Item("CENA_CD_CENARIO").Value%>" selected ><%=(rdsCenario.Fields.Item("CENA_TX_TITULO_CENARIO").Value)%></option>
          <% else %>
...
%>
    ...
    <tr> 
      <td width="21%"></td>
      <td width="52%"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Se 
        preferir, digite o código do Cenário abaixo</font></b> </td>
      <td width="12%"></td>
      <td width="17%"></td>
    </tr>
    <tr> 
      <td width="21%"></td>
      <td width="52%"> 
        <input type="text" name="txtCenario" size="33" maxlength=11>
        <font face="Verdana, Arial, Helvetica, sans-serif" color="#330099" size="1">( 
        Ex.: MM.REF.0100 )</font> </td>
      <td width="12%">&nbsp;</td>
      <td width="17%">&nbsp;</td>
    </tr>
  </table>
