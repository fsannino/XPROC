...
<form name="frm1" method="POST" action="grava_gera_fluxo.asp">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="12%">&nbsp;</td>
      <td width="80%"> 
        <div align="center"><font color="#330099" face="Verdana" size="3">Define</font><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#330099"> 
          Fluxo Mestre</font></div>
      </td>
      <td width="8%">&nbsp;</td>
    </tr>
    <tr>
...
if len(id2)=11 then
	ssql = "SELECT * FROM " & Session("PREFIXO") & "CENARIO WHERE ONDA_CD_ONDA = " & rsonda("ONDA_CD_ONDA") & " and CENA_CD_CENARIO = '" & id2 & "'"
end if
  ...
  <div align="center">
    <center>
      <table border="0" width="716" cellspacing="1" cellpadding="0">
        <tr> 
          <td width="110" bgcolor="#330099"> 
            <p style="margin-top: 0; margin-bottom: 0" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#FFFFFF">Código</font></b></font></p>
          </td>
          <td width="482" bgcolor="#330099"> 
          ...
          <td width="120" bgcolor="#330099"> 
            <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#FFFFFF"> 
              Fuxo Mestre</font></b></font></div>
          </td>
        </tr>
        <%end if%>
		...
		ls_Gera_Fluxo = atual("CENA_TX_GERA_FLUXO")
        ...
        %>
        <tr> 
          <td width="110" align="left" bgcolor="<%=COR%>" height="30"> 
          ...
          <td width="482" align="left" bgcolor="<%=COR%>" height="30"><font size="2" face="Verdana"> 
          ...
          <td width="120" align="left" bgcolor="<%=COR%>" height="30"> 
            <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="gera_rel_geral.asp?id=<%=rs("CENA_CD_CENARIO")%>&selMegaProcesso=<%=rs("MEPR_CD_MEGA_PROCESSO")%>&selProcesso=<%=rs("PROC_CD_PROCESSO")%>&selSubProcesso=<%=rs("SUPR_CD_SUB_PROCESSO")%>"><font size="2" face="Verdana"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
              <input type="hidden" name="txtGeraFluxo<%=int_sequencia%>" value="<%=ls_Gera_Fluxo%>">
              </font></font></a> 
              <% IF ls_Gera_Fluxo = "S" THEN %>
              <input type="checkbox" name="rdbGeraFluxo<%=int_sequencia%>" value="S" checked>
              <% else %>
              <input type="checkbox" name="rdbGeraFluxo<%=int_sequencia%>" value="S">
              <% end if %>
              </font></div>
          </td>
        </tr>
