...
str_SQL_Cen_Tran = str_SQL_Cen_Tran & " , " & Session("PREFIXO") & "CENARIO_TRANSACAO.TRAN_CD_TRANSACAO "
...
if not rdsCen_Tran.EOF then
   ...
   str_Cd_Transacao = rdsCen_Tran("TRAN_CD_TRANSACAO")
...
str_SQL_BPP = str_SQL_BPP & " " & Session("PREFIXO") & "BPP.BPPP_CD_BPP, "
str_SQL_BPP = str_SQL_BPP & " " & Session("PREFIXO") & "BPP.BPPP_TX_DESC_BPP, "
str_SQL_BPP = str_SQL_BPP & " " & Session("PREFIXO") & "BPP_TRANSACAO.TRAN_CD_TRANSACAO"
str_SQL_BPP = str_SQL_BPP & " FROM " & Session("PREFIXO") & "BPP INNER JOIN"
str_SQL_BPP = str_SQL_BPP & " " & Session("PREFIXO") & "BPP_TRANSACAO ON "
str_SQL_BPP = str_SQL_BPP & " " & Session("PREFIXO") & "BPP.BPPP_CD_BPP = " & Session("PREFIXO") & "BPP_TRANSACAO.BPPP_CD_BPP"
str_SQL_BPP = str_SQL_BPP & " WHERE " & Session("PREFIXO") & "BPP_TRANSACAO.TRAN_CD_TRANSACAO = '" & str_Cd_Transacao & "'"
str_SQL_BPP = str_SQL_BPP & " order by " & Session("PREFIXO") & "BPP.BPPP_TX_DESC_BPP "
...
<form name="frm1" method="POST" action="grava_operacoes_especiais.asp">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="24%"><%'=str_SQL_BPP%></td>
      <td width="62%">&nbsp;</td>
      <td width="14%">&nbsp;</td>
    </tr>
    <tr> 
      <td width="24%">&nbsp;</td>
      <td width="62%"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#000099">Relaciona 
        BPP de uma Transa&ccedil;&atilde;o para um Cen&aacute;rio</font></td>
      <td width="14%">&nbsp;</td>
    </tr>
  </table>
  ...
  <table width="817" border="0" cellspacing="2" cellpadding="0">
    <tr> 
      <td width="89"> 
        <input type="hidden" name="txtAcao" value="BPP">
      </td>
      <td width="722"> 
    ...
    <tr>
      <td width="89"> 
        <div align="right"><b><font size="2" color="#000099"><font face="Verdana, Arial, Helvetica, sans-serif">Transa&ccedil;&atilde;o 
          : </font></font></b></div>
      </td>
      <td width="722"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Desc_Transacao%></font> </td>
    </tr>
    <tr> 
      <td width="89"> 
      ...
      <td width="722"> 
        <select name="selBPP">
          ...
          <%Set rdsDesenv= Conn_db.Execute(str_SQL_BPP)
While (NOT rdsDesenv.EOF)
         if (Trim(str_BPP) = Trim(rdsDesenv.Fields.Item("BPPP_CD_BPP").Value)) then %>
          <option value="<%=(rdsDesenv.Fields.Item("BPPP_CD_BPP").Value)%>" selected><%=(rdsDesenv.Fields.Item("BPPP_CD_BPP").Value)%> - <%=Left((rdsDesenv.Fields.Item("BPPP_TX_DESC_BPP").Value),70)%></option>
          <% else %>
          <option value="<%=(rdsDesenv.Fields.Item("BPPP_CD_BPP").Value)%>"><%=(rdsDesenv.Fields.Item("BPPP_CD_BPP").Value)%> - <%=Left((rdsDesenv.Fields.Item("BPPP_TX_DESC_BPP").Value),70)%></option>
          <% end if %>
          <%
  rdsDesenv.MoveNext()
Wend
...
%>
    ...
    <tr> 
      <td width="89"> 
        <div align="right"><b><font size="2" color="#000099"></font><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"> 
          </font></b></div>
      </td>
      <td width="722">&nbsp; </td>
    </tr>
