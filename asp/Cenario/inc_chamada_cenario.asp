...
if ((document.frm1.selCenario.value == "0")&&(document.frm1.txtCdCenario.value == ""))    
     { 
	 alert("A seleção de um Cenário ou a digitação é obrigatória!.");
...
<form name="frm1" method="POST" action="grava_operacoes_especiais.asp">
  <table width="773" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099" height="86">
    ...
    <tr bgcolor="#00FF99"> 
      <td height="21" width="111">&nbsp; </td>
      <td height="21" width="30"><a href="javascript:Confirma()"><img src="../../imagens/confirma_f02.gif" width="24" height="24" border="0"></a></td>
      <td height="21" width="213"><font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Enviar</b></font></td>
      <td colspan="2" height="21"> 
        <div align="right"><a href="javascript:Limpa()"><img src="../../imagens/limpa_F02.gif" width="24" height="24" border="0"></a></div>
      </td>
      <td height="21" width="334"><font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Limpa</b></font></td>
    </tr>
  </table>
...
<%'=str_SQL_DescCenario%></td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr> 
      ...
      <td width="54%"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_MegaProcesso%>-<%=ls_Desc_MegaProcesso%> 
    ...
    <tr> 
      ...
      <td width="54%"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Processo%>-<%=ls_Desc_Processo%> 
    ...
    <tr> 
      ...
      <td width="54%"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_SubProcesso%>-<%=ls_Desc_SubProcesso%> 
  ...
  <table width="779" border="0" cellspacing="2" cellpadding="0">
    <tr> 
      <td width="34">&nbsp;</td>
      <td width="139"> 
        <input type="hidden" name="txtAcao" value="ICC">
      </td>
      <td width="598">&nbsp; </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td width="598"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
...
%>
    ...
    <tr>
      ...
      <td width="139" height="25">
        <div align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Cen&aacute;rio</font></b></div>
      </td>
      <td width="598" height="25">
        <input type="text" name="txtCdCenario" maxlength="11">
      </td>
    </tr>
    <tr> 
      <td width="34" height="25">&nbsp;</td>
