...
if str_MegaProcesso <> "" then
   set rs_class=conn_db.execute("SELECT * FROM " & Session("PREFIXO") & "CLASSE_CENARIO_MEGA_PROCESSO WHERE MEPR_CD_MEGA_PROCESSO=" & str_MegaProcesso)
else
   set rs_class=conn_db.execute("SELECT * FROM " & Session("PREFIXO") & "CLASSE_CENARIO_MEGA_PROCESSO WHERE MEPR_CD_MEGA_PROCESSO=" & 0)
end if   
'if str_MegaProcesso <> "0" then
...
{
window.location.href="rel_geral.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
function manda_Classe()
{
window.location.href="rel_geral.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selClasse="+document.frm1.selClasse.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
<form name="frm1" method="post" action="gera_rel_cond.asp">
  ...
  <table width="97%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="446">
    <tr> 
    ...
    <tr> 
      ...
      <td width="52%" height="25"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','rel_geral.asp');return document.MM_returnValue" size="1">
...
%>
    ...
    <tr> 
      <td width="19%" height="1" valign="middle" align="left"> <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Assunto 
          &nbsp;</font></b> </td>
      <td width="59%" colspan="2" height="1" valign="middle" align="left"> <select size="1" name="selAssunto" onChange="manda_assunto()">
    ...
    <tr>
      <td height="25"><div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font face="Verdana" size="2" color="#330099">Classe 
          do Cenário</font></b> </font></div></td>
      <td height="25"><select size="1" name="selClasse">
          <option value="0">== TODOS ==</option>
          <%do until rs_class.eof=true
       set atual=conn_db.execute("SELECT * FROM " & Session("PREFIXO") & "CLASSE_CENARIO WHERE CLCE_CD_NR_CLASSE_CENARIO=" & rs_class("CLCE_CD_NR_CLASSE_CENARIO"))
    ...
    <tr> 
      <td width="21%" height="25"> <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font color="#330099">Processo</font></b></font></div></td>
      <td width="52%" height="25"> <select name="selProcesso" size="1"  onChange="manda_processo()">
          <option value="0" selected>== TODOS ==</option>
          &nbsp;<% 
		  if str_Opc <> "1" then %>
          <% else %>
...
%>
    ...
    <tr> 
      <td width="21%" height="25"> <div align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Sub-Processo</font></b></div></td>
      <td width="52%" height="25"> <select name="selSubProcesso" size="1">
          <option value="0" selected>== TODOS ==</option>
          &nbsp;<% 
		  if str_Opc <> "1" then %>
          <% else %>
...
%>
    ...
    <tr> 
      <td width="21%" height="32"> <div align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Status</font></b></div></td>
      <td width="52%" height="32"> <select name="selStatus" size="1">
          <option value="0">== TODOS ==</option>
          <option value="EE">Em elaboração</option>
          <option value="DF">Definido</option>
          <option value="DS">Desenhado</option>
          <option value="PT">Pronto para teste</option>
          <option value="TD">Testado no PED</option>
          <option value="TQ">Testado no PEQ</option>
        </select> </td>
      <td width="12%" height="32">&nbsp;</td>
      <td width="17%" height="32">&nbsp;</td>
    </tr>
    <tr> 
      <td width="21%" height="25"> <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Escopo</font></b></td>
      <td width="52%" height="25"> <select size="1" name="selEscopo">
...
%>
    ...
    <tr> 
      <td height="1" valign="middle" align="left"> <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Empresa&nbsp;</font></b> 
      </td>
      <td colspan="2" height="1" valign="middle" align="left"> <select size="1" name="selEmpresa">
          <option value="0">== TODOS ==</option>
          <option value="PAPER COMPANIES">PAPER COMPANIES</option>
          <option value="PETROBRAS">PETROBRAS</option>
          <option value="REFAP">REFAP</option>
          <option value="9">Seleciona Cenário sem Empresa</option>
        </select> </td>
      <td height="21"></td>
    </tr>
    <tr> 
