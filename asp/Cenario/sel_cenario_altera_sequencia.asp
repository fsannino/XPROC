...
if str_Assunto<>0 then
	str_SQL_Cenario = str_SQL_Cenario & " AND " & Session("PREFIXO") & "CENARIO.MEPR_CD_MEGA_PROCESSO = " & str_MegaProcesso & " AND " & Session("PREFIXO") & "CENARIO.SUMO_NR_SEQUENCIA = " & str_Assunto
end if
...
{
window.location.href="sel_cenario_altera_sequencia.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
<form name="frm1" method="post" action="alt_ordem_cenario.asp">
    ...
    <tr> 
      ...
      <td width="74%"> 
        <div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Seleciona 
          Cen&aacute;rio para altera&ccedil;&atilde;o da sequencia de visualiza&ccedil;&atilde;o</font></div>
      </td>
      <td width="17%">&nbsp;</td>
    </tr>
  </table>
  <table width="97%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    ...
    <tr> 
      ...
      <td width="52%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','sel_cenario_altera_sequencia.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
