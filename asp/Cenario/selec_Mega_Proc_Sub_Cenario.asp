  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    ...
    <tr> 
      ...
      <td width="45%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','selec_Mega_Proc_Sub_Cenario.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="45%" height="25"> 
        <select name="selProcesso" onChange="MM_goToURL2('self','selec_Mega_Proc_Sub_Cenario.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="45%"> 
        <select name="selSubProcesso" onChange="MM_goToURL3('self','selec_Mega_Proc_Sub_Cenario.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
