...
<form name="frm1" method="post" action="altera_assunto_em_massa.asp">
  ...
  <table width="97%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="327">
    <tr> 
...
%>
    ...
    <tr> 
      <td width="19%" height="1" valign="middle" align="left"> 
        <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Assunto
        &nbsp;</font></b>
      </td>
      <td width="59%" colspan="2" height="1" valign="middle" align="left"> 
    ...
    <tr> 
      ...
      <td width="52%" height="25"> 
        <select name="selProcesso" size="1">
          <option value="0" selected>== TODOS ==</option>
          &nbsp;
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%" height="25"> 
        <select name="selSubProcesso" size="1">
          <option value="0" selected>== TODOS ==</option>
          &nbsp;
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr>
      <td width="21%" height="32">
        <div align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Status</font></b></div>
      </td>
