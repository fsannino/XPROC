...
if (document.frm1.selMegaProcesso.selectedIndex == 0)
     { 
	 alert("Você deve selecionar pelo menos um MEGA-PROCESSO!");
...
<form name="frm1" method="post" action="gera_rel_geral.asp">
  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    <tr>
      ...
      <td width="52%" height="5" colspan="3"> 
...
%>
    ...
    <tr> 
      ...
      <td width="52%" height="25" colspan="3"> 
...
%>
    ...
    <tr> 
      <td width="19%">&nbsp;</td>
      <td width="52%" colspan="3">&nbsp;<input type="hidden" name="INC" size="20" value="1"> </td>
      <td width="12%">&nbsp;</td>
      <td width="17%">&nbsp;</td>
    </tr>
  </table>
