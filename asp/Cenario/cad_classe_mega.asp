...
function limpa()
{
document.frm1.txtDescClasse.value = '';
...
<form method="POST" action="valida_cad_classe_mega.asp" name="frm1">
  ...
  <table border="0" width="742" height="94" cellpadding="0" cellspacing="0" align="center">
    <tr> 
      ...
      <td height="21" width="453">
        ...
        <p style="margin-top: 0; margin-bottom: 0"><font face="Verdana" color="#330099" size="3">Cadastro
        de Classes</font></p>
      </td>
    ...
    <tr> 
      ...
      <td height="21" width="453"><input type="text" name="txtDescClasse" size="63"></td>
      <td height="21" width="83">&nbsp;</td>
    </tr>
    <tr bgcolor="#330099"> 
