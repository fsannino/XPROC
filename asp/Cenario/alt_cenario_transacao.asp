...
<form name="frm1" method="POST" action="grava_operacoes_especiais.asp">
  ...
  <table width="779" border="0" cellspacing="4" cellpadding="0">
    <tr> 
      <td width="37">&nbsp;</td>
      <td width="133"> 
        <input type="hidden" name="txtAcao" value="AT">
      </td>
      <td width="593"> 
    ...
    <tr> 
      <td width="37">&nbsp;</td>
      <td width="133"> 
        <div align="right"><b><font size="2" color="#000099" face="Verdana, Arial, Helvetica, sans-serif"> 
          Desc Transa&ccedil;&atilde;o </font></b></div>
      </td>
      <td width="593"> 
    ...
    <tr> 
      <td width="37">&nbsp;</td>
      <td width="133">&nbsp;</td>
      <td width="593"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        </font></td>
    </tr>
  </table>
  <p>&nbsp; </p>
