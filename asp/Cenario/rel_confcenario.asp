...
function manda_mega_processo()
{
window.location.href="rel_confcenario.asp?selMegaProcesso="+document.frm1.selMegaProcesso.value
}
...
<form name="frm1" method="post" action="gera_rel_confcenario.asp">
  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    ...
    <tr>
      <td width="19%" height="5"></td>
      <td width="52%" height="5"> <font face="Verdana" size="3" color="#330099">Relatório 
        de Problemas com status de Cenários</font></td>
      <td width="12%" height="5"> 
      </td>
      <td width="17%" height="5"> 
      </td>
    ...
    <tr> 
      ...
      <td width="52%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="manda_mega_processo()">
          <% 
		  if str_Opc <> "1" then %>
