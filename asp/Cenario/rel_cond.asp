...
function MM_goToURL4() { //v3.0
  ...
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"?txtOpc="+document.frm1.txtOpc.value+"&selAssunto="+document.frm1.selAssunto.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selOnda="+document.frm1.selOnda.value+"'");
}
...
{
window.location.href="rel_cond.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
<form name="frm1" method="post" action="gera_rel_geral.asp">
  ...
  <table width="96%" border="0" cellpadding="0" cellspacing="5" name="tblSubProcesso" height="204">
    <tr> 
    ...
    <tr> 
      ...
      <td width="59%" height="25"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','rel_cond.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="59%" height="25"> 
        <select name="selProcesso" onChange="MM_goToURL2('self','rel_cond.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="59%" height="25"> 
        <select name="selSubProcesso" onChange="MM_goToURL3('self','rel_cond.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%"> 
        <select size="1" name="selOnda" onChange="MM_goToURL4('self','rel_cond.asp',this);return document.MM_returnValue">
      ...
      %>
        ...
        <img src="../../imagens/novo.gif" width="48" height="26"> </td>
