...
{
window.location.href="excluir_cenario.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
if (document.frm1.ID2.value == "")
     ...
     {
	  if(confirm("Confirma Exclusão ( TODOS os registros relacionados serão excluídos - Cenário, Transações do Cenário e Histórico do Cenário) ?"))
	  {
...
if (document.frm1.selProcesso.selectedIndex == 0)
     { 
	 alert("Você deve selecionar um PROCESSO");
     document.frm1.selProcesso.focus();
     return;
     }	 
if (document.frm1.selSubProcesso.selectedIndex == 0)
     { 
	 alert("Você deve selecionar um SUB-PROCESSO");
     document.frm1.selSubProcesso.focus();
     return;
     }	 
if (document.frm1.ID.selectedIndex == 0)
     { 
	 alert("Você deve selecionar um CENÁRIO");
...
<form name="frm1" method="post" action="valida_excluir_cenario.asp">
  ...
  <table width="94%" border="0" cellpadding="0" cellspacing="0" name="tblSubProcesso" height="261">
    <tr>
      <td width="19%" height="39">&nbsp;</td>
      <td width="52%" height="39" colspan="2"> 
        <input type="hidden" name="txtOpc" value="1">
        <p align="center"><font face="Verdana" color="#330099" size="3">Exclusão
        de Cenário</font>
    ...
    <tr> 
      ...
      <td width="52%" height="36" colspan="2"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','excluir_cenario.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%" height="36" colspan="2"> 
        <select name="selProcesso" onChange="MM_goToURL2('self','excluir_cenario.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%" height="33" colspan="2"> 
        <select name="selSubProcesso" onChange="MM_goToURL3('self','excluir_cenario.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
      ...
      <td width="12%" height="33"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp; 
        </font></td>
      <td width="17%" height="33"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp; 
        </font></td>
    </tr>
    <tr> 
      ...
      <td width="52%" height="34" colspan="2"> 
...
%>
    ...
    <tr> 
      ...
      <td width="52%" height="29" colspan="2" bgcolor="#CCCCCC"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">&nbsp;&nbsp;&nbsp;
        Se
    ...
    <tr> 
      ...
      <td width="27%" bgcolor="#CCCCCC" height="11">
        <p style="margin-top: 0; margin-bottom: 0">&nbsp;&nbsp;&nbsp; <input type="text" name="ID2" size="11" maxlength=11>  <font face="Verdana, Arial, Helvetica, sans-serif" color="#330099" size="1">(
        Ex.: MM.REF.0100 ) </font> </p>
 </td>
      <td width="32%" bgcolor="#CCCCCC" height="11">
        <p style="margin-top: 0; margin-bottom: 0"><a href="javascript:Confirma3()"><img src="../../imagens/confirma_f02.gif" width="24" height="24" border="0" align="absmiddle"></a><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#330099">Excluir</font></b></p>
 </td>
