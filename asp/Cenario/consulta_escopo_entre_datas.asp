...
function manda01()
{
window.location="consulta_escopo_entre_datas.asp?selMegaProcesso="+document.frm1.selMegaProcesso.value
}
</script>
...
<form name="frm1" method="post" action="gera_consulta_escopo_duas_datas.asp">
  ...
  <table border="0" width="973" height="281">
    <tr> 
      <td width="94" height="25"> </td>
      <td width="224" height="25"><b><font color="#000080" face="Verdana" size="2">Selecione 
        o Mega-Processo :</font></b> </td>
      <td width="641" align="left" height="25"><b><font color="#000080" face="Verdana" size="2"> 
        <select size="1" name="selMegaProcesso" onChange="manda01()">
    ...
    <tr> 
      ...
      <td width="641" align="left" height="21">&nbsp;</td>
    </tr>
    <tr> 
      <td width="94" height="25"> </td>
      <td width="224" height="25"><b><font color="#000080" face="Verdana" size="2">Selecione 
    ...
    <tr> 
      ...
      <td width="641" align="left" height="15"></td>
    </tr>
    <tr> 
      <td width="94" height="25"> </td>
      <td width="224" height="25"><b><font color="#000080" face="Verdana" size="2">Selecione 
    ...
    <tr> 
      ...
      <td width="224" height="25"><b><font color="#000080" face="Verdana" size="2">Selecione 
        o Evento</font></b></td>
      <td width="641" align="left" height="25"><b><font color="#000080" face="Verdana" size="2"> 
        <select size="1" name="selEvento1" onClick="document.frm1.data01.value=this.value">
    ...
    <tr> 
      <td width="94" height="25"></td>
      <td width="224" height="25"><b><font color="#000080" face="Verdana" size="2">Ou 
        Digite uma data inicial :</font></b></td>
      <td width="641" align="left" height="25"> <input type="text" name="data01" size="13" maxlength="10" title="Informe a data, formato DD/MM/AAAA: dia com 2 dígitos, mês com 2 dígitos e ano com 4 dígitos">
    ...
    <tr> 
      ...
      <td width="224" height="25"><b><font color="#000080" face="Verdana" size="2">Selecione 
        o Evento</font></b></td>
      <td width="641" align="left" height="25"><b><font color="#000080" face="Verdana" size="2"> 
        <select size="1" name="selEvento2" onClick="document.frm1.data02.value=this.value">
          <option value="">== Selecione um Evento ==</option>
          <% EVENTO.movefirst
          DO UNTIL EVENTO.EOF=TRUE
          DATA1 = EVENTO("EVEN_DT_EVENTO")
    ...
    <tr> 
      <td height="25"></td>
      <td width="224" height="25"><b><font color="#000080" face="Verdana" size="2">Ou 
        Digite uma data final :</font></b></td>
      <td width="641" align="left" height="25"> <input name="data02" type="text" id="data02" title="Informe a data, formato DD/MM/AAAA: dia com 2 dígitos, mês com 2 dígitos e ano com 4 dígitos" size="13" maxlength="10">
        <font size="1" face="Verdana, Arial, Helvetica, sans-serif">Formato dd/mm/aaaa 
        - Ex.25/12/2002 - A data m&iacute;nima para este campo &eacute; 06/03/2003</font></td>
    </tr>
  </table>
