...
{
window.location.href="copia_cenario_onda.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
if (document.frm1.selSubProcesso.selectedIndex == 0)
     ...
     { 
	 alert("Você deve selecionar um ONDA!.");
...
<form name="frm1" method="post" action="valida_copia_cenario_onda.asp">
    ...
    <td colspan="3" height="20"> 
      <table width="625" border="0" align="center">
        <tr> 
          ...
          <td width="50"><font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Copiar</b></font></td>
          <td width="26">
            <p align="center">&nbsp;</p>
          </td>
  ...
  <table width="90%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    <tr>
      ...
      <td width="53%" height="5"> 
        ...
        <p align="left"><font face="Verdana" color="#330099" size="3">Cópia
    ...
    <tr> 
      ...
      <td width="53%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','copia_cenario_onda.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="53%" height="25"> 
        <select name="selProcesso" onChange="MM_goToURL2('self','copia_cenario_onda.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="53%"> 
        <select name="selSubProcesso" onChange="MM_goToURL3('self','copia_cenario_onda.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      <td width="31%">
        <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">&nbsp;Copiar
        Cenário para Onda</font></b></p>
      </td>
      <td width="53%"><select size="1" name="selOnda">
