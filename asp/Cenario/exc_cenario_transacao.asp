...
<form name="frm1" method="POST" action="grava_operacoes_especiais.asp">
  <table width="773" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099" height="86">
    ...
    <tr bgcolor="#00FF99"> 
      ...
      <td height="20" width="213"><font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Exclui</b></font></td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="24%">&nbsp;</td>
      <td width="62%"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Exclui</font><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr> 
      <td width="2%">&nbsp;</td>
      <td width="17%">&nbsp;</td>
      <td width="54%"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"> 
        <%If not rdsDescCenario.EOF then%>
        <b><%=rdsDescCenario("CENA_TX_TITULO_CENARIO")%> </b>
<% end if 
		%>
        </font> 
  ...
  <table width="779" border="0" cellspacing="4" cellpadding="0">
    <tr> 
      <td width="70">&nbsp;</td>
      <td width="187"> 
        <input type="hidden" name="txtAcao" value="ET">
      </td>
      <td width="522"> 
    ...
    <tr> 
      ...
      <td width="522"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_CenarioTrSequencia%> </font></td>
    </tr>
    <tr> 
      <td width="70">&nbsp;</td>
      <td width="187"> 
        <div align="right"><b><font size="2" color="#000099"><font face="Verdana, Arial, Helvetica, sans-serif">Desc</font><font face="Verdana, Arial, Helvetica, sans-serif"> 
          Opera&ccedil;&atilde;o especial</font></font><font color="#000099" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
          - </font></b></div>
      </td>
