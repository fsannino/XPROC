...
{
window.location.href="sel_cenario_refer_fluxo.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
<form name="frm1" method="post" action="alt_refer_fluxo.asp">
    ...
    <tr> 
      ...
      <td width="74%"> 
        <div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Seleciona 
          Cen&aacute;rio para defini&ccedil;&atilde;o de Fluxo Mestre de Refer&ecirc;ncia</font></div>
      </td>
      <td width="17%">&nbsp;</td>
    </tr>
  </table>
  <table width="97%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    ...
    <tr> 
      ...
      <td width="52%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','sel_cenario_refer_fluxo.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
