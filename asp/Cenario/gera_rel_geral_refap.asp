...
ssql="SELECT * FROM " & Session("PREFIXO") & "CENARIO_REFAP " & compl1
...
<% if request("opt") <> 1 then %>
  <table width="773" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099" height="86">
    ...
    <tr bgcolor="#00FF99"> 
      ...
      <td height="20" width="213"><a href="gera_rel_geral_refap.asp?selMegaProcesso=<%=mega%>&amp;selProcesso=<%=proc%>&amp;selSubProcesso=<%=subproc%>&amp;ID=<%=ID%>&amp;selOnda=4&amp;opt=1" target="blank"><img border="0" src="../../imagens/exp_excel.gif"></a></td>
  ...
  <table border="0" width="94%">
    ...
    <tr> 
      ...
      <%SET ONDA=DB.EXECUTE("SELECT * FROM " & Session("PREFIXO") & "ONDA_REFAP WHERE ONDA_CD_ONDA ="& rs("ONDA_CD_ONDA"))%>
    ...
    <tr>
      <td width="17%"><font face="Verdana" color="#330099" size="1">Respons&aacute;vel 
        :</font></td>
      ...
      <td width="28%"><font size="2" face="Verdana" color="#330099">Cenário</font></td>
            <td width="72%"><font size="2" face="Verdana" color="#330099"><b><%=rs("CENA_CD_CENARIO")%></b></font></td>
          </tr>
          <tr>
            <td width="28%"></td>
            <td width="72%"><b><font size="2" face="Verdana" color="#330099"><%=ATUAL("CENA_TX_TITULO_CENARIO")%></font></b></td>
          </tr>
        </table>
