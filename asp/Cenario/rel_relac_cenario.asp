...
'str_SQL_Cenario_Tot = str_SQL_Cenario_Tot & " order by " & Session("PREFIXO") & "CENA_CD_CENARIO"
...
{
window.location.href="rel_relac_cenario.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
if (document.frm1.selVis.selectedIndex == 0)
     { 
	 alert("Você deve selecionar um MODO DE VISUALIZAÇÃO");
     document.frm1.selVis.focus();
     return;
     }
	 else
     {
...
<form name="frm1" method="post" action="gera_rel_relac_cenario.asp" target="_blank">
  ...
  <table width="96%" border="0" cellpadding="0" cellspacing="2" name="tblSubProcesso" height="204">
    <tr> 
      <td width="19%" height="39">&nbsp;</td>
      <td width="59%" height="39" colspan="3"> 
        <input type="hidden" name="txtOpc" value="1">
        <p align="center"><font face="Verdana" color="#330099" size="3">Relatório
        Demonstrativo Cenário x Cenário</font>
    ...
    <tr> 
      ...
      <td width="59%" height="25" colspan="3"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','rel_relac_cenario.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      <td width="21%"> 
        <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Cen&aacute;rio</font></b> 
      </td>
...
While (NOT rdsCenario.EOF)
          ...
          <option value="<%=rdsCenario.Fields.Item("CENA_CD_CENARIO").Value%>" selected ><%=rdsCenario.Fields.Item("CENA_CD_CENARIO").Value%> - <%=left((rdsCenario.Fields.Item("CENA_TX_TITULO_CENARIO").Value),65)%></option>
          <% else %>
          <option value="<%=rdsCenario.Fields.Item("CENA_CD_CENARIO").Value%>" ><%=rdsCenario.Fields.Item("CENA_CD_CENARIO").Value%> - <%=left((rdsCenario.Fields.Item("CENA_TX_TITULO_CENARIO").Value),65)%></option>
          <% end if %>
          <%
  rdsCenario.MoveNext()
Wend
...
%>
    ...
    <tr> 
      ...
      <td width="59%" height="1" colspan="3"> 
      </td>
      <td width="5%" height="1"> </td>
      <td width="17%" height="1"></td>
    </tr>
    <tr> 
      <td width="19%" height="1"> 
        <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Visualização</font></b>
      </td>
      <td width="16%" height="1" valign="middle"> 
        <select size="1" name="selVis">
          <option value="0">Selecione o tipo de Visualização</option>
          <option value="1">CENÁRIOS RELACIONADOS</option>
          <option value="2">RELACIONADO COM CENÁRIOS</option>
          </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </td>
      <td width="1%" height="1" valign="middle"> 
        <p align="right"><input type="checkbox" name="selExcel" value="1">
      </td>
      <td width="46%" height="1" valign="middle"> 
        <font face="Verdana" color="#330099" size="1">Visualizar diretamente no
        Microsoft Excel</font>
      </td>
      <td width="5%" height="1">&nbsp; </td>
      <td width="17%" height="1">&nbsp;</td>
    </tr>
    <tr> 
      ...
      %>
      <td width="59%" bgcolor="#FFFFFF" height="21" colspan="3"><b><font color="#800000" size="2" face="Verdana">
        <p align="left" style="margin-top: 0; margin-bottom: 0"><img border="0" src="../../imagens/b021.gif"></font> </b>
        <font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FF9933">A
        visualização <b>CENÁRIOS RELACIONADOS</b> exibe todos os cenários
        relacionados com o cenário</font></p>
        <p align="left" style="margin-top: 0; margin-bottom: 0"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FF9933">selecionado,
        enquanto que a visualização <b>RELACIONADO COM CENÁRIOS</b> exibe com
        quais cenários</font></p>
        <p align="left" style="margin-top: 0; margin-bottom: 0"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FF9933">o
        cenário selecionado está relacionado</font> </td>
