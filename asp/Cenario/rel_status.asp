...
function MM_goToURL1() { //v3.0
  ...
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selAssunto="+document.frm1.selAssunto.value+"&selProcesso=0&selSubProcesso=0'");
}
function MM_goToURL2() { //v3.0
  var i, args=MM_goToURL2.arguments; document.MM_returnValue = false;
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selAssunto="+document.frm1.selAssunto.value+"&selProcesso="+document.frm1.selProcesso.value+"'");
}
function MM_goToURL3() { //v3.0
  var i, args=MM_goToURL3.arguments; document.MM_returnValue = false;
  for (i=0; i<(args.length-1); i+=2) eval(args[i]+".location='"+args[i+1]+"?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selAssunto="+document.frm1.selAssunto.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"'");
}
...
{
window.location.href="rel_status.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../imagens/novo_registro_02.gif','../imagens/atualiza_02.gif');javascript:Limpa()">
<form name="frm1" method="post" action="gera_rel_status.asp">
  ...
  <table width="97%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="403">
    <tr> 
      <td width="21%" height="21">&nbsp;</td>
      <td width="52%" height="21"> <input type="hidden" name="txtOpc" value="1"> 
      </td>
      <td width="12%" height="21"> <%'=str_Opc%></td>
      <td width="17%" height="21"> <%'=str_MegaProcesso%> <%'=str_Processo%></td>
    </tr>
    <tr> 
      <td width="21%" height="25"> <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font color="#330099">Mega-Processo</font></b></font></div></td>
      <td width="52%" height="25"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','rel_status.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      <td width="21%" align="right" height="25"> <font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Processo</b></font> 
      </td>
      <td width="52%" height="25"> <%set rs_proc=conn_db.execute(str_SQL_Proc)%> <select size="1" name="selProcesso" onChange="MM_goToURL2('self','rel_status.asp');return document.MM_returnValue">
          <option value="0">Selecione um Processo</option>
          <%do until rs_proc.eof=true
          IF TRIM(str_Processo)=trim(rs_proc("PROC_CD_PROCESSO")) then
          %>
    ...
    <tr> 
      <td width="21%" align="right" height="17"> <font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Sub-Processo</b></font> 
      </td>
      <td width="52%" height="17"> <%set rs_sub = conn_db.execute(str_SQL_Sub_Proc)%> <select size="1" name="selSubProcesso" onChange="MM_goToURL3('self','rel_status.asp');return document.MM_returnValue">
          <option value="0">Selecione um Sub-Processo</option>
          <%do until rs_sub.eof=true
          IF TRIM(str_SubProcesso)=trim(rs_sub("SUPR_CD_SUB_PROCESSO")) then
          %>
    ...
    <tr> 
      <td width="21%" height="25"> <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Onda</font></b> 
      </td>
      <td width="52%" height="25"> <select size="1" name="selOnda">
    ...
    <tr> 
      <td width="21%" height="25"> <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Status</font></b> 
      </td>
      <td width="52%" height="25"> <select size="1" name="selStatus">
          <option value="0">Selecione um Status</option>
          <%DO UNTIL RS_STATUS.EOF=TRUE%>
          <option value="<%=RS_STATUS("SITU_TX_CD_STATUS")%>"><%=RS_STATUS("SITU_TX_DESC_SITUACAO")%></option>
          <%
          RS_STATUS.MOVENEXT
          LOOP
          %>
    ...
    <tr>
      <td height="25"> <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Escopo</font></b></td>
      <td height="25"> <select size="1" name="selEscopo">
          <option value="2">Selecione o Escopo</option>
          <option value="1" selected>DENTRO DO ESCOPO</option>
          <option value="0">FORA DO ESCOPO</option>
        </select> </td>
      <td height="25">&nbsp;</td>
      <td height="25">&nbsp;</td>
    </tr>
    <tr> 
      <td width="21%" height="25"> <div align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Cen&aacute;rio</font></b></div></td>
      <td width="52%" height="25"> <select name="ID" size="1">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      <td width="21%" height="21"></td>
      <td width="52%" height="21"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Se 
    ...
    <tr> 
      ...
      <td width="52%" height="25"><input type="text" name="ID2" size="33" maxlength=11> 
    ...
    <tr> 
      <td width="21%" height="25"> <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Ordenar 
          por</font></b></td>
      <td width="52%" height="25"> <select size="1" name="Order">
          <option value="CENA_CD_CENARIO" selected>CENÁRIO</option>
          <option value="CENA_TX_SITUACAO">STATUS</option>
          <option value="CENA_TX_SITU_DESENHO_TIPO">TIPO</option>
          <option value="CENA_TX_SITU_DESENHO_CONF">CONFIGURAÇÃO</option>
          <option value="CENA_TX_SITU_DESENHO_DESE">DESENVOLVIMENTO</option>
        </select> </td>
      <td width="12%" height="25"></td>
      <td width="17%" height="25"></td>
    </tr>
