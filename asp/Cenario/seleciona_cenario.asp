...
<form name="frm1" method="post" action="cad_cenario_transacao.asp">
  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="111">
    ...
    <tr> 
      ...
      <td width="52%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','seleciona_cenario.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%" height="25"> 
        <select name="selProcesso" onChange="MM_goToURL2('self','seleciona_cenario.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="52%"> 
        <select name="selSubProcesso" onChange="MM_goToURL3('self','seleciona_cenario.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      <td width="19%">&nbsp;</td>
      <td width="52%">&nbsp;<input type="hidden" name="INC" size="20" value="1"> </td>
      <td width="12%">&nbsp;</td>
      <td width="17%">&nbsp;</td>
    </tr>
  </table>
