...
{
window.location.href="rel_entsai.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selOnda="+document.frm1.selOnda.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
<form name="frm1" method="post" action="gera_rel_entsai.asp">
  ...
  <table width="97%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="234">
    <tr>
    ...
    <tr> 
      ...
      <td width="52%" height="25" colspan="2"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','rel_entsai.asp');return document.MM_returnValue" size="1">
