...
{
window.location.href="rel_cenario.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
<form name="frm1" method="post" action="gera_rel_cenario.asp">
  ...
  <table width="97%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="330">
    <tr>
      <td width="21%" height="1">&nbsp;</td>
      <td width="52%" height="1" colspan="2"> 
        <input type="hidden" name="txtOpc" value="1">
        <font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="3">Relatório
        Geral de Cenário</font>
      </td>
    ...
    <tr> 
      ...
      <td width="52%" height="25" colspan="2"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','rel_cenario.asp');return document.MM_returnValue" size="1">
...
%>
    ...
    <tr> 
      <td width="21%" align="right" height="25"> 
        <font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Processo</b></font>
      </td>
      <td width="52%" height="25" colspan="2"> 
      <%set rs_proc=conn_db.execute(str_SQL_Proc)%>
        <select size="1" name="selProcesso" onChange="MM_goToURL2('self','rel_cenario.asp');return document.MM_returnValue">
          <option value="0">== TODOS ==</option>
    ...
    <tr> 
      <td width="21%" align="right" height="17"> 
        <font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Sub-Processo</b></font>
      </td>
      <td width="52%" height="17" colspan="2"> 
        <%set rs_sub = conn_db.execute(str_SQL_Sub_Proc)%>
        <select size="1" name="selSubProcesso" onChange="MM_goToURL3('self','rel_cenario.asp');return document.MM_returnValue">
          <option value="0">== TODOS ==</option>
    ...
    <tr>
      <td width="21%" height="25"> 
        <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Escopo</font></b></td>
    ...
    <tr> 
      <td width="21%" height="25"> 
        <p align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Status</font></b>
      </td>
      <td width="52%" height="25" colspan="2"> 
...
%>
    ...
    <tr> 
      ...
      <td width="52%" height="21" colspan="2"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">Se
    ...
    <tr> 
      ...
      <td width="22%" height="25"><input type="text" name="ID2" size="33" maxlength=11>  <font face="Verdana, Arial, Helvetica, sans-serif" color="#330099" size="1">(
