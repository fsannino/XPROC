...
str_codigo=request("ID")

valor=str_codigo

DB.EXECUTE("DELETE FROM " & Session("PREFIXO") & "CLASSE_CENARIO_MEGA_PROCESSO WHERE CLCE_CD_NR_CLASSE_CENARIO=" & valor)

ssql=""
ssql="UPDATE " & Session("PREFIXO") & "CLASSE_CENARIO "
ssql=ssql+"SET CLCE_TX_DESC_CLASSE_CENARIO='"& ucase(str_classe) &"' "
ssql=ssql & " ,ATUA_TX_OPERACAO = 'A'"   
ssql=ssql & " ,ATUA_CD_NR_USUARIO = '" & Session("CdUsuario") & "'"
ssql=ssql & " ,ATUA_DT_ATUALIZACAO = GETDATE()"
ssql=ssql+"WHERE CLCE_CD_NR_CLASSE_CENARIO="& valor 
...
<div align="center">
  ...
  <table border="0" width="790" height="128">
    ...
    <tr>
      <td width="233"></td>
      <td width="48">
            <a href="alterar_classe.asp"><img src="../../imagens/selecao_F02.gif" border="0" align="right"></a>
            </td>
      <td width="489" height="49">
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Volta
        para tela de alteração de Classes</font>
        </td>
    </tr>
  </table>
</div>
