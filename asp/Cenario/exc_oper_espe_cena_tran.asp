...
if (Request("p_Cen_Sequencia") <> "") then 
    str_Cen_Sequencia = Request("p_Cen_Sequencia")
else
    str_Cen_Sequencia = "0"
end if
...
str_SQL_Cen_Tran = str_SQL_Cen_Tran & " AND " & Session("PREFIXO") & "CENARIO_TRANSACAO.CETR_NR_SEQUENCIA = " &  str_Cen_Sequencia
Set rdsCen_Tran= Conn_db.Execute(str_SQL_Cen_Tran)
if not rdsCen_Tran.EOF then
   str_Seq_Tran = rdsCen_Tran("CENA_NR_SEQUENCIA_TRANS")
   str_Desc_Transacao = rdsCen_Tran("CETR_TX_DESC_TRANSACAO")
   str_OpeEsp = rdsCen_Tran("OPES_CD_OPERACAO_ESP")   
   str_CenarioSeguinte = rdsCen_Tran("CENA_CD_CENARIO_SEGUINTE")   
   str_BPP = rdsCen_Tran("BPPP_CD_BPP")   
else
   str_Seq_Tran = ""
   str_Desc_Transacao = ""
   str_OpeEsp = ""
...
if str_OpeEsp = "" or IsNull(str_OpeEsp) then
   str_OpeEsp = "0"
end if
str_SQL_OpEs = ""
...
str_SQL_OpEs = str_SQL_OpEs & " where OPES_CD_OPERACAO_ESP = " & str_OpeEsp
'response.write str_SQL_OpEs
Set rdsOpEs= Conn_db.Execute(str_SQL_OpEs)
if not rdsOpEs.EOF then
   str_Desc_OpeEsp = rdsOpEs("OPES_TX_DESC_OPERACAO_ESP")
else
   str_Desc_OpeEsp = ""
end if
rdsOpEs.Close
...
if str_Cenario = "" or IsNull(str_Cenario) then
   str_Cenario = ""
end if
...
if not rdsCenario.EOF then
   str_Desc_Cenario = rdsCenario("CENA_TX_TITULO_CENARIO")
else
   str_Desc_Cenario = ""
end if
rdsCenario.Close
...
if str_CenarioSeguinte = "" or IsNull(str_CenarioSeguinte) then
   str_CenarioSeguinte = "0"
end if

str_SQL_CenarioSeguinte = ""
str_SQL_CenarioSeguinte = str_SQL_CenarioSeguinte & " SELECT "
str_SQL_CenarioSeguinte = str_SQL_CenarioSeguinte & " CENA_CD_CENARIO"
str_SQL_CenarioSeguinte = str_SQL_CenarioSeguinte & " , CENA_TX_TITULO_CENARIO"
str_SQL_CenarioSeguinte = str_SQL_CenarioSeguinte & " FROM " & Session("PREFIXO") & "CENARIO"
str_SQL_CenarioSeguinte = str_SQL_CenarioSeguinte & " where CENA_CD_CENARIO = '" &  str_Cen_Seg & "'"
Set rdsDescCenario= Conn_db.Execute(str_SQL_CenarioSeguinte)
if not rdsDescCenario.EOF then
   str_Desc_Cen_Seg = rdsDescCenario("CENA_TX_TITULO_CENARIO")
else
   str_Desc_Cen_Seg = ""
end if
...
if str_BPP = "" or IsNull(str_BPP) then
   str_BPP = "0"
end if

str_SQL_BPP = ""
str_SQL_BPP = str_SQL_BPP & " SELECT "
str_SQL_BPP = str_SQL_BPP & " BPPP_CD_BPP"
str_SQL_BPP = str_SQL_BPP & " , BPPP_TX_DESC_BPP"
str_SQL_BPP = str_SQL_BPP & " FROM " & Session("PREFIXO") & "BPP"
str_SQL_BPP = str_SQL_BPP & " where BPPP_CD_BPP ='" & str_BPP & "'"
Set rdsBPP= Conn_db.Execute(str_SQL_BPP)
if not rdsBPP.EOF then
   str_Desc_BPP = rdsBPP("BPPP_TX_DESC_BPP")
else
   str_Desc_BPP = ""
end if
rdsBPP.Close
...
function Confirma() 
{ 
if (document.frm1.txtSeq.value == "")
     { 
	 alert("O preenchimento do campo Sequência é obrigatório.");
     document.frm1.txtSeq.focus();
     return;
     }	 
  ano=document.frm1.txtSeq.value 
  ok = 1
  for(i=0; i<4; ++i) {
...
if (document.frm1.txtDescOprEs.value == "")
     { 
	 alert("O preenchimento do campo Descrição da Operação Especial é obrigatório.");
     document.frm1.txtDescOprEs.focus();
     return;
     }	 
	 else
	 {
...
<form name="frm1" method="POST" action="grava_operacoes_especiais.asp">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="62%"><%=str_SQL_Cen_Tran%></td>
      <td width="14%">&nbsp;</td>
    </tr>
    <tr> 
      <td width="24%">&nbsp;</td>
      <td width="62%"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Exclui 
        Transa&ccedil;&atilde;o de um Cen&aacute;rio</font></td>
      <td width="14%">&nbsp;</td>
    </tr>
  </table>
  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr> 
      ...
      <td width="17%">&nbsp;</td>
      <td width="54%">&nbsp;</td>
      <td width="27%"><%=str_SQL_CenarioSeguinte%></td>
    </tr>
    <tr> 
      <td width="2%">&nbsp;</td>
      <td width="17%"> 
      ...
      <td width="54%"><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_MegaProcesso%>-<%=ls_Desc_MegaProcesso%></font></b></td>
      <td width="27%">&nbsp;</td>
    </tr>
    <tr> 
      <td width="2%">&nbsp;</td>
      ...
      <td width="54%"><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Processo%>-<%=ls_Desc_Processo%></font></b></td>
      <td width="27%">&nbsp;</td>
    </tr>
    <tr> 
      <td width="2%">&nbsp;</td>
      ...
      <td width="54%"><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_SubProcesso%>-<%=ls_Desc_SubProcesso%></font></b></td>
      <td width="27%"><%=str_Cen_Seg%></td>
    </tr>
    <tr> 
      <td width="2%">&nbsp;</td>
      <td width="17%"> 
  ...
  <table width="779" border="0" cellspacing="4" cellpadding="0">
    <tr> 
      <td width="70">&nbsp;</td>
      <td width="187">&nbsp;</td>
      <td width="522"> 
        <input type="hidden" name="txtCenSeq" value="<%=str_Cen_Seg%>">
      </td>
    </tr>
    <tr> 
      <td width="70">&nbsp;</td>
      ...
      <td width="522"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Seq_Tran%> </font></td>
    </tr>
    <tr> 
      <td width="70">&nbsp;</td>
      <td width="187"> 
      ...
      <td width="522"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Desc_Transacao%> </font></td>
    </tr>
    <tr> 
      <td width="70">&nbsp;</td>
      <td width="187"> 
        <div align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"> 
          Tipo Oper Esp </font></b></div>
      </td>
      <td width="522"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Desc_OpeEsp%></font></td>
    </tr>
    <tr> 
      <td width="70">&nbsp;</td>
      <td width="187"> 
        <div align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"> 
          Desvia para Cen&aacute;rio </font></b></div>
      </td>
      <td width="522"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Desc_Cen_Seg%> </font></td>
    </tr>
    <tr> 
      <td width="70">&nbsp;</td>
      <td width="187"> 
        <div align="right"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">BPP 
          </font></b></div>
      </td>
      <td width="522"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Desc_BPP%> </font></td>
    </tr>
    <tr> 
      <td width="70">&nbsp;</td>
      <td width="187">&nbsp;</td>
      <td width="522"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        </font></td>
    </tr>
  </table>
  <p>&nbsp; </p>
