...
ORDEM= " ORDER BY ONDA_CD_ONDA, MEPR_CD_MEGA_PROCESSO, CENA_TX_SITUACAO"
    ...
    <td colspan="3" height="20"> 
      <table width="625" border="0" align="center">
        <tr> 
          ...
          <td width="27"></td>
          <td width="50"><a href="gera_rel_cenario_quebra_perc.asp?excel=1&amp;selOnda=<%=request("selOnda")%>&amp;SelMegaProcesso=<%=request("selMegaProcesso")%>&amp;selStatus=<%=request("selStatus")%>" target="_blank"><img border="0" src="../../imagens/exp_excel.gif"></a></td>
          <td width="28">&nbsp;</td>
          <td width="26">&nbsp;</td>
...
<%end if%>
  ...
  de Cenários por Onda<b> <%=ONDA("ONDA_TX_DESC_ONDA")%>  :</b> <b> <%=TEM%></b></font>
