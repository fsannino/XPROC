...
function Confirma() 
{ 
  if ((!document.frm1.rdbSituacao1[0].checked)&&
      (!document.frm1.rdbSituacao1[1].checked)){
     alert("A seleção do Status é obrigatória !");
     return;
  }
	 else
	 {
...
<form name="frm1" method="POST" action="grava_operacoes_especiais.asp">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr> 
      ...
      <td width="71%"><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_MegaProcesso%>-<%=ls_Desc_MegaProcesso%></font></b></td>
      <td width="12%"> 
    ...
    <tr> 
      ...
      <td width="71%"><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_Processo%>-<%=ls_Desc_Processo%></font></b></td>
      <td width="12%"> 
    ...
    <tr> 
      ...
      <td width="71%"><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"><%=str_SubProcesso%>-<%=ls_Desc_SubProcesso%></font></b></td>
      <td width="12%">&nbsp;</td>
    </tr>
    <tr> 
      <td width="1%">&nbsp;</td>
    ...
    <tr> 
      ...
      <td width="570" valign="top"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="5%">&nbsp;</td>
            <td width="20%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Em 
              elabora&ccedil;&atilde;o</font></td>
            <td width="75%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">(o 
              cen&aacute;rio foi criado)</font></td>
          </tr>
          <tr> 
            <td width="5%"> 
              <input type="radio" name="rdbSituacao1" value="DF">
            </td>
            <td width="20%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Definido</font></td>
            <td width="75%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099"> 
              (o cen&aacute;rio est&aacute; pronto para ser testado)</font></td>
          </tr>
          <tr> 
            <td width="5%"> 
              <input type="radio" name="rdbSituacao1" value="ID">
            </td>
            <td width="20%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">Indefinido 
              </font></td>
            <td width="75%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000099">(o 
              cen&aacute;rio est&aacute; dependendo de informa&ccedil;&otilde;es 
              adicionais)</font></td>
          </tr>
          <tr> 
            <td width="5%">&nbsp; </td>
