...
<form name="frm1" method="post" action="gera_rel_resp.asp">
  ...
  <table width="94%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="109">
    <tr>
...
Relat&oacute;rio de Cen&aacute;rios sem Respons&aacute;vel</span></span></td>
