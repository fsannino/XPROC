...
{
window.location.href="altera_cenario.asp?txtOpc="+document.frm1.txtOpc.value+"&selMegaProcesso="+document.frm1.selMegaProcesso.value+"&selProcesso="+document.frm1.selProcesso.value+"&selSubProcesso="+document.frm1.selSubProcesso.value+"&selAssunto="+document.frm1.selAssunto.value
}
...
<form name="frm1" method="post" action="alterar_cenario.asp">
  ...
  <table width="96%" border="0" cellpadding="0" cellspacing="0" name="tblSubProcesso" height="300">
    <tr>
      <td width="19%" height="39">&nbsp;</td>
      <td width="59%" height="39" colspan="2"> 
        <input type="hidden" name="txtOpc" value="1">
        <p align="center"><font face="Verdana" color="#330099" size="3">Alteração 
          de Cenário</font>
        <p align="center" style="margin-top: 0; margin-bottom: 0">&nbsp;
      </td>
      <td width="5%" height="39"> 
        <%'=str_Opc%></td>
    ...
    <tr> 
      ...
      <td width="59%" colspan="2" height="25"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" onChange="MM_goToURL1('self','altera_cenario.asp');return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="59%" height="25" colspan="2"> 
        <select name="selProcesso" onChange="MM_goToURL2('self','altera_cenario.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      <td width="59%" colspan="2" height="25"> 
        <select name="selSubProcesso" onChange="MM_goToURL3('self','altera_cenario.asp',this);return document.MM_returnValue">
          <% 
		  if str_Opc <> "1" then %>
...
%>
    ...
    <tr> 
      ...
      %>
      <td width="59%" colspan="2" bgcolor="#FFFFFF" height="21"><font color="#800000" size="2" face="Verdana"><b><%=ord%></b></font> </td>
      <td width="5%" height="21"></td>
      <td width="17%" height="21"></td>
    </tr>
    <tr> 
      <td width="19%" height="21"></td>
      <td width="59%" colspan="2" bgcolor="#CCCCCC" height="21"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099">&nbsp;&nbsp;&nbsp;
        Se
    ...
    <tr> 
      ...
      <td width="27%" bgcolor="#CCCCCC" height="26">
        ...
        Ex.: MM.REF.0100 ) </font><input type="hidden" name="INC" size="20" value="1"> </p>
 </td>
      <td width="32%" bgcolor="#CCCCCC" height="26">
        <p style="margin-top: 0; margin-bottom: 0"><a href="javascript:Confirma3()"><img src="../../imagens/confirma_f02.gif" width="24" height="24" border="0" align="absmiddle"></a><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#330099"><b>Alterar</b></font></p>
 </td>
