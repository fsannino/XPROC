...
<form name="frm1" method="post" action="gera_rel_cenario_quebra.asp">
  ...
  <table width="90%" border="0" cellpadding="2" cellspacing="7" name="tblSubProcesso" height="136">
    <tr>
    ...
    <tr>
      ...
      <option value="0">TODAS AS ONDAS</option>
    ...
    <tr> 
      ...
      <td width="55%" height="25"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        <select name="selMegaProcesso" size="1">
          <option value="0" selected>TODOS OS MEGA-PROCESSOS</option>
          <option value="0" >TODOS OS MEGA-PROCESSOS</option>
          &nbsp;
          <% 
		  if str_Opc <> "1" then %>
          <% else %><% end if %>
...
%>
    ...
    <tr> 
      ...
      <td width="55%" height="25" valign="middle" align="left"> 
        <b><font color="#330099" face="Verdana, Arial, Helvetica, sans-serif" size="1"><input type="checkbox" name="soma" value="1" style="float: left">Visualizar
        Somente Somatórios / Percentuais</font></b>
      </td>
    </tr>
  </table>
  </form>
