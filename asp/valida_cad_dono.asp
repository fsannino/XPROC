...
valor=request("selTransacao")

db.execute("DELETE FROM " & Session("PREFIXO") & "TRANSACAO_MEGA WHERE TRAN_CD_TRANSACAO='" & valor & "'")

str_mega=request("txtEmpSelecionada")

'response.write valor & " - "
'response.write str_mega

ssql=""

Sub Grava_transacao(strC, strM)
	
	ssql=""
	ssql="INSERT INTO " & Session("PREFIXO") & "TRANSACAO_MEGA "
...
Do Until contador = tamanho + 1
    ...
    If str_temp = "," Then
	   ...
	   'Aqui entra o que vc quer fazer com o caracter em questão!
			...
			call Grava_transacao(valor, str_atual)
  ...
  <table border="0" width="790" height="128">
    ...
    <tr>
      ...
      <td width="543" height="21" colspan="2"><b><font face="Verdana" size="2" color="#FF0000">Ocorreu
        um erro na gravação do Registro - <%=err.description%></font></b></td>
    </tr>
    <%end if%>
    <tr>
      <td width="233" height="21"></td>
    ...
    <tr>
      <td width="233"></td>
      <td width="48">
            <a href="cad_dono.asp?transacao=<%=valor%>"><img src="../imagens/selecao_F02.gif" border="0" align="right"></a>
            </td>
      <td width="489" height="49">
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Volta
        para tela de Cadastro de Dono</font>
        </td>
    </tr>
  </table>
</div>
