...
ssql=ssql & "SET SUPR_TX_DESC_SUB_PROCESSO='" & str_Param & "' "
ssql=ssql & "WHERE MEPR_CD_MEGA_PROCESSO=" & str_Mega & " AND PROC_CD_PROCESSO= " & str_Proc & " AND SUPR_CD_SUB_PROCESSO= " & str_sub
...
<form method="POST" action="valida_altera_processo.asp?mega=<%=str_MegaProcesso%>&Proc=<%=str_Processo%>">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="3%"></td>
      <td width="18%"></td>
      <td width="65%"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000099" size="2"><b>Processo 
    ...
    <tr> 
      <td width="3%"></td>
      <td width="18%"></td>
      <td width="65%"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#800000">Não 
    ...
    <tr> 
      ...
      <td width="65%"> 
        <table width="74%" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr> 
            <td height="41"><a href="JavaScript:history.go(-1)"><img src="../imagens/selecao_F02.gif" width="22" height="20" border="0"></a></td>
            <td height="41"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366">Volta 
              para tela de Altera&ccedil;&atilde;o de Sub Processo</font></td>
          </tr>
          <tr> 
