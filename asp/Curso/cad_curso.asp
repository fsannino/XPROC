...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
  ...
  <table border="0" width="849" height="149">
    <tr> 
      <td width="116" height="29"></td>
      <td width="209" height="29" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Código 
        do Curso</b></font></td>
      <td width="504" height="29" valign="middle" align="left"> <input type="text" name="txtCodCurso" size="14" maxlength="6"></td>
    </tr>
    <tr>
      <td height="29"></td>
      <td height="29" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Status do Curso - Ativo:</b></font></td>
      <td height="29" valign="middle" align="left"><input name="checkAtivo" type="checkbox" value="1" checked></td>
    </tr>
    <tr> 
      <td width="116" height="29"></td>
      <td width="209" height="29" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Mega-Processo 
        :</b></font></td>
      <td width="504" height="29" valign="middle" align="left"> <select size="1" name="selMegaProcesso">
    ...
    <tr> 
      ...
      <td width="209" height="1" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Nome 
        do Curso :</b></font></td>
      <td height="1" valign="middle" align="left" width="504"> <input type="text" name="txtnomecurso" size="58" maxlength="100"></td>
    </tr>
    <tr> 
      <td width="116" height="1"></td>
      <td width="209" height="1" valign="middle" align="left"></td>
    ...
    <tr> 
      ...
      <td height="1" valign="middle" align="left"><select size="1" name="selOnda">
          <option value="0">== Selecione Abrangência ==</option>
    ...
    <tr>
      ...
      <td height="1" valign="middle" align="left"> <font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif">Caso 
        o curso seja pertinente &agrave;s solu&ccedil;&otilde;es antecipada e 
        definitiva, &nbsp;marcar a op&ccedil;&atilde;o &quot;PET&quot; adequada.</font></td>
    </tr>
    <tr> 
      <td width="116" height="1"></td>
      <td width="209" height="1" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Carga 
        Horária (h):</b></font></td>
      <td height="1" valign="middle" align="left" width="504"> <input type="text" name="txtcargacurso" size="14" onkeyup="javascript:ver_conteudo(txtcargacurso)"></td>
    </tr>
    <tr> 
      <td width="116" height="1"></td>
      <td width="209" height="1" valign="middle" align="left"></td>
    ...
    <tr> 
      ...
      <td width="209" height="1" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Método 
        :</b></font></td>
      <td height="1" valign="middle" align="left" width="504"> <select size="1" name="selMetodo">
    ...
    <tr> 
      ...
      <td width="209" height="1" valign="top" align="left"><font face="Verdana" size="2" color="#330099"><b>Público 
        Alvo : </b></font></td>
      <td height="1" valign="middle" align="left" width="504"> <textarea rows="4" name="txtPublicoAlvo" cols="50"></textarea> 
      </td>
    </tr>
    <tr> 
      <td width="116" height="1"></td>
    ...
    <tr> 
      <td width="116" height="1"></td>
      <td width="209" height="1" valign="top" align="left"><font face="Verdana" size="2" color="#330099"><b>Requisitos 
        n&atilde;o R/3:</b></font></td>
      <td height="1" valign="middle" align="left" width="504"> <textarea rows="4" name="txtPreRequisitos" cols="50"></textarea> 
      </td>
    </tr>
    <tr> 
      <td width="116" height="1"></td>
    ...
    <tr> 
      ...
      <td height="1" valign="middle" align="left" width="504"> <textarea rows="4" name="txtConteudo" cols="50"></textarea> 
      </td>
    </tr>
    <tr> 
      <td width="116" height="1"></td>
    ...
    <tr> 
      ...
      <td width="209" height="1" valign="top" align="left"><font face="Verdana" size="2" color="#330099"><b>Objetivo 
        :</b></font></td>
      <td height="1" valign="middle" align="left" width="504"> <textarea rows="4" name="txtObjetivo" cols="50"></textarea> 
      </td>
    </tr>
    <tr> 
      <td width="116" height="1"></td>
