...
<form method="POST" action="valida_rel_curso_pre_requisito_alternativo.asp" name="frm1">
    ...
    <tr>
      <td>
        <div align="center"><font face="Verdana" color="#330099" size="3">Relação 
          Curso x Pré-Requisitos Alternativo</font></div>
      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
        ...
        <table border="0" width="964" height="142">
          <tr>
            ...
            <td width="300" height="138" rowspan="5">
              ...
              SET RSTEM=DB.EXECUTE("SELECT * FROM " & Session("PREFIXO") & "CURSO_PRE_REQUISITO WHERE CURS_CD_CURSO='" & CURSO & "' AND CURS_PRE_REQUSITO='" & rscurso("CURS_CD_CURSO") & "'")
            ...
            <td width="526" height="138" rowspan="5">
              ...
              <select size="7" name="list2" multiple>
           	...
           	set temp=db.execute("SELECT * FROM " & Session("PREFIXO") & "CURSO WHERE CURS_CD_CURSO='" & rscursopre("CURS_CD_CURSO") & "'")
           	VALOR = temp("CURS_TX_NOME_CURSO")
           	%>
				 <option value="<%=rscursopre("CURS_CD_CURSO")%>"><%=rscursopre("CURS_CD_CURSO")%>-<%=VALOR%></option>
				 <%
				 rscursopre.movenext
				 loop
				 %>
