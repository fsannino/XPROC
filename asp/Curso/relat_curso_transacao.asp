    ...
    <tr>
      <td>
        <div align="center">
          ...
          de Cursos x Transação</font></div>
      </td>
    </tr>
  </table>
        ...
        <table border="0" width="100%">
          <tr>
            ...
            <td width="34%" bgcolor="#330099"><b><font face="Verdana" size="2" color="#FFFFFF">Transação</font></b></td>
          </tr>
          <%
          ...
          do until rs.eof=true
			...
			set rstemp=db.execute("SELECT * FROM " & Session("PREFIXO") & "CURSO_TRANSACAO WHERE CURS_CD_CURSO='" & rs("CURS_CD_CURSO") & "' ORDER BY TRAN_CD_TRANSACAO")			          
          ...
          <tr>
            ...
            <%
            	SET RS1=DB.EXECUTE("SELECT * FROM " & Session("PREFIXO") & "TRANSACAO WHERE TRAN_CD_TRANSACAO='" & RSTEMP("TRAN_CD_TRANSACAO") & "'")
				NOME2=RS1("TRAN_TX_DESC_TRANSACAO")            
            %>
            <td width="34%" bgcolor="#CCFFCC"><font face="Verdana" size="2" color="#330099"><%=rstemp("TRAN_CD_TRANSACAO")%>-<%=NOME2%></font></td>
          </tr>
          <%
          tem=tem+1
