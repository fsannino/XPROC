    ...
    <tr>
      <td>
        <div align="center">
          ...
          de Cursos x </font><font face="Verdana" color="#330099" size="3">Cenário</font></div>
      </td>
    </tr>
  </table>
        ...
        <table border="0" width="100%">
          <tr>
            ...
            <td width="34%" bgcolor="#330099"><b><font face="Verdana" size="2" color="#FFFFFF">Cenário</font></b></td>
          </tr>
          <%
          ...
          do until rs.eof=true
			...
			set rstemp=db.execute("SELECT * FROM " & Session("PREFIXO") & "CURSO_CENARIO WHERE CURS_CD_CURSO='" & rs("CURS_CD_CURSO") & "' ORDER BY CENA_CD_CENARIO")			          
          ...
          <tr>
            ...
            <%
            	SET RS1=DB.EXECUTE("SELECT * FROM " & Session("PREFIXO") & "CENARIO WHERE CENA_CD_CENARIO='" & RSTEMP("CENA_CD_CENARIO") & "'")
				NOME2=RSTEMP("CENA_CD_CENARIO") & "-" & RS1("CENA_TX_TITULO_CENARIO")            
            %>
