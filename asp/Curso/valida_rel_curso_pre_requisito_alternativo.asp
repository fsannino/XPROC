...
set rs_seq=db.execute("SELECT MAX(CUPR_NR_SEQUENCIA) AS CODIGO FROM " & Session("PREFIXO") & "CURSO_PRE_REQUISITO_ALTER WHERE CURS_CD_CURSO='" & curso & "'")
...
Sub Grava_Pre(strP,seq1,seq2)

	ssql=""
	ssql="INSERT INTO " & Session("PREFIXO") & "CURSO_PRE_REQUISITO_ALTER (CURS_CD_CURSO,CUPR_NR_SEQUENCIA,CURS_PRE_REQUISITO,ATUA_TX_OPERACAO,ATUA_CD_NR_USUARIO,ATUA_DT_ATUALIZACAO) "
	...
	if err.number=0 then
		'call grava_log(ucase(curso),"" & Session("PREFIXO") & "CURSO_PRE_REQUISITO","I",1)
	end if
...
Do Until contador = tamanho + 1
    ...
    If str_temp = "," Then
        ...
        str_atual = Left(str_atual, quantos - 1)
			...
			call Grava_Pre(str_atual,seq,contador)
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
    ...
    <tr>
      <td width="845">
        <p align="center"><font face="Verdana" color="#330099" size="3">Relação 
          Curso x Pré - Requisito Alternativo</font>
      </td>
    </tr>
    <tr>
      <td width="845">&nbsp;</td>
  ...
  <table border="0" width="779" height="87">
    <tr> 
      ...
      <td height="29" valign="middle" align="left" colspan="2"> 
        <%if err.number=0 then%>
        <b><font face="Verdana" color="#330099" size="2">O Curso e seus Pré-Requisitos 
        Alternativos foram relacionados com Sucesso</font></b> </td>
    </tr>
    <%else%>
    <tr> 
    ...
    <tr> 
      <td width="205" height="1"></td>
      <td width="93" height="1" valign="middle" align="left"></td>
      <td height="1" valign="middle" align="left" width="93"> <a href="../../indexA.asp"> 
        <img border="0" src="../../imagens/selecao_F02.gif" align="right" width="22" height="20"></a></td>
      <td height="1" valign="middle" align="left" width="370"> <font face="Verdana" color="#330099" size="2">Retornar 
        para Tela Principal</font></td>
    </tr>
    <tr> 
      <td width="205" height="1"></td>
      <td width="93" height="1" valign="middle" align="left"></td>
      <td height="1" valign="middle" align="left" width="93"> <a href="rel_curso_pre_requisitos.asp?mega=<%=mega%>&amp;curso=<%=curso%>"> 
        <img border="0" src="../../imagens/selecao_F02.gif" align="right" width="22" height="20"></a></td>
      <td height="1" valign="middle" align="left" width="370"> <font face="Verdana" color="#330099" size="2">Retornar 
        para Tela de Relacionar Curso x Pré-Requisitos Alternativo</font></td>
    </tr>
    <tr> 
      <td width="205" height="1"></td>
      <td width="93" height="1" valign="middle" align="left"></td>
      <td height="1" valign="middle" align="left" width="93"> </td>
      <td height="1" valign="middle" align="left" width="370"> </td>
    </tr>
    <tr> 
      <td width="205" height="1"></td>
      <td width="93" height="1" valign="middle" align="left"></td>
