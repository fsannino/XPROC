...
curso=request("curso")
transa=request("txtTrans")
'response.Write(" ini tran <p>")
'response.Write(transa)
'response.Write(" fin tran  <p>")
set db = Server.CreateObject("ADODB.Connection")
db.Open Session("Conn_String_Cogest_Gravacao")

str_Sql = ""
str_Sql = str_Sql & " DELETE FROM " & Session("PREFIXO") & "CURSO_TRANSACAO "
...
Sub Grava_Trans(strI)
	ssql=""
	ssql="INSERT INTO " & Session("PREFIXO") & "CURSO_TRANSACAO ("
	ssql=ssql+" CURS_CD_CURSO "
	ssql=ssql+" ,TRAN_CD_TRANSACAO "
	ssql=ssql+" ,ATUA_TX_OPERACAO "
	ssql=ssql+" ,ATUA_CD_NR_USUARIO "
	ssql=ssql+" ,ATUA_DT_ATUALIZACAO )"
	ssql=ssql+"VALUES(" 
	ssql=ssql+"'" & ucase(curso) & "'"
	ssql=ssql+", '" & strI & "'"
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
  ...
  <table border="0" width="849" height="87">
      ...
      <b><font face="Verdana" color="#330099" size="2">O Curso e Transações foram
      relacionados com
      Sucesso</font></b> 
      </td>
      ...
      <td height="1" valign="middle" align="left" width="93"> 
        <a href="seleciona_curso.asp?option=2"> 
        <img border="0" src="../../imagens/selecao_F02.gif" align="right"></a></td>
            
      <td height="1" valign="middle" align="left" width="439"> <font face="Verdana" color="#330099" size="2">Retornar 
        para Tela de Relacionar Curso x Fun&ccedil;&atilde;o</font></td>
          </tr>
          <tr>
