...
Sub Grava_Trans(strC)
	...
	ssql=""
	ssql="INSERT INTO " & Session("PREFIXO") & "CURSO_CENARIO "
	ssql=ssql+"VALUES('" & strC & "',"
	ssql=ssql+"'I','" & ucase(curso) & "','" & Session("CdUsuario") & "',GETDATE())"
	
	on error resume next	
	db.execute(ssql)
	
	if err.number=0 then
		'call grava_log(ucase(curso),"" & Session("PREFIXO") & "CURSO_CENARIO","I",1)
	end if
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
  ...
  <table border="0" width="849" height="87">
      ...
      <%if err.number=0 then%>
      <b><font face="Verdana" color="#330099" size="2">O Curso e Cenários foram
      relacionados com
      Sucesso</font></b> 
      </td>
