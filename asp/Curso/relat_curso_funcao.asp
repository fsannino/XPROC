    ...
    <tr>
      <td>
        <div align="center">
          ...
          de Cursos x Fun&ccedil;&atilde;o R/3</font></div>
      </td>
    </tr>
  </table>
        ...
        <table border="0" width="100%">
          <tr>
            ...
            <td width="34%" bgcolor="#330099"><b><font face="Verdana" size="2" color="#FFFFFF">Função</font></b></td>
          </tr>
          <%
          ...
          do until rs.eof=true
			...
			set rstemp=db.execute("SELECT * FROM " & Session("PREFIXO") & "CURSO_FUNCAO WHERE CURS_CD_CURSO='" & rs("CURS_CD_CURSO") & "' ORDER BY FUNE_CD_FUNCAO_NEGOCIO")			          
          ...
          <tr>
            ...
            <%
				if atual2<>ant2 then
					NOME_CURSO=RS("CURS_TX_NOME_CURSO")            
				else
					nome_curso=""
				end if
				if nome_curso="" then
            ...
            <%
            	SET RS1=DB.EXECUTE("SELECT * FROM " & Session("PREFIXO") & "FUNCAO_NEGOCIO WHERE FUNE_CD_FUNCAO_NEGOCIO='" & RSTEMP("FUNE_CD_FUNCAO_NEGOCIO") & "'")
				NOME2=RS1("FUNE_TX_TITULO_FUNCAO_NEGOCIO")            
            %>
            <td width="34%" bgcolor="#CCFFCC"><font face="Verdana" size="2" color="#330099"><%=RSTEMP("FUNE_CD_FUNCAO_NEGOCIO")%>-<%=NOME2%></font></td>
          </tr>
          <%
          tem=tem+1
