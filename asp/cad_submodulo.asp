...
<form name="frm1" method="post" action="valida_cad_submodulo.asp">
  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td width="10%">&nbsp;</td>
      <td width="20%">
        <p align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b>Mega-Processo&nbsp;&nbsp;</b></font></p>
      </td>
      <td width="70%"> 
...
%>
    ...
    <tr> 
      ...
      <td width="20%" align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#003366"><b>Descrição&nbsp;&nbsp;</b></font></td>
      <td width="70%"><input type="text" name="txtDesc" size="78"></td>
    </tr>
    <tr> 
      <td width="10%">&nbsp;</td>
      <td width="20%">&nbsp;</td>
