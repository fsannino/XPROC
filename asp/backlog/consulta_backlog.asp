...
function manda()
{
window.location.href="consulta_backlog.asp?selMega="+document.frm1.selMega.value+"&selModulo="+document.frm1.selModulo.value+"&op="+<%=request("op")%>
}
</script>
<%
case 2
...
function manda()
{
window.location.href="consulta_backlog.asp?str01="+document.frm1.Str01.value+"&str02="+document.frm1.Str02.value+"&str03="+document.frm1.Str03.value+"&op="+<%=request("op")%>
}
</script>
<%
case 3
...
function manda()
{
window.location.href="consulta_backlog.asp?str01="+document.frm1.Str01.value+"&str02="+document.frm1.Str02.value+"&str03="+document.frm1.Str03.value+"&selMega="+document.frm1.selMega.value+"&selModulo="+document.frm1.selModulo.value+"op="+<%=request("op")%>
}
</script>
<%
end select
...
<form name="frm1" method="POST" action="exibe_registros.asp">

  <table border="0" width="96%" height="244">
    <tr> 
      <td width="23%" height="33">&nbsp;</td>
      <td colspan="3" height="33"> 
        <p align="left"><font face="Verdana" color="#000080">Consulta de Solicita&ccedil;&otilde;es 
	...
	<tr> 
      ...
      <td height="1" colspan="2" width="62%"></td>
    </tr>
 	<tr> 
      <td width="23%" height="18"></td>
      <td width="15%" height="18"><b><font face="System" size="2" color="#000080">Mega-Processo</font></b></td>
      <td height="18" colspan="2" width="62%"> 
    ...
    <tr> 
      ...
      <td width="15%" height="20"><b><font face="System" size="2" color="#000080">Assunto</font></b></td>
      <td height="20" colspan="2" width="62%"> 
    ...
    <tr> 
      <td width="23%" height="18"></td>
      <td width="15%" height="18"><font color="#000080" face="System" size="2"><b>Órgão</b></font></td>
      <td height="18" colspan="2" width="62%"> 
    ...
    <tr> 
      ...
      <td width="15%" height="24"><b><font face="System" size="2" color="#000080">Unidade</font></b></td>
      <td height="24" colspan="2" width="62%"> 
    ...
    <tr> 
      ...
      <td width="15%" height="13"><font color="#000080" face="System" size="2"><b> 
        Gerência</b></font></td>
      <td height="13" colspan="2" width="62%"> 
    ...
    <tr> 
      ...
      <td width="15%" height="42" valign="middle"><b><font face="System" size="2" color="#000080">T&iacute;tulo 
        da Solicita&ccedil;&atilde;o</font></b></td>
      <td height="42" valign="middle" colspan="2" width="62%"> 
        <input type="text" name="txtTitulo" size="50" maxlength="50" style="font-family: Verdana; font-size: 8 pt">
      </td>
    </tr>
	<%
	end if
	%>	
    <tr> 
      <td width="23%" height="28"><font color="#990000"></font></td>
      <td width="15%" height="28"><b><font size="2" color="#000080"></font></b></td>
      <td height="28" colspan="2" width="62%"> 
        <input type="button" name="Submit" value="Consultar" onClick="Confirma()">
        <font face="Arial, Helvetica, sans-serif" size="1"><b>
        <input type="button" name="Submit22" value="Menu Principal" onClick="window.location='menu.asp'">
        </b></font> </td>
    </tr>
  </table>
  <p align="left">
