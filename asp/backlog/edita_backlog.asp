...
function manda()
{
//window.location.href="edita_backlog.asp?str01="+document.frm1.Str01.value+"&str02="+document.frm1.Str02.value+"&str03="+document.frm1.Str03.value+"&selMega="+document.frm1.selMega.value+"&selModulo="+document.frm1.selModulo.value+"&selPrioridade="+document.frm1.selPrioridade.value+"&selResponsavel="+document.frm1.selResponsavel.value+"&selTipo="+document.frm1.selTipo.value+"&selLegado="+document.frm1.txtLegado.value
...
{
document.frm1.action='valida_edita_backlog.asp'
document.frm1.submit();
}
}
...
function excluir(e)
{
if(confirm('Confirma a Exclusão do Registro Atual?'))
{
window.location='valida_exclui_backlog.asp?registro='+e
}
}
  ...
  <table border="0" width="96%" height="244">
    ...
    <tr> 
      ...
      <td height="72" colspan="2"> 
        <textarea name="txtDescricao" cols="80" rows="7" onKeyUp="Verifica_tamanho(this.value)"><%=request("txtDescricao")%></textarea>
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td height="28" colspan="2"> 
        ...
        <input type="button" name="Submit2" value="Excluir Solicita&ccedil;&atilde;o" onClick="excluir(<%=Session("Registro_atual")%>)">
