...
<body topmargin="0" leftmargin="0" bgcolor="#FFFFFF">		
		  ...
		  <tr bgcolor="#F1F1F1">
			...
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<td width="237">
						<div align="center">	
							 <a href="dados_centro_treinamento.asp?excel=1&pTituloRel=<%=strTituloRel%>" target="_blank"><img border="0" src="../../imagens/exp_excel.gif" title="Exportar para o Excel"></a>
						</div>
					</td>						
		...
		<table width="52%"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="40%" bgcolor="#CCCCCC"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><strong>Centro Treinamento </strong></font></td>
		  ...
		  <%
			...
			str_Sql = str_Sql & " dbo.GRADE_LOCALIDADE.LOC_CD_LOCALIDADE = dbo.GRADE_CENTRO_TREINAMENTO.LOC_CD_LOCALIDADE"
			str_Sql = str_Sql & " WHERE  dbo.GRADE_CENTRO_TREINAMENTO.CORT_CD_CORTE = " & int_Cd_Corte
			str_Sql = str_Sql & " order by dbo.GRADE_LOCALIDADE.LOC_TX_NOME_LOCALIDADE, dbo.GRADE_CENTRO_TREINAMENTO.CTRO_TX_NOME_CENTRO_TREINAMENTO"
