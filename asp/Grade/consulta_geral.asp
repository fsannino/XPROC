...
<html>
	...
	<script language="javascript">
		...
		{				
			...
			if (strTipo == 'Corte')
			{				
				window.location.href = "consulta_geral.asp?selCorte="+document.frm1.selCorte.value+"&selDiretoria=0&selUnidade=0&pNumRel="+document.frm1.pNumRel.value+"&pTituloRel="+document.frm1.pTituloRel.value+"&selCurso=0";
			}			
			
			if (strTipo == 'Diretoria')
			{
				window.location.href = "consulta_geral.asp?selCorte="+document.frm1.selCorte.value+"&selDiretoria="+document.frm1.selDiretoria.value+"&selUnidade=0&pNumRel="+document.frm1.pNumRel.value+"&pTituloRel="+document.frm1.pTituloRel.value+"&selCurso=0";
			}				
		}
...
<body topmargin="0" leftmargin="0" bgcolor="#FFFFFF">
	<form method="POST" name="frm1">	
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
		  ...
		  <table border="0" width="849" height="222">					
			<tr>
			  <td height="26"></td>
