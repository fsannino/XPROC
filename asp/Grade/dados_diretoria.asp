...
<body topmargin="0" leftmargin="0" bgcolor="#FFFFFF">		
		  ...
		  <tr bgcolor="#F1F1F1">
			...
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<td width="237">
						<div align="center">	
							 <a href="dados_diretoria.asp?excel=1&pTituloRel=<%=strTituloRel%>" target="_blank"><img border="0" src="../../imagens/exp_excel.gif" title="Exportar para o Excel"></a>
						</div>
					</td>						
		...
		<table width="52%"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="79%" bgcolor="#CCCCCC"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><strong>Diretoria</strong></font></td>
          </tr>
		  <%
		  	int_Tot_Registro = 0
			...
			str_Sql = str_Sql & " , DIRE_TX_DESC_DIRETORIA"
			str_Sql = str_Sql & " FROM dbo.GRADE_DIRETORIA "
			set rds_Diretoria = db_banco.Execute(str_Sql)
			if not rds_Diretoria.Eof then
				Do While not rds_Diretoria.Eof
          ...
          <tr bgcolor="<%=str_Cor_Linha%>">
            <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rds_Diretoria("DIRE_TX_DESC_DIRETORIA")%></font></td>
          </tr>
		  <%
				int_Tot_Registro = int_Tot_Registro + 1
				rds_Diretoria.movenext
			Loop
		  end if
		  %>
          <tr>
