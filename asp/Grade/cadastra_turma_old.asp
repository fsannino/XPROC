...
'intCdCorte		=  trim(Request("selCorte"))
...
if Session("Corte") <> "" then
	strSQLUnidade = strSQLUnidade & " AND CORT_CD_CORTE = " & Session("Corte")
else
	strSQLUnidade = strSQLUnidade & " AND CORT_CD_CORTE = 99999999 " 
end if
...
<html>
	<head>
		...
		<script language="javascript">
			...
			{						
				...
				window.location.href='cadastra_turma.asp?parAcao='+strAcao+'&hdSala='+strCdSala+'&selCurso='+strValor+'&txtNomeTurma='+strNomeTurma+'&txtMandante='+strMandante+'&txtDtIni='+strDtIni+'&txtDtFim='+strDtFim+'&txtHrIni='+strHrIni+'&txtHrFim='+strHrFim+'&pCorte='+strCorte;											
			}
	...
	<body topmargin="0" leftmargin="0" bgcolor="#FFFFFF">
		<form method="POST" name="frmCadTurma">	
			...
			<input type="hidden" name="hdDiasCurso" value="<%=strDias%>">								
        ...
        <table width="859" border="0" align="center">
          <tr> 
            ...
            <td width="211"><font color="#330099" face="Verdana" size="2"><b>Tela 
              de Sala e Turma</b></font></td>
			  <%
  				'set centro = db_banco.execute("SELECT * FROM GRADE_SALA WHERE SALA_CD_SALA=" & strSala)
				'ct = centro("CTRO_CD_CENTRO_TREINAMENTO")
			  %>
           <!-- <td width="26"><a href="gera_grade.asp?selCT=<%'=ct%>&selCorte=<%'=intCdCorte%>&pTituloRel=GRADE%20DE%20TREINAMENTO" target="_blank"><img src="../../imagens/calender.gif" width="22" height="21" border="0"></a></td>
            <td width="317"><font color="#330099" face="Verdana" size="2"><b>Visualizar 
              Grade de Treinamento</b></font></td>-->
           <td width="26"></td>
		   <td width="317"></td>
		  </tr>
        </table>
			  ...
			  <table border="0" width="988" height="377">
				...
				%>				   
			  	<tr>
				   ...
				   <td width="214" height="27" rowspan="10" align="left" valign="top">				  	
				...
				<tr> 
				  ...
				  <td width="114" height="31" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Turma:</b></font></td>
				  <td height="31" valign="middle" align="left" width="592">
			  	...
			  	<tr> 
				  <td width="50" height="31"></td>
				  <td width="114" height="31" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Curso:</b></font></td>
				  <td height="31" valign="middle" align="left" width="592"> 
					<!--<input type="text" name="txtCurso" maxlength="100" size="50" value="<%'=strCurso%>">-->
					<select size="1" name="selCurso" onchange="javascript:submet_pagina(this.value);">
				 ...
				 <tr>
				   ...
				   <td height="54" valign="top" align="left">
				   	<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td width="29%" height="30"><input name="rdMultplicador" type="radio" value="0" checked onClick="MostraEscondeMult();">&nbsp;<font face="Verdana" color="#330099" size="2"><b>Unidade</b></font></td>
						<td width="71%">
					...
					<tr>
					  <td height="32"><input name="rdMultplicador" type="radio" value="1" onClick="MostraEscondeMult();">&nbsp;<font face="Verdana" color="#330099" size="2"><b>Área de Negócio</b></font></td>
						<td>
					...
					<tr>
						<td><input name="rdMultplicador" type="radio" value="2" onClick="MostraEscondeMult();">&nbsp;<font face="Verdana" color="#330099" size="2"><b>Companhia</b></font></td>
						<td>
			    ...
			    <tr> 
				  ...
				  <td width="114" height="30" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Mandante:</b></font></td>
				  <td height="30" valign="middle" align="left" width="592"><font face="Verdana" size="2" color="#330099"><b>
				...
				<tr> 
				  ...
				  <td width="114" height="34" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Data de Início:</b></font></td>
				  <td height="34" valign="middle" align="left" width="592"> 
					<input type="text" name="txtDtIni" maxlength="10" size="10" value="<%=strDtIni%>">
				...
				<tr> 
				  <td width="50" height="34"></td>
				  <td width="114" height="34" valign="middle" align="left"><font face="Verdana" size="2" color="#330099"><b>Data de T&eacute;rmino:</b></font></td>
				  <td height="34" valign="middle" align="left" width="592"> 
		  ...
		  <table width="854" height="175" border="0">
				<tr>
					<td width="52" height="55" rowspan="5"></td>
					<td colspan="3"><font face="Verdana" size="2" color="#330099"><b>Unidade:</b></font></td>
				</tr>
				<tr> 
				  <td width="454" height="55" rowspan="5" align="center" valign="middle">        
				  <p align="left">
				  ...
				  <td width="54" height="32" align="center" valign="middle"><div align="left"></div></td>
				  <td width="276" rowspan="5" align="center" valign="middle">
				...
				<tr>
				  <td height="53" align="center" valign="middle"><div align="center"><img src="../../imagens/continua_F01.gif" width="24" height="24" onClick="move(document.frmCadTurma.selUnidade,document.frmCadTurma.selUnidade_Selecionado,1)"></div></td>
				</tr>
				<tr>
				  <td height="34" align="center" valign="middle"><div align="center"><img src="../../imagens/continua2_F01.gif" width="24" height="24" onClick="move(document.frmCadTurma.selUnidade_Selecionado,document.frmCadTurma.selUnidade,1)"></div></td>
				</tr>
				<tr>
