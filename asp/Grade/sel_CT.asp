...
strSQLCT = ""
strSQLCT = strSQLCT & "SELECT CTRO_CD_CENTRO_TREINAMENTO, "
strSQLCT = strSQLCT & "CTRO_TX_NOME_CENTRO_TREINAMENTO "
	...
	<head>
		...
		<script language="javascript">
			...
			{										
				if (strAcao =='Incluir')				
				{		
					document.frmCT.action = "cadastra_CT.asp?pAcao=I";
				}
				
				if (strAcao =='Alterar')				
				{		
					if (document.frmCT.selCT.selectedIndex == 0)
					{
						alert('Selecione um centro de treinamento para alteração!');
						document.frmCT.selCT.focus();
						return;
					}
					else
					{
						document.frmCT.action = "cadastra_CT.asp?pAcao=A";
					}
				}
				...
				{		
					if (document.frmCT.selCT.selectedIndex == 0)
					{
						alert('Selecione um centro de treinamento para exclusão!');
						document.frmCT.selCT.focus();
						return;
					}
					else
					{											 
					   if (confirm('Por favor confirme a remoção deste centro de treinamento.'))
					   {
						 document.frmCT.action = "grava_CT.asp?parAcao=E";
					   }		
					   else
					   {
					   	return;
			...
			{				
				window.location.href = "sel_CT.asp?selCT=0&selCorte="+strValor;											
			}
		...
		<form method="POST" name="frmCT">					
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
				  <td>
					<div align="center"><font face="Verdana" color="#330099" size="3"><b>Cadastro de Centro de Treinamento</b></font></div>
				  </td>
				</tr>
				...
				<tr>
					...
					<table border="0" cellpadding="3" cellspacing="3">								
							...
							%>								
								<tr>
								  <td height="30">
								  	<font face="Verdana" color="#330099" size="1">
										Estes são os Centros de Treinamento cadastrados.<br>
								...
								<tr>
									<td valign="top" colspan="2">										
											<input type="button" value="Incluir novo centro de treinamento"  Onclick="Confirma('Incluir');" tabindex="4" class="boton_box">
									</td>
								</tr>
							</table>    
						<%
						...
						%>
							...
							<p><font face="Verdana" color="#330099" size="2"><b>Ainda não existem CENTRO DE TREINAMENTOS cadastrados no sistema.</b></p>			   
							<a href="#" Onclick="Confirma('Incluir');">
								<input type="button" value="Incluir novo centro de treinamento" tabindex="4" class="boton_box">
							</a>		   
						<%
						end if
