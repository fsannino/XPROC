	...
	<head>
		...
		<script language="javascript">
			...
			{				
				...
				{
					alert('Selecione um curso para listar os multiplicadores a serem aprovados!');
					document.frmCurso.selCurso.focus();
					return;
				}
				else
				{
					document.frmCurso.action = "cadastra_multiplicador_aprov.asp";
			...
			{				
				window.location.href = "sel_multiplicador_aprov.asp?selCurso=0&selCorte="+strValor;											
			}				
		</script>		
	</head>
		...
		<form method="POST" name="frmCurso">					
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
				  <td>
					<div align="center"><font face="Verdana" color="#330099" size="3"><b>Aprovação de Multiplicadores</b></font></div>
				  </td>
				</tr>
							...
							<table width="475" border="0" cellpadding="3" cellspacing="3">
								...
								<tr>
									...
									<td width="149" align="left" valign="top">										
										<input type="submit" Onclick="Confirma();" value="   Listar Multiplicadores   " tabindex="2" class="boton_box">
									</td>									
								</tr>				   
					  </table>    
				    <%
