...
Do while not rdsTransacao.EOF
  ...
  <tr> 
    <td width="50" bgcolor="#0000FF"> 
      <div align="center"><b><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rdsTransacao("TRAN_CD_TRANSACAO")%></font></b></div>
    </td>
    <% str_SQL = ""
	...
	%>
    <td colspan="11"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=rdsDescTransacao("TRAN_TX_DESC_TRANSACAO")%></font> </td>
