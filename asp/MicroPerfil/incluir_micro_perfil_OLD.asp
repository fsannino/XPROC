...
function Confirma()
{
   if((document.frm1.selMacroPerfil.selectedIndex == 0)&&
      ...
      document.frm1.selNomeTecnico.focus();
      return;
      }
   else
      {
...
<form method="POST" action="../MacroPerfil/altera_macro_perfil.asp" name="frm1">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#330099">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="73">
    ...
    <tr> 
      ...
      <td width="23%" height="35"> 
        <div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099"><b>Nome 
          T&eacute;cnico Macro:</b></font></div>
      </td>
      <td width="67%" height="35"><b> 
    ...
    <tr> 
      ...
      <td width="23%" height="35"> 
        <div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#330099"><b>Nome 
          T&eacute;cnico Micro:</b></font></div>
      </td>
      <td width="67%" height="35"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#330099"><%=str_PrefixoNomeTecnico%></font> 
    ...
    <tr>
      ...
      <td width="23%" height="83" valign="top"> 
        <div align="right"><font face="Verdana" size="2" color="#330099"><b>Descrição 
          : </b></font> 
          <input type="hidden" name="txtFuncSelec" size="20">
          <input type="hidden" name="txtImp" size="20">
        </div>
      </td>
      <td width="67%" height="83" valign="top"> 
        <p> 
          <textarea rows="3" name="txtDesc" cols="49" onKeyUp="javascript:pega_tamanho()"></textarea>
        </p>
